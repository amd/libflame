...
/* ===================================================================== */
/* Subroutine */
void dsygv_2stage_(integer *itype, char *jobz, char *uplo, integer *n, doublereal *a, integer *lda,
                   ...
                   integer *info)
{
    ...
    extern /* Subroutine */
        void
        dsyev_2stage_(char *, char *, integer *, doublereal *, integer *, doublereal *,
    ...
    *info = 0;
    ...
    if(wantz)
    {
        ...
        if(*itype == 1 || *itype == 2)
        {
            ...
            dtrsm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[b_offset], ldb,
                   &a[a_offset], lda);
        }
        else if(*itype == 3)
        {
            ...
            dtrmm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[b_offset], ldb,
                   &a[a_offset], lda);
        }
    }
    work[1] = (doublereal)lwmin;
