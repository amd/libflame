    ...
    *info = 0;
    ...
    if(upper)
    {
        ...
        for(i__ = 1; i__ <= i__1; ++i__)
        {
            ...
            aocl_blas_stpsv("Upper", "Transpose", "Non-unit", n, &ap[1], &b[i__ * b_dim1 + 1],
                            &c__1);
            /* Solve U*X = B, overwriting B with X. */
            aocl_blas_stpsv("Upper", "No transpose", "Non-unit", n, &ap[1], &b[i__ * b_dim1 + 1],
                            &c__1);
            /* L10: */
        }
    }
    else
    {
        ...
        for(i__ = 1; i__ <= i__1; ++i__)
        {
            ...
            aocl_blas_stpsv("Lower", "No transpose", "Non-unit", n, &ap[1], &b[i__ * b_dim1 + 1],
                            &c__1);
            /* Solve L**T *X = Y, overwriting B with X. */
            aocl_blas_stpsv("Lower", "Transpose", "Non-unit", n, &ap[1], &b[i__ * b_dim1 + 1],
                            &c__1);
            /* L20: */
        }
    }
