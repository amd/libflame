...
void zunbdb1_(aocl_int_t *m, aocl_int_t *p, aocl_int_t *q, dcomplex *x11, aocl_int_t *ldx11,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zunbdb1(m, p, q, x11, ldx11, x21, ldx21, theta, phi, taup1, taup2, tauq1, work,
                        lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t p_64 = *p;
    ...
    aocl_lapack_zunbdb1(&m_64, &p_64, &q_64, x11, &ldx11_64, x21, &ldx21_64, theta, phi, taup1,
...
void aocl_lapack_zunbdb1(aocl_int64_t *m, aocl_int64_t *p, aocl_int64_t *q, dcomplex *x11,
                         ...
                         aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZUNBDB1", &i__1, (ftnlen)7);
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        ...
        aocl_lapack_zlarf1f("Left", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], &c__1, &z__1,
        ...
        {
            i__2 = *q - i__;
            aocl_blas_zdrot(&i__2, &x11[i__ + (i__ + 1) * x11_dim1], ldx11,
                            &x21[i__ + (i__ + 1) * x21_dim1], ldx21, &c__, &s);
            i__2 = *q - i__;
            aocl_lapack_zlacgv(&i__2, &x21[i__ + (i__ + 1) * x21_dim1], ldx21);
            i__2 = *q - i__;
            ...
            i__2 = *p - i__;
            i__3 = *q - i__;
            aocl_lapack_zlarf1f("Right", &i__2, &i__3, &x21[i__ + (i__ + 1) * x21_dim1], ldx21,
            ...
            i__2 = *p - i__;
            /* Computing 2nd power */
            d__1 = aocl_blas_dznrm2(&i__2, &x11[i__ + 1 + (i__ + 1) * x11_dim1], &c__1);
            i__3 = *m - *p - i__;
            /* Computing 2nd power */
            d__2 = aocl_blas_dznrm2(&i__3, &x21[i__ + 1 + (i__ + 1) * x21_dim1], &c__1);
            c__ = sqrt(d__1 * d__1 + d__2 * d__2);
            phi[i__] = atan2(s, c__);
            i__2 = *p - i__;
            i__3 = *m - *p - i__;
            i__4 = *q - i__ - 1;
            aocl_lapack_zunbdb5(&i__2, &i__3, &i__4, &x11[i__ + 1 + (i__ + 1) * x11_dim1], &c__1,
