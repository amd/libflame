...
/* > \brief <b> CGEESX computes the eigenvalues, the Schur form, and, optionally, the matrix of
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeesx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeesx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeesx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > CGEESX computes for an N-by-N scomplex nonsymmetric matrix A, the */
...
/* ===================================================================== */
/* Subroutine */
void cgeesx_(char *jobvs, char *sort, L_fp select, char *sense, integer *n, complex *a,
             integer *lda, integer *sdim, complex *w, complex *vs, integer *ldvs, real *rconde,
             real *rcondv, complex *work, integer *lwork, real *rwork, logical *bwork,
             integer *info)
{
    ...
    *sdim = 0;
    ...
    if(wantst && *info == 0)
    {
        ...
        /* (RWorkspace: none) */
        i__1 = *lwork - iwrk + 1;
        ctrsen_(sense, jobvs, &bwork[1], n, &a[a_offset], lda, &vs[vs_offset], ldvs, &w[1], sdim,
                rconde, rcondv, &work[iwrk], &i__1, &icond);
        if(!wantsn)
        {
            /* Computing MAX */
            i__1 = maxwrk;
