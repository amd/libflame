...
/* ===================================================================== */
/* Subroutine */
void cunmlq_(char *side, char *trans, integer *m, integer *n, integer *k, complex *a, integer *lda,
...
#endif
    extern void fla_cunmlq(char *side, char *trans, integer *m, integer *n, integer *k, complex *a,
...
void fla_cunmlq(char *side, char *trans, integer *m, integer *n, integer *k, complex *a,
                integer *lda, complex *tau, complex *c__, integer *ldc, complex *work,
                integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        cunml2_(char *, char *, integer *, integer *, integer *, complex *, integer *, complex *,
    ...
    *info = 0;
    ...
    {
        /* Use unblocked code */
        cunml2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[c_offset], ldc, &work[1],
                &iinfo);
    }
    else
    {
...
#pragma omp single
#endif
                {
                    ...
                    i__4 = nq - i__ + 1;
                    clarft_("Forward", "Rowwise", &i__4, &ib, &a[i__ + i__ * a_dim1], lda,
...
#ifdef FLA_OPENMP_MULTITHREADING
                if(left)
                    clarfb_(side, transt, "Forward", "Rowwise", &mi_sub, &ni_sub, &ib,
...
#pragma omp barrier
#else
                clarfb_(side, transt, "Forward", "Rowwise", &mi, &ni, &ib, &a[i__ + i__ * a_dim1],
