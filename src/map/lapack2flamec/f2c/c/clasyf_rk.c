...
/* > \brief \b CLASYF_RK computes a partial factorization of a complex symmetric indefinite matrix
...
/* ===================================================================== */
/* Subroutine */
void clasyf_rk_(char *uplo, integer *n, integer *nb, integer *kb, complex *a, integer *lda,
