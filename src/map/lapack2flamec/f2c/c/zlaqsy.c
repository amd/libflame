/* ../netlib/zlaqsy.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zlaqsy.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zlaqsy.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zlaqsy.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zlaqsy(uplo, n, a, lda, s, scond, amax, equed);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;

    aocl_lapack_zlaqsy(uplo, &n_64, a, &lda_64, s, scond, amax, equed);
#endif
}

void aocl_lapack_zlaqsy(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
