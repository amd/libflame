...
#include "FLA_f2c.h"
/* Subroutine */
int ztrmv_(char *uplo, char *trans, char *diag, integer *n, dcomplex *a, integer *lda, dcomplex *x, integer *incx)
{
                        ...
                        ++j)
                {
                    ...
                    if (x[i__2].real != 0. || x[i__2].imag != 0.)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__3 = j;
                            i__4 = j + j * a_dim1;
                            z__1.real = x[i__3].real * a[i__4].real - x[i__3].imag * a[ i__4].imag, z__1.imag = x[i__3].real * a[i__4].imag + x[i__3].imag * a[i__4].real;
                        ...
                        --j)
                {
                    ...
                    if (x[i__1].real != 0. || x[i__1].imag != 0.)
                    {
                                ...
                                --i__)
                        {
                            ...
                            i__3 = i__;
                            i__4 = i__ + j * a_dim1;
                            z__2.real = temp.real * a[i__4].real - temp.imag * a[i__4].imag, z__2.imag = temp.real * a[i__4].imag + temp.imag * a[ i__4].real;
            ...
            if (*incx == 1)
            {
                        ...
                        --j)
                {
                    ...
                    if (noconj)
                    {
                        ...
                        {
                            i__1 = j + j * a_dim1;
                            z__1.real = temp.real * a[i__1].real - temp.imag * a[i__1].imag, z__1.imag = temp.real * a[i__1].imag + temp.imag * a[ i__1].real;
            ...
            if (*incx == 1)
            {
                        ...
                        ++j)
                {
                    ...
                    if (noconj)
                    {
                        ...
                        {
                            i__2 = j + j * a_dim1;
                            z__1.real = temp.real * a[i__2].real - temp.imag * a[i__2].imag, z__1.imag = temp.real * a[i__2].imag + temp.imag * a[ i__2].real;
                            temp.real = z__1.real, temp.imag = z__1.imag;
                        }
                        i__2 = *n;
                        for (i__ = j + 1;
                                ...
                                ++i__)
                        {
                            i__3 = i__ + j * a_dim1;
                            i__4 = i__;
                            z__2.real = a[i__3].real * x[i__4].real - a[i__3].imag * x[ i__4].imag, z__2.imag = a[i__3].real * x[i__4].imag + a[i__3].imag * x[i__4].real;
                            z__1.real = temp.real + z__2.real, z__1.imag = temp.imag + z__2.imag;
                            temp.real = z__1.real, temp.imag = z__1.imag;
                            /* L150: */
                        }
