...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zlaed8.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zlaed8.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zlaed8.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
L70:
    ...
    else
    {
        ...
        if((d__1 = t * c__ * s, f2c_dabs(d__1)) <= tol)
        {
            ...
            givnum[(*givptr << 1) + 2] = s;
            aocl_blas_zdrot(qsiz, &q[indxq[indx[jlam]] * q_dim1 + 1], &c__1,
...
L100: /* Sort the eigenvalues and corresponding eigenvectors into DLAMBDA */
    ...
    if(*k < *n)
    {
        ...
        i__1 = *n - *k;
        aocl_lapack_zlacpy("A", qsiz, &i__1, &q2[(*k + 1) * q2_dim1 + 1], ldq2,
                           &q[(*k + 1) * q_dim1 + 1], ldq);
    }
    AOCL_DTL_TRACE_LOG_EXIT
    return;
