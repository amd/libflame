...
/* ===================================================================== */
/* Subroutine */
void zheevr_2stage_(char *jobz, char *range, char *uplo, integer *n, doublecomplex *a, integer *lda,
                    ...
                    integer *iwork, integer *liwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        zhetrd_2stage_(char *, char *, integer *, doublecomplex *, integer *, doublereal *,
                       doublereal *, doublecomplex *, doublecomplex *, integer *, doublecomplex *,
                       integer *, integer *);
    char order[1];
    integer indwk, lhtrd;
    extern /* Subroutine */
    ...
    *m = 0;
    ...
    zhetrd_2stage_(jobz, uplo, n, &a[a_offset], lda, &rwork[indrd], &rwork[indre], &work[indtau],
