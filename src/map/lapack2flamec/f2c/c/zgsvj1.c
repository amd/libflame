/* ../netlib/v3.9.0/zgsvj1.f -- translated by f2c (version 20160102). You must link the resulting
...
/* > \brief \b ZGSVJ1 pre-processor for the routine zgesvj, applies Jacobi rotations targeting only
 * particular pivots. */
/* =========== DOCUMENTATION =========== */
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dgsvj1.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dgsvj1.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dgsvj1.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void zgsvj1_(char *jobv, aocl_int_t *m, aocl_int_t *n, aocl_int_t *n1, dcomplex *a,
             aocl_int_t *lda, dcomplex *d__, doublereal *sva, aocl_int_t *mv, dcomplex *v,
             aocl_int_t *ldv, doublereal *eps, doublereal *sfmin, doublereal *tol,
             aocl_int_t *nsweep, dcomplex *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zgsvj1(jobv, m, n, n1, a, lda, d__, sva, mv, v, ldv, eps, sfmin, tol, nsweep, work,
                       lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    ...
    aocl_int64_t nsweep_64 = *nsweep;
    aocl_int64_t lwork_64 = *lwork;
    aocl_int64_t info_64 = *info;

    aocl_lapack_zgsvj1(jobv, &m_64, &n_64, &n1_64, a, &lda_64, d__, sva, &mv_64, v, &ldv_64, eps,
                       sfmin, tol, &nsweep_64, work, &lwork_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zgsvj1(char *jobv, aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *n1,
                        dcomplex *a, aocl_int64_t *lda, dcomplex *d__, doublereal *sva,
                        aocl_int64_t *mv, dcomplex *v, aocl_int64_t *ldv, doublereal *eps,
                        doublereal *sfmin, doublereal *tol, aocl_int64_t *nsweep,
                        dcomplex *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("zgsvj1 inputs: jobv %c, m %" FLA_IS ", n %" FLA_IS ", n1 %" FLA_IS
                      ", lda %" FLA_IS ", mv %" FLA_IS ", ldv %" FLA_IS ", nsweep %" FLA_IS "",
                      *jobv, *m, *n, *n1, *lda, *mv, *ldv, *nsweep);
    /* System generated locals */
    aocl_int64_t a_dim1, a_offset, v_dim1, v_offset, i__1, i__2, i__3, i__4, i__5, i__6, i__7;
    ...
    aocl_int64_t jbc;
    doublereal big;
    aocl_int64_t kbl, igl, ibr, jgl, mvl, nblc;
    doublereal aapp;
    dcomplex aapq;
    doublereal aaqq;
    aocl_int64_t nblr, ierr;
    dcomplex ompq;
    ...
    aocl_int64_t emptsw, notrot, iswrot;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZGSVJ1", &i__1, (ftnlen)6);
                            ...
                            if(aaqq > 0.)
                            {
                                ...
                                if(aaqq >= 1.)
                                {
                                    ...
                                    if(aapp < big / aaqq)
                                    {
                                        aocl_lapack_zdotc_f2c(&z__3, m, &a[p * a_dim1 + 1], &c__1,
                                                   &a[q * a_dim1 + 1], &c__1);
                                        z__2.real = z__3.real / aaqq;
                                        z__2.imag = z__3.imag / aaqq; // , expr subst
                                        z__1.real = z__2.real / aapp;
                                        z__1.imag = z__2.imag / aapp; // , expr subst
                                        aapq.real = z__1.real;
                                        aapq.imag = z__1.imag; // , expr subst
                                    }
                                    else
                                    {
                                        aocl_blas_zcopy(m, &a[p * a_dim1 + 1], &c__1, &work[1],
                                                        &c__1);
                                        aocl_lapack_zlascl("G", &c__0, &c__0, &aapp, &c_b18, m,
                                                           &c__1, &work[1], lda, &ierr);
                                        aocl_lapack_zdotc_f2c(&z__2, m, &work[1], &c__1, &a[q * a_dim1 + 1],
                                                   &c__1);
                                        z__1.real = z__2.real / aaqq;
                                        z__1.imag = z__2.imag / aaqq; // , expr subst
                                        aapq.real = z__1.real;
                                        aapq.imag = z__1.imag; // , expr subst
                                    }
                                }
                                else
                                {
                                    ...
                                    if(aapp > small_val / aaqq)
                                    {
                                        ...
                                        z__2.real = z__3.real / d__1;
                                        z__2.imag = z__3.imag / d__1; // , expr subst
                                        d__2 = fla_min(aaqq, aapp);
                                        z__1.real = z__2.real / d__2;
                                        z__1.imag = z__2.imag / d__2; // , expr subst
                                        aapq.real = z__1.real;
                                        aapq.imag = z__1.imag; // , expr subst
                                    }
                                    else
                                    {
                                        aocl_blas_zcopy(m, &a[q * a_dim1 + 1], &c__1, &work[1],
                                                        &c__1);
                                        aocl_lapack_zlascl("G", &c__0, &c__0, &aaqq, &c_b18, m,
                                                           &c__1, &work[1], lda, &ierr);
                                        aocl_lapack_zdotc_f2c(&z__2, m, &a[p * a_dim1 + 1], &c__1, &work[1],
                                                   &c__1);
                                        z__1.real = z__2.real / aapp;
                                        z__1.imag = z__2.imag / aapp; // , expr subst
                                        aapq.real = z__1.real;
                                ...
                                {
                                    d__1 = z_abs(&aapq);
                                    z__1.real = aapq.real / d__1;
                                    z__1.imag = aapq.imag / d__1; // , expr subst
                                    ompq.real = z__1.real;
                                    ompq.imag = z__1.imag; // , expr subst
                                    notrot = 0;
                                    ...
                                    if(rotok)
                                    {
                                        ...
                                        apoaq = aapp / aaqq;
                                        theta
                                            = (d__1 = aqoap - apoaq, f2c_dabs(d__1)) * -.5 / aapq1;
                                        if(aaqq > aapp0)
                                        {
                                            theta = -theta;
                                        }
                                        ...
                                        else
                                        {
                                            ...
                                            aapp *= sqrt((fla_max(d__1, d__2)));
                                            d_cnjg(&z__2, &ompq);
                                            z__1.real = sn * z__2.real;
                                            z__1.imag = sn * z__2.imag; // , expr subst
                                            aocl_lapack_zrot(m, &a[p * a_dim1 + 1], &c__1,
                                                             &a[q * a_dim1 + 1], &c__1, &cs, &z__1);
                                            if(rsvec)
                                            {
                                        ...
                                        i__6 = p;
                                        i__7 = q;
                                        z__2.real = -d__[i__7].real;
                                        z__2.imag = -d__[i__7].imag; // , expr subst
                                        z__1.real = z__2.real * ompq.real - z__2.imag * ompq.imag;
                                        z__1.imag = z__2.real * ompq.imag + z__2.imag * ompq.real; // , expr subst
                                        d__[i__6].real = z__1.real;
                                        d__[i__6].imag = z__1.imag; // , expr subst
                                    }
                                    else
                                    {
                                        ...
                                        if(aapp > aaqq)
                                        {
                                            ...
                                            aocl_lapack_zlascl("G", &c__0, &c__0, &aaqq, &c_b18, m,
                                                               ...
                                                               &ierr);
                                            z__1.real = -aapq.real;
                                            z__1.imag = -aapq.imag; // , expr subst
                                            aocl_blas_zaxpy(m, &z__1, &work[1], &c__1,
                                                            &a[q * a_dim1 + 1], &c__1);
                                            aocl_lapack_zlascl("G", &c__0, &c__0, &c_b18, &aaqq, m,
                                                               &c__1, &a[q * a_dim1 + 1], lda,
                                                               &ierr);
                                            /* Computing MAX */
                                            d__1 = 0.;
                                        ...
                                        else
                                        {
                                            ...
                                            aocl_blas_zaxpy(m, &z__1, &work[1], &c__1,
                                                            &a[p * a_dim1 + 1], &c__1);
                                            aocl_lapack_zlascl("G", &c__0, &c__0, &c_b18, &aapp, m,
                                                               &c__1, &a[p * a_dim1 + 1], lda,
                                                               &ierr);
                                            /* Computing MAX */
                                            d__1 = 0.;
