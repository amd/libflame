...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chbgvd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chbgvd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chbgvd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,
             "chbgvd inputs: jobz %c, uplo %c, n %lld, ka %lld, kb %lld, ldab %lld, ldbb %lld, ldz "
             "%lld, lwork %lld, lrwork %lld, liwork %lld",
             *jobz, *uplo, *n, *ka, *kb, *ldab, *ldbb, *ldz, *lwork, *lrwork, *liwork);
#else
    snprintf(buffer, 256,
             "chbgvd inputs: jobz %c, uplo %c, n %d, ka %d, kb %d, ldab %d, ldbb %d, ldz %d, lwork "
             "%d, lrwork %d, liwork %d",
             *jobz, *uplo, *n, *ka, *kb, *ldab, *ldbb, *ldz, *lwork, *lrwork, *liwork);
#endif
