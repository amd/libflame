...
void cggqrf_(aocl_int_t *n, aocl_int_t *m, aocl_int_t *p, scomplex *a, aocl_int_t *lda,
             scomplex *taua, scomplex *b, aocl_int_t *ldb, scomplex *taub, scomplex *work,
             aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cggqrf(n, m, p, a, lda, taua, b, ldb, taub, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t m_64 = *m;
    aocl_int64_t p_64 = *p;
    ...
    aocl_lapack_cggqrf(&n_64, &m_64, &p_64, a, &lda_64, taua, b, &ldb_64, taub, work, &lwork_64,
                       &info_64);
...
void aocl_lapack_cggqrf(aocl_int64_t *n, aocl_int64_t *m, aocl_int64_t *p, scomplex *a,
                        ...
                        scomplex *taub, scomplex *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    nb2 = aocl_lapack_ilaenv(&c__1, "CGERQF", " ", n, p, &c_n1, &c_n1);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CGGQRF", &i__1, (ftnlen)6);
    ...
    aocl_lapack_cgeqrf(n, m, &a[a_offset], lda, &taua[1], &work[1], lwork, info);
    lopt = (integer)work[1].r;
    /* Update B := Q**H*B. */
    i__1 = fla_min(*n, *m);
    aocl_lapack_cunmqr("Left", "Conjugate Transpose", n, p, &i__1, &a[a_offset], lda, &taua[1],
    ...
    aocl_lapack_cgerqf(n, p, &b[b_offset], ldb, &taub[1], &work[1], lwork, info);
    /* Computing MAX */
    i__2 = lopt;
