/* ./cheevx_2stage.f -- translated by f2c (version 20190311). You must link the resulting object
...
/* > \brief <b> CHEEVX_2STAGE computes the eigenvalues and, optionally, the left and/or right
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cheevx_
 * 2stage.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cheevx_
 * 2stage.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cheevx_
 * 2stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void cheevx_2stage_(char *jobz, char *range, char *uplo, aocl_int_t *n, scomplex *a, aocl_int_t *lda,
                    real *vl, real *vu, aocl_int_t *il, aocl_int_t *iu, real *abstol, aocl_int_t *m,
                    real *w, scomplex *z__, aocl_int_t *ldz, scomplex *work, aocl_int_t *lwork,
                    real *rwork, aocl_int_t *iwork, aocl_int_t *ifail, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cheevx_2stage(jobz, range, uplo, n, a, lda, vl, vu, il, iu, abstol, m, w, z__, ldz,
    ...
    aocl_lapack_cheevx_2stage(jobz, range, uplo, &n_64, a, &lda_64, vl, vu, &il_64, &iu_64, abstol,
...
void aocl_lapack_cheevx_2stage(char *jobz, char *range, char *uplo, aocl_int64_t *n, scomplex *a,
                               ...
                               aocl_int64_t *info)
{
...
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,
             "cheevx_2stage inputs: jobz %c, range %c, uplo %c, n %lld, lda %lld, il %lld, iu "
             "%lld, m %lld, ldz %lld, lwokr %lld",
             *jobz, *range, *uplo, *n, *lda, *il, *iu, *m, *ldz, *lwork);
#else
    snprintf(buffer, 256,
             "cheevx_2stage inputs: jobz %c, range %c, uplo %c, n %d, lda %d, il %d, iu %d, m %d, "
             "ldz %d, lwork %d",
             *jobz, *range, *uplo, *n, *lda, *il, *iu, *m, *ldz, *lwork);
#endif
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHEEVX_2STAGE", &i__1, (ftnlen)13);
    ...
    *m = 0;
    ...
    aocl_lapack_chetrd_2stage(jobz, uplo, n, &a[a_offset], lda, &rwork[indd], &rwork[inde],
