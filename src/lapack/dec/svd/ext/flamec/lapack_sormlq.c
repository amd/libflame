/* ../netlib/sormlq.f -- translated by f2c (version 20000121). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sormlq.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sormlq.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sormlq.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                  ...
                  aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    aocl_int64_t nbmin, iinfo, i1, i2, i3, ib, ic, jc;
    extern /* Subroutine */
        int
        lapack_sorml2(char *, char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, real *,
                      aocl_int64_t *, real *, real *, aocl_int64_t *, real *, aocl_int64_t *);
    aocl_int64_t nb, mi, ni, nq, nw;
    logical notran;
    aocl_int64_t ldwork;
    char transt[1];
    aocl_int64_t lwkopt;
    ...
    *info = 0;
    ...
    if(nb > 1 && nb < *k)
    {
        if(*lwork < lwkopt)
        {
            ...
            /* Computing MAX */
            i__1 = 2;
            i__2 = aocl_lapack_ilaenv(&c__2, "SORMLQ", ch__1, m, n, k, &c_n1); // , expr subst
    ...
    {
        /* Use unblocked code */
        lapack_sorml2(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[c_offset], ldc,
                      &work[1], &iinfo);
    }
    else
    {
...
#pragma omp single
#endif
                {
                    ...
                    i__4 = nq - i__ + 1;
                    aocl_lapack_slarft("Forward", "Rowwise", &i__4, &ib, &a[i__ + i__ * a_dim1],
...
#ifdef FLA_OPENMP_MULTITHREADING
                if(left)
                    aocl_lapack_slarfb(side, transt, "Forward", "Rowwise", &mi_sub, &ni_sub, &ib,
