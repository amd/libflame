...
void zgeevx_(char *balanc, char *jobvl, char *jobvr, char *sense, aocl_int_t *n, dcomplex *a,
             aocl_int_t *lda, dcomplex *w, dcomplex *vl, aocl_int_t *ldvl,
             dcomplex *vr, aocl_int_t *ldvr, aocl_int_t *ilo, aocl_int_t *ihi,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zgeevx(balanc, jobvl, jobvr, sense, n, a, lda, w, vl, ldvl, vr, ldvr, ilo, ihi,
    ...
    aocl_lapack_zgeevx(balanc, jobvl, jobvr, sense, &n_64, a, &lda_64, w, vl, &ldvl_64, vr,
...
void aocl_lapack_zgeevx(char *balanc, char *jobvl, char *jobvr, char *sense, aocl_int64_t *n,
                        dcomplex *a, aocl_int64_t *lda, dcomplex *w, dcomplex *vl,
                        ...
                        aocl_int64_t *lwork, doublereal *rwork, aocl_int64_t *info)
{
    ...
    char side[1];
    doublereal anrm;
    aocl_int64_t ierr, itau, iwrk, nout, icond;
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        else
        {
            ...
            else
            {
                if(wntsnn)
                {
                    aocl_lapack_zhseqr("E", "N", n, &c__1, n, &a[a_offset], lda, &w[1],
                                       &vr[vr_offset], ldvr, &work[1], &c_n1, info);
                }
                else
                {
                    aocl_lapack_zhseqr("S", "N", n, &c__1, n, &a[a_offset], lda, &w[1],
                                       &vr[vr_offset], ldvr, &work[1], &c_n1, info);
                }
            }
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZGEEVX", &i__1, (ftnlen)6);
    ...
    aocl_lapack_zgebal(balanc, n, &a[a_offset], lda, ilo, ihi, &scale[1], &ierr);
    *abnrm = aocl_lapack_zlange("1", n, n, &a[a_offset], lda, dum);
    if(scalea)
    {
        dum[0] = *abnrm;
    ...
    else
    {
        ...
        iwrk = itau;
        i__1 = *lwork - iwrk + 1;
        aocl_lapack_zhseqr(job, "N", n, ilo, ihi, &a[a_offset], lda, &w[1], &vr[vr_offset], ldvr,
                           &work[iwrk], &i__1, info);
    }
    ...
    if(!wntsnn)
    {
        aocl_lapack_ztrsna(sense, "A", select, n, &a[a_offset], lda, &vl[vl_offset], ldvl,
    ...
    if(wantvl)
    {
        ...
        aocl_lapack_zgebak(balanc, "L", n, ilo, ihi, &scale[1], n, &vl[vl_offset], ldvl, &ierr);
    ...
    if(wantvr)
    {
        ...
        aocl_lapack_zgebak(balanc, "R", n, ilo, ihi, &scale[1], n, &vr[vr_offset], ldvr, &ierr);
