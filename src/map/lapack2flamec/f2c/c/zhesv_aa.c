...
/* > \verbatim */
/* > */
/* > ZHESV_AA computes the solution to a scomplex system of linear equations */
/* > A * X = B, */
...
void zhesv_aa_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, dcomplex *a, aocl_int_t *lda,
               aocl_int_t *ipiv, dcomplex *b, aocl_int_t *ldb, dcomplex *work,
               aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhesv_aa(uplo, n, nrhs, a, lda, ipiv, b, ldb, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zhesv_aa(uplo, &n_64, &nrhs_64, a, &lda_64, ipiv, b, &ldb_64, work, &lwork_64,
                         &info_64);
...
void aocl_lapack_zhesv_aa(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, dcomplex *a,
                          ...
                          dcomplex *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHESV_AA ", &i__1, (ftnlen)9);
    ...
    aocl_lapack_zhetrf_aa(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if(*info == 0)
    {
