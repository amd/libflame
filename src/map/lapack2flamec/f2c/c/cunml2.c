...
/* ../netlib/cunml2.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cunml2.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cunml2.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cunml2.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void cunml2_(char *side, char *trans, aocl_int_t *m, aocl_int_t *n, aocl_int_t *k, scomplex *a,
             aocl_int_t *lda, scomplex *tau, scomplex *c__, aocl_int_t *ldc, scomplex *work,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cunml2(side, trans, m, n, k, a, lda, tau, c__, ldc, work, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t k_64 = *k;
    ...
    aocl_lapack_cunml2(side, trans, &m_64, &n_64, &k_64, a, &lda_64, tau, c__, &ldc_64, work,
                       &info_64);
...
void aocl_lapack_cunml2(char *side, char *trans, aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *k,
                        ...
                        aocl_int64_t *ldc, scomplex *work, aocl_int64_t *info)
{
    ...
    char buffer[256];
    snprintf(buffer, 256,
             "cunml2 inputs: side %c, trans %c, m %" FLA_IS ", n %" FLA_IS ", k %" FLA_IS
    ...
    *info = 0;
    ...
    for(i__ = i1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
    {
        ...
        aocl_lapack_clarf1f(side, &mi, &ni, &a[i__ + i__ * a_dim1], lda, &taui,
