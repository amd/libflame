/* ../netlib/v3.9.0/zhecon_3.f -- translated by f2c (version 20160102). You must link the resulting
...
void zhecon_3_(char *uplo, aocl_int_t *n, dcomplex *a, aocl_int_t *lda, dcomplex *e,
               aocl_int_t *ipiv, doublereal *anorm, doublereal *rcond, dcomplex *work,
               aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhecon_3(uplo, n, a, lda, e, ipiv, anorm, rcond, work, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;
    aocl_int64_t info_64 = *info;

    aocl_lapack_zhecon_3(uplo, &n_64, a, &lda_64, e, ipiv, anorm, rcond, work, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zhecon_3(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
                          ...
                          dcomplex *work, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHECON_3", &i__1, (ftnlen)8);
...
L30:
    ...
    if(kase != 0)
    {
        ...
        aocl_lapack_zhetrs_3(uplo, n, &c__1, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], n, info);
        goto L30;
    }
