...
aocl_int_t iladlr_(aocl_int_t *m, aocl_int_t *n, doublereal *a, aocl_int_t *lda)
{
#if FLA_ENABLE_ILP64
    return aocl_lapack_iladlr(m, n, a, lda);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;

    return aocl_lapack_iladlr(&m_64, &n_64, a, &lda_64);
#endif
}

aocl_int64_t aocl_lapack_iladlr(aocl_int64_t *m, aocl_int64_t *n, doublereal *a, aocl_int64_t *lda)
{
