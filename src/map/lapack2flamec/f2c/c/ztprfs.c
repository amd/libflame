/* ../netlib/ztprfs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ztprfs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ztprfs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ztprfs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                        ...
                        doublereal *rwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    for(j = 1; j <= i__1; ++j)
    {
        ...
        aocl_blas_ztpmv(uplo, trans, diag, n, &ap[1], &work[1], &c__1);
        z__1.real = -1.;
            ...
            if (upper)
            {
                ...
                if(nounit)
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        {
                            i__4 = kc + i__ - 1;
                            rwork[i__] += ((d__1 = ap[i__4].r, f2c_abs(d__1)) + ( d__2 = d_imag(&ap[kc + i__ - 1]), f2c_abs( d__2))) * xk;
                            /* L30: */
                        }
                        kc += k;
                        /* L40: */
            ...
            else
            {
                ...
                if(nounit)
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        {
                            i__4 = kc + i__ - k;
                            rwork[i__] += ((d__1 = ap[i__4].r, f2c_abs(d__1)) + ( d__2 = d_imag(&ap[kc + i__ - k]), f2c_abs( d__2))) * xk;
                            /* L70: */
                        }
                        kc = kc + *n - k + 1;
                        /* L80: */
                ...
                if(nounit)
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        for(i__ = 1; i__ <= i__3; ++i__)
                        {
                            i__4 = kc + i__ - 1;
                            i__5 = i__ + j * x_dim1;
                            s += ((d__1 = ap[i__4].r, f2c_abs(d__1)) + (d__2 = d_imag(&ap[kc + i__ - 1]), f2c_abs(d__2))) * ( (d__3 = x[i__5].r, f2c_abs(d__3)) + (d__4 = d_imag(&x[i__ + j * x_dim1]), f2c_abs(d__4)));
                            /* L110: */
                        }
                        rwork[k] += s;
                        kc += k;
                ...
                if(nounit)
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        for(i__ = k; i__ <= i__3; ++i__)
                        {
                            i__4 = kc + i__ - k;
                            i__5 = i__ + j * x_dim1;
                            s += ((d__1 = ap[i__4].r, f2c_abs(d__1)) + (d__2 = d_imag(&ap[kc + i__ - k]), f2c_abs(d__2))) * ( (d__3 = x[i__5].r, f2c_abs(d__3)) + (d__4 = d_imag(&x[i__ + j * x_dim1]), f2c_abs(d__4)));
                            /* L150: */
                        }
                        rwork[k] += s;
                        kc = kc + *n - k + 1;
    ...
    L210:
        ...
        if(kase != 0)
        {
            if(kase == 1)
            {
                ...
                aocl_blas_ztpsv(uplo, transt, diag, n, &ap[1], &work[1], &c__1);
                i__2 = *n;
                for(i__ = 1; i__ <= i__2; ++i__)
                {
                    i__3 = i__;
            ...
            else
            {
                ...
                aocl_blas_ztpsv(uplo, transn, diag, n, &ap[1], &work[1], &c__1);
            }
            goto L210;
        }
        /* Normalize error. */
