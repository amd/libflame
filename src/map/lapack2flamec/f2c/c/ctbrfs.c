/* ../netlib/ctbrfs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ctbrfs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ctbrfs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ctbrfs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,
             "ctbrfs inputs: uplo %c, trans %c, diag %c, n %lld, kd %lld, nrhs %lld, ldab %lld, "
             "ldb %lld, ldx %lld",
             *uplo, *trans, *diag, *n, *kd, *nrhs, *ldab, *ldb, *ldx);
#else
    snprintf(
        buffer, 256,
        "ctbrfs inputs: uplo %c, trans %c, diag %c, n %d, kd %d, nrhs %d, ldab %d, ldb %d, ldx %d",
        *uplo, *trans, *diag, *n, *kd, *nrhs, *ldab, *ldb, *ldx);
#endif
    ...
    *info = 0;
    ...
    for(j = 1; j <= i__1; ++j)
    {
        ...
        if(notran)
        {
            ...
            if(upper)
            {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        for(i__ = fla_max(i__3, i__4); i__ <= i__5; ++i__)
                        {
                            ...
                            rwork[i__] += ((r__1 = ab[i__3].real, f2c_abs(r__1))
                                           + (r__2 = r_imag(&ab[*kd + 1 + i__ - k + k * ab_dim1]),
                                              f2c_abs(r__2)))
                                          * xk;
                            /* L30: */
                        }
                ...
                else
                {
                    ...
                    {
                        i__5 = k + j * x_dim1;
                        xk = (r__1 = x[i__5].real, f2c_abs(r__1))
                             + (r__2 = r_imag(&x[k + j * x_dim1]), f2c_abs(r__2));
                        /* Computing MAX */
                        i__5 = 1;
                        ...
                        for(i__ = fla_max(i__5, i__3); i__ <= i__4; ++i__)
                        {
                            ...
                            rwork[i__] += ((r__1 = ab[i__5].real, f2c_abs(r__1))
                                           + (r__2 = r_imag(&ab[*kd + 1 + i__ - k + k * ab_dim1]),
                                              f2c_abs(r__2)))
                                          * xk;
                            /* L50: */
            ...
            else
            {
                if(nounit)
                {
                    ...
                    {
                        i__4 = k + j * x_dim1;
                        xk = (r__1 = x[i__4].real, f2c_abs(r__1))
                             + (r__2 = r_imag(&x[k + j * x_dim1]), f2c_abs(r__2));
                        /* Computing MIN */
                        i__5 = *n;
                        i__3 = k + *kd; // , expr subst
                        ...
                        for(i__ = k; i__ <= i__4; ++i__)
                        {
                            ...
                            rwork[i__] += ((r__1 = ab[i__5].real, f2c_abs(r__1))
                                           + (r__2 = r_imag(&ab[i__ + 1 - k + k * ab_dim1]),
                                              f2c_abs(r__2)))
                                          * xk;
                            /* L70: */
                        }
        ...
        else
        {
                ...
                if(nounit)
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        for(i__ = fla_max(i__4, i__5); i__ <= i__3; ++i__)
                        {
                            ...
                            i__5 = i__ + j * x_dim1;
                            s += ((r__1 = ab[i__4].real, f2c_abs(r__1))
                                  + (r__2 = r_imag(&ab[*kd + 1 + i__ - k + k * ab_dim1]),
                                     f2c_abs(r__2)))
                ...
                else
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        for(i__ = fla_max(i__3, i__4); i__ <= i__5; ++i__)
                        {
                            i__3 = *kd + 1 + i__ - k + k * ab_dim1;
                            i__4 = i__ + j * x_dim1;
                            s += ((r__1 = ab[i__3].real, f2c_abs(r__1))
                                  + (r__2 = r_imag(&ab[*kd + 1 + i__ - k + k * ab_dim1]),
                                     f2c_abs(r__2)))
                                 * ((r__3 = x[i__4].real, f2c_abs(r__3))
                                    + (r__4 = r_imag(&x[i__ + j * x_dim1]), f2c_abs(r__4)));
                            /* L130: */
                        }
                        rwork[k] += s;
            ...
            else
            {
                if(nounit)
                {
                    ...
                    for(k = 1; k <= i__2; ++k)
                    {
                        ...
                        for(i__ = k; i__ <= i__5; ++i__)
                        {
                            ...
                            i__4 = i__ + j * x_dim1;
                            s += ((r__1 = ab[i__3].real, f2c_abs(r__1))
                                  + (r__2 = r_imag(&ab[i__ + 1 - k + k * ab_dim1]), f2c_abs(r__2)))
                                 * ((r__3 = x[i__4].real, f2c_abs(r__3))
                                    + (r__4 = r_imag(&x[i__ + j * x_dim1]), f2c_abs(r__4)));
                            /* L150: */
                        }
                ...
                else
                {
                    ...
                    {
                        i__5 = k + j * x_dim1;
                        s = (r__1 = x[i__5].real, f2c_abs(r__1))
                            + (r__2 = r_imag(&x[k + j * x_dim1]), f2c_abs(r__2));
                        /* Computing MIN */
                        i__3 = *n;
                        i__4 = k + *kd; // , expr subst
        ...
        for(i__ = 1; i__ <= i__2; ++i__)
        {
            if(rwork[i__] > safe2)
            {
                ...
                i__5 = i__;
                r__3 = s;
                r__4 = ((r__1 = work[i__5].real, f2c_abs(r__1))
        ...
        for(i__ = 1; i__ <= i__2; ++i__)
        {
            ...
            {
                i__5 = i__;
                rwork[i__] = (r__1 = work[i__5].real, f2c_abs(r__1))
    ...
    L210:
        ...
        if(kase != 0)
        {
            if(kase == 1)
            {
                ...
                for(i__ = 1; i__ <= i__2; ++i__)
                {
                    ...
                    i__3 = i__;
                    i__4 = i__;
                    q__1.real = rwork[i__3] * work[i__4].real;
                    q__1.imag = rwork[i__3] * work[i__4].imag; // , expr subst
        ...
        for(i__ = 1; i__ <= i__2; ++i__)
        {
            ...
            i__5 = i__ + j * x_dim1;
            r__3 = lstres;
            r__4 = (r__1 = x[i__5].real, f2c_abs(r__1))
