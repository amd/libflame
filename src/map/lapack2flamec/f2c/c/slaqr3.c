...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slaqr3.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slaqr3.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slaqr3.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void slaqr3_(logical *wantt, logical *wantz, aocl_int_t *n, aocl_int_t *ktop, aocl_int_t *kbot,
             ...
             real *wv, aocl_int_t *ldwv, real *work, aocl_int_t *lwork)
{
    ...
    aocl_lapack_slaqr3(wantt, wantz, &n_64, &ktop_64, &kbot_64, &nw_64, h__, &ldh_64, &iloz_64,
...
void aocl_lapack_slaqr3(logical *wantt, logical *wantz, aocl_int64_t *n, aocl_int64_t *ktop,
                        ...
                        aocl_int64_t *lwork)
{
    ...
    AOCL_DTL_SNPRINTF(
        "slaqr3 inputs: n %" FLA_IS ",ktop %" FLA_IS ",kbot %" FLA_IS ",nw %" FLA_IS ",ldh %" FLA_IS
