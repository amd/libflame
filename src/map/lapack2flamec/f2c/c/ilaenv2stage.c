...
aocl_int_t ilaenv2stage_(aocl_int_t *ispec, char *name__, char *opts, aocl_int_t *n1,
                         aocl_int_t *n2, aocl_int_t *n3, aocl_int_t *n4)
{
#if FLA_ENABLE_ILP64
    return aocl_lapack_ilaenv2stage(ispec, name__, opts, n1, n2, n3, n4);
#else
    ...
    return aocl_lapack_ilaenv2stage(&ispec_64, name__, opts, &n1_64, &n2_64, &n3_64, &n4_64);
#endif
}
...
L10: /* 2stage eigenvalues and SVD or related subroutines. */
    iispec = *ispec + 16;
    ret_val
        = aocl_lapack_iparam2stage(&iispec, name__, opts, n1, n2, n3, n4); // , name_len, opts_len);
    return ret_val;
    /* End of ILAENV2STAGE */
}
/* ilaenv2stage_ */
