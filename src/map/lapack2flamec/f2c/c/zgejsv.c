/* ../netlib/v3.9.0/zgejsv.f -- translated by f2c (version 20160102). You must link the resulting
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgejsv.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgejsv.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgejsv.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
             ...
             doublereal *rwork, integer *lrwork, integer *iwork, integer *info)
{
    ...
    AOCL_DTL_SNPRINTF(
        "zgejsv inputs: joba %c, jobu %c, jobv %c, jobr %c, jobt %c, jobp %c, m %" FLA_IS
    ...
    if(*info == 0)
    {
        ...
        else if(rsvec && !lsvec)
        {
            ...
            if(lquery)
            {
                ...
                {
                    /* Computing MAX */
                    i__1 = *n + lwrk_zgeqp3__, i__1 = fla_max(i__1, lwcon),
                    i__1 = fla_max(i__1, lwrk_zgesvj__), i__2 = *n + lwrk_zgelqf__,
                    i__1 = fla_max(i__1, i__2), i__2 = (*n << 1) + lwrk_zgeqrf__,
                    i__1 = fla_max(i__1, i__2), i__2 = *n + lwrk_zgesvj__;
                    i__1 = fla_max(i__1, i__2);
                ...
                {
                    /* Computing MAX */
                    i__1 = *n + lwrk_zgeqp3__, i__1 = fla_max(i__1, lwrk_zgesvj__),
                    i__2 = *n + lwrk_zgelqf__, i__1 = fla_max(i__1, i__2),
                    i__2 = (*n << 1) + lwrk_zgeqrf__, i__1 = fla_max(i__1, i__2),
                    i__2 = *n + lwrk_zgesvj__;
                    i__1 = fla_max(i__1, i__2);
                    i__2 = *n + lwrk_zunmlq__; // ; expr subst
                    optwrk = fla_max(i__1, i__2);
                }
            ...
            if(lquery)
            {
                ...
                if(!jracc)
                {
                    ...
                    if(errest)
                    {
                        ...
                        /* Computing 2nd power */
                        i__11 = *n;
                        i__1 = *n + lwrk_zgeqp3__, i__2 = *n + lwcon, i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__3 * i__3 + lwcon, i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + lwrk_zgeqrf__, i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + lwrk_zgeqp3n__, i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__4 * i__4 + *n + lwrk_zgelqf__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__5 * i__5 + *n + i__6 * i__6 + lwcon,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__7 * i__7 + *n + lwrk_zgesvj__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__8 * i__8 + *n + lwrk_zgesvjv__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__9 * i__9 + *n + lwrk_zunmqr__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__10 * i__10 + *n + lwrk_zunmlq__,
                        i__1 = fla_max(i__1, i__2), i__2 = *n + i__11 * i__11 + lwrk_zgesvju__;
                        i__1 = fla_max(i__1, i__2);
                    ...
                    else
                    {
                        ...
                        /* Computing 2nd power */
                        i__11 = *n;
                        i__1 = *n + lwrk_zgeqp3__, i__2 = (*n << 1) + i__3 * i__3 + lwcon,
                        i__1 = fla_max(i__1, i__2), i__2 = (*n << 1) + lwrk_zgeqrf__,
                        i__1 = fla_max(i__1, i__2), i__2 = (*n << 1) + lwrk_zgeqp3n__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__4 * i__4 + *n + lwrk_zgelqf__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__5 * i__5 + *n + i__6 * i__6 + lwcon,
                ...
                else
                {
                    ...
                    if(errest)
                    {
                        ...
                        i__2 = (*n << 1) + i__4 * i__4 + lwrk_zgesvjv__, i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__5 * i__5 + *n + lwrk_zunmqr__;
                        i__1 = fla_max(i__1, i__2);
                        i__2 = *n + lwrk_zunmqrm__; // ; expr subst
                        optwrk = fla_max(i__1, i__2);
                    }
                    else
                    {
                        ...
                        /* Computing 2nd power */
                        i__5 = *n;
                        i__1 = *n + lwrk_zgeqp3__, i__2 = (*n << 1) + lwrk_zgeqrf__,
                        i__1 = fla_max(i__1, i__2), i__2 = (*n << 1) + i__3 * i__3,
                        i__1 = fla_max(i__1, i__2), i__2 = (*n << 1) + i__4 * i__4 + lwrk_zgesvjv__,
                        i__1 = fla_max(i__1, i__2),
                        i__2 = (*n << 1) + i__5 * i__5 + *n + lwrk_zunmqr__;
                        i__1 = fla_max(i__1, i__2);
                        i__2 = *n + lwrk_zunmqrm__; // ; expr subst
    ...
    else if(l2rank)
    {
        ...
        for(p = 2; p <= i__1; ++p)
        {
            if(z_abs(&a[p + p * a_dim1]) < epsln * z_abs(&a[p - 1 + (p - 1) * a_dim1])
               || z_abs(&a[p + p * a_dim1]) < small_val
               || l2kill && z_abs(&a[p + p * a_dim1]) < temp1)
            {
                goto L3402;
            }
            ++nr;
