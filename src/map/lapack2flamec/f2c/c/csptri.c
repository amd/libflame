/* ../netlib/csptri.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/csptri.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/csptri.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/csptri.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > CSPTRI computes the inverse of a scomplex symmetric indefinite matrix */
    ...
    L30: /* If K > N, exit from loop. */
        ...
        if(ipiv[k] > 0)
        {
            ...
            if(k > 1)
            {
                ...
                i__2 = kc + k - 1;
                i__3 = k - 1;
                aocl_lapack_cdotu_f2c(&q__2, &i__3, &work[1], &c__1, &ap[kc], &c__1);
        ...
        else
        {
            ...
            if(k > 1)
            {
                ...
                i__2 = kcnext + k - 1;
                i__3 = k - 1;
                aocl_lapack_cdotu_f2c(&q__2, &i__3, &ap[kc], &c__1, &ap[kcnext], &c__1);
                q__1.r = ap[i__2].r - q__2.r;
                q__1.i = ap[i__2].i - q__2.i; // , expr subst
                ap[i__1].r = q__1.r;
                ap[i__1].i = q__1.i; // , expr subst
                ...
                i__2 = kcnext + k;
                i__3 = k - 1;
                aocl_lapack_cdotu_f2c(&q__2, &i__3, &work[1], &c__1, &ap[kcnext], &c__1);
                q__1.r = ap[i__2].r - q__2.r;
                q__1.i = ap[i__2].i - q__2.i; // , expr subst
                ap[i__1].r = q__1.r;
                ap[i__1].i = q__1.i; // , expr subst
    ...
    L60: /* If K < 1, exit from loop. */
        ...
        if(ipiv[k] > 0)
        {
            ...
            if(k < *n)
            {
                ...
                i__2 = kc;
                i__3 = *n - k;
                aocl_lapack_cdotu_f2c(&q__2, &i__3, &work[1], &c__1, &ap[kc + 1], &c__1);
                q__1.r = ap[i__2].r - q__2.r;
                q__1.i = ap[i__2].i - q__2.i; // , expr subst
                ap[i__1].r = q__1.r;
                ap[i__1].i = q__1.i; // , expr subst
        ...
        else
        {
            ...
            if(k < *n)
            {
                ...
                i__2 = kcnext;
                i__3 = *n - k;
                aocl_lapack_cdotu_f2c(&q__2, &i__3, &work[1], &c__1, &ap[kcnext + 2], &c__1);
                q__1.r = ap[i__2].r - q__2.r;
                q__1.i = ap[i__2].i - q__2.i; // , expr subst
                ap[i__1].r = q__1.r;
                ap[i__1].i = q__1.i; // , expr subst
