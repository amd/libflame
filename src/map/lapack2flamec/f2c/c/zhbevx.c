...
/* ===================================================================== */
/* Subroutine */
void zhbevx_(char *jobz, char *range, char *uplo, integer *n, integer *kd, doublecomplex *ab,
             ...
             integer *iwork, integer *ifail, integer *info)
{
    ...
    *m = 0;
    ...
    indrwk = inde + *n;
    indwrk = 1;
    zhbtrd_(jobz, uplo, n, kd, &ab[ab_offset], ldab, &rwork[indd], &rwork[inde], &q[q_offset], ldq,
            &work[indwrk], &iinfo);
