...
/* > \brief \b ZSYTRF_RK computes the factorization of a complex symmetric indefinite matrix using
...
/* ===================================================================== */
/* Subroutine */
void zsytrf_rk_(char *uplo, integer *n, doublecomplex *a, integer *lda, doublecomplex *e,
                integer *ipiv, doublecomplex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        zsytf2_rk_(char *, integer *, doublecomplex *, integer *, doublecomplex *, integer *,
                   integer *),
        zlasyf_rk_(char *, integer *, integer *, integer *, doublecomplex *, integer *,
    ...
    *info = 0;
    ...
    L10: /* If K < 1, exit from loop */
        ...
        if(k > nb)
        {
            ...
            zlasyf_rk_(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &ldwork,
                       &iinfo);
        }
        else
        {
    ...
    L20: /* If K > N, exit from loop */
        ...
        if(k <= *n - nb)
        {
            ...
            i__1 = *n - k + 1;
            zlasyf_rk_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k], &ipiv[k], &work[1],
                       &ldwork, &iinfo);
        }
        else
        {
