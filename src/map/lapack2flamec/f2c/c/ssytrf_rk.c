...
/* ===================================================================== */
/* Subroutine */
void ssytrf_rk_(char *uplo, integer *n, real *a, integer *lda, real *e, integer *ipiv, real *work,
                integer *lwork, integer *info)
{
    AOCL_DTL_TRACE_ENTRY(AOCL_DTL_LEVEL_TRACE_5);
#if LF_AOCL_DTL_LOG_ENABLE
    char buffer[256];
    snprintf(buffer, 256, "ssytrf_rk inputs: uplo %c, n %" FLA_IS ", lda %" FLA_IS "", *uplo, *n,
             *lda);
    ...
    extern /* Subroutine */
        void
        ssytf2_rk_(char *, integer *, real *, integer *, real *, integer *, integer *),
        slasyf_rk_(char *, integer *, integer *, integer *, real *, integer *, real *, integer *,
