...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chpevx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chpevx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chpevx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_chpevx(jobz, range, uplo, n, ap, vl, vu, il, iu, abstol, m, w, z__, ldz, work,
    ...
    aocl_lapack_chpevx(jobz, range, uplo, &n_64, ap, vl, vu, &il_64, &iu_64, abstol, &m_64, w, z__,
...
void aocl_lapack_chpevx(char *jobz, char *range, char *uplo, aocl_int64_t *n, scomplex *ap, real *vl,
                        ...
                        aocl_int_t *iwork, aocl_int_t *ifail, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHPEVX", &i__1, (ftnlen)6);
