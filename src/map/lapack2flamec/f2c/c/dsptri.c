/* ../netlib/dsptri.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsptri.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsptri.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsptri.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
    ...
    *info = 0;
    ...
    L30: /* If K > N, exit from loop. */
        ...
        if(kp != k)
        {
            ...
            kpc = (kp - 1) * kp / 2 + 1;
            i__1 = kp - 1;
            aocl_blas_dswap(&i__1, &ap[kc], &c__1, &ap[kpc], &c__1);
            kx = kpc + kp - 1;
            i__1 = k - 1;
            for(j = kp + 1; j <= i__1; ++j)
            {
    ...
    L60: /* If K < 1, exit from loop. */
        ...
        else
        {
            ...
            if(k < *n)
            {
                ...
                ap[kc] -= aocl_blas_ddot(&i__1, &work[1], &c__1, &ap[kc + 1], &c__1);
                i__1 = *n - k;
                ap[kcnext + 1] -= aocl_blas_ddot(&i__1, &ap[kc + 1], &c__1, &ap[kcnext + 2], &c__1);
                i__1 = *n - k;
