...
/* ===================================================================== */
/* Subroutine */
void dormql_(char *side, char *trans, integer *m, integer *n, integer *k, doublereal *a,
             ...
             integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        dorm2l_(char *, char *, integer *, integer *, integer *, doublereal *, integer *,
    ...
    *info = 0;
    ...
    else
    {
        ...
        for(i__ = i1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            i__4 = nq - *k + i__ + ib - 1;
            dlarft_("Backward", "Columnwise", &i__4, &ib, &a[i__ * a_dim1 + 1], lda, &tau[i__],
                    &work[iwt], &c__65);
            if(left)
            {
            ...
            /* Apply H or H**T */
            dlarfb_(side, trans, "Backward", "Columnwise", &mi, &ni, &ib, &a[i__ * a_dim1 + 1], lda,
