...
void fla_test_sytrf_rook_experiment(test_params_t *params, integer datatype, integer p_cur,
    ...
    if(argc >= 8 && argc <= 9)
    {
        ...
        if(n_repeats > 0)
        {
            ...
            for(i = 0; i < num_types; i++)
            {
                ...
                /* Call the test code */
                fla_test_sytrf_rook_experiment(params, datatype, N, N, 0, n_repeats, einfo, &perf,
                                               &time_min, &residual);
                                    ...
                                    double *perf, double *t, double *residual)
{
    ...
    *residual = params->lin_solver_paramslist[pci].solver_threshold;
    ...
    /* call to API */
    prepare_sytrf_rook_run(datatype, n, A_test, uplo, lda, ipiv, work, lwork, n_repeats, t, &info,
