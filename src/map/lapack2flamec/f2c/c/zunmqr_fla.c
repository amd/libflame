/* ../netlib/zunmqr.f -- translated by f2c (version 20100827). You must link the resulting object
                ...
                doublecomplex *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
    ...
    {
        /* Use unblocked code */
        zunm2r_fla(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[c_offset], ldc, &work[1],
                   &iinfo);
    }
    else
    {
