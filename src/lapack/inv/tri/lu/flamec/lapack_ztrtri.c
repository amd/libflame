/* ztrtri.f -- translated by f2c (version 20190311).
...
/* > <a
href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ztrtri.
f"> */
/* > [TGZ]</a> */
/* > <a
href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ztrtri.
f"> */
/* > [ZIP]</a> */
/* > <a
href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ztrtri.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
                                    ...
                                    integer *info)
{
    ...
    *info = 0;
    ...
    if(nounit)
    {
        ...
        {
            if(a[*info + *info * a_dim1].real == 0. && a[*info + *info * a_dim1].imag == 0.)
            {
                return;
            }
        }
