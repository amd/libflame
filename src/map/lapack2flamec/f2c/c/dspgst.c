/* ../netlib/dspgst.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dspgst.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dspgst.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dspgst.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
        ...
        else
        {
            ...
            for(k = 1; k <= i__1; ++k)
            {
                ...
                if(k < *n)
                {
                    ...
                    i__2 = *n - k;
                    aocl_blas_dspr2(uplo, &i__2, &c_b9, &ap[kk + 1], &c__1, &bp[kk + 1], &c__1,
                                    &ap[k1k1]);
                    i__2 = *n - k;
                    aocl_blas_daxpy(&i__2, &ct, &bp[kk + 1], &c__1, &ap[kk + 1], &c__1);
                    i__2 = *n - k;
    ...
    else
    {
        if(upper)
        {
            ...
            for(k = 1; k <= i__1; ++k)
            {
                ...
                aocl_blas_daxpy(&i__2, &ct, &bp[k1], &c__1, &ap[k1], &c__1);
                i__2 = k - 1;
                aocl_blas_dscal(&i__2, &bkk, &ap[k1], &c__1);
                /* Computing 2nd power */
                d__1 = bkk;
                ap[kk] = akk * (d__1 * d__1);
                /* L30: */
        ...
        else
        {
            ...
            for(j = 1; j <= i__1; ++j)
            {
                ...
                bjj = bp[jj];
                i__2 = *n - j;
                ap[jj] = ajj * bjj + aocl_blas_ddot(&i__2, &ap[jj + 1], &c__1, &bp[jj + 1], &c__1);
                i__2 = *n - j;
