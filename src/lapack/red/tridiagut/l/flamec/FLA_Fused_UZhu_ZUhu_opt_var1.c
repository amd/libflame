                                        ...
                                        double* buff_w, fla_dim_t inc_w ) 
{
  ...
  fla_dim_t       n_run    = n_U / 2;
  fla_dim_t       n_left   = n_U % 2;
  fla_dim_t       step_u   = 2*cs_U;
  fla_dim_t       step_z   = 2*cs_Z;
  fla_dim_t       step_tau = 2*inc_t;
  fla_dim_t       i;
                                        ...
                                        dcomplex* buff_w, fla_dim_t inc_w ) 
{
  ...
  fla_dim_t       n_left   = n_U % 1;
  fla_dim_t       step_u   = 1*cs_U;
  fla_dim_t       step_z   = 1*cs_Z;
  fla_dim_t       step_tau = 1*inc_t;
  fla_dim_t       i;
