/* ../netlib/dlaebz.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaebz.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaebz.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaebz.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void dlaebz_(integer *ijob, integer *nitmax, integer *n, integer *mmax, integer *minp,
             ...
             integer *info)
{
    ...
    /* Local variables */
    aocl_int64_t j, kf, ji, kl, jp, jit;
    doublereal tmp1, tmp2;
    aocl_int64_t itmp1, itmp2, kfnew, klnew;
            ...
            for(ji = kf; ji <= i__2; ++ji)
            {
                ...
                if(*ijob <= 2)
                {
                    ...
                    else if(klnew < *mmax)
                    {
                        ...
                        nab[klnew + nab_dim1] = (aocl_int_t)(itmp1);
                        ab[ji + (ab_dim1 << 1)] = tmp1;
                        nab[ji + (nab_dim1 << 1)] = (aocl_int_t)(itmp1);
                    }
                    else
                    {
                        *info = *mmax + 1;
                ...
                else
                {
                    ...
                    {
                        ab[ji + ab_dim1] = tmp1;
                        nab[ji + nab_dim1] = (aocl_int_t)(itmp1);
                    }
                    if(itmp1 >= nval[ji])
                    {
                        ab[ji + (ab_dim1 << 1)] = tmp1;
