/* ../netlib/cpoequb.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cpoequb
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cpoequb
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cpoequb
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                         ...
                         real *amax, aocl_int64_t *info)
{
    ...
    real r__1, r__2;
    /* Builtin functions */
    double log(doublereal), pow_ri(real *, aocl_int64_t *), sqrt(doublereal);
    /* Local variables */
    aocl_int64_t i__;
    real tmp, base, smin;
