...
/* ../netlib/v3.9.0/zgesvj.f -- translated by f2c (version 20160102). You must link the resulting
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesvj.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesvj.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesvj.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                        ...
                        aocl_int64_t *info)
{
    ...
    aocl_int64_t emptsw;
    logical lquery;
    aocl_int64_t minmn, lwmin, lrwmin;
            ...
            for(ir1 = 0; ir1 <= i__2; ++ir1)
            {
                ...
                for(p = igl; p <= i__3; ++p)
                {
                    ...
                    if(p != q)
                    {
                        ...
                        sva[q] = temp1;
                        i__4 = p;
                        aapq.real = cwork[i__4].real;
                        aapq.imag = cwork[i__4].imag; // , expr subst
                        i__4 = p;
                        i__5 = q;
                        cwork[i__4].real = cwork[i__5].real;
                        cwork[i__4].imag = cwork[i__5].imag; // , expr subst
                        i__4 = q;
                        cwork[i__4].real = aapq.real;
                        cwork[i__4].imag = aapq.imag; // , expr subst
                    }
                    if(ir1 == 0)
                    {
                            ...
                            if(aaqq > 0.)
                            {
                                ...
                                if(f2c_dabs(aapq1) > tol)
                                {
                                    ...
                                    if(rotok)
                                    {
                                        ...
                                        i__5 = p;
                                        i__6 = q;
                                        z__2.real = -cwork[i__6].real;
                                        z__2.imag = -cwork[i__6].imag; // , expr subst
                                        z__1.real = z__2.real * ompq.real - z__2.imag * ompq.imag;
                                        z__1.imag = z__2.real * ompq.imag + z__2.imag * ompq.real; // , expr subst
                                        cwork[i__5].real = z__1.real;
                                        cwork[i__5].imag = z__1.imag; // , expr subst
                                    }
                                    else
                                    {
