...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggsvd3
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggsvd3
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggsvd3
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void sggsvd3_(char *jobu, char *jobv, char *jobq, aocl_int_t *m, aocl_int_t *n, aocl_int_t *p,
              aocl_int_t *k, aocl_int_t *l, real *a, aocl_int_t *lda, real *b, aocl_int_t *ldb,
              real *alpha, real *beta, real *u, aocl_int_t *ldu, real *v, aocl_int_t *ldv, real *q,
              aocl_int_t *ldq, real *work, aocl_int_t *lwork, aocl_int_t *iwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_sggsvd3(jobu, jobv, jobq, m, n, p, k, l, a, lda, b, ldb, alpha, beta, u, ldu, v,
    ...
    aocl_lapack_sggsvd3(jobu, jobv, jobq, &m_64, &n_64, &p_64, &k_64, &l_64, a, &lda_64, b, &ldb_64,
                        alpha, beta, u, &ldu_64, v, &ldv_64, q, &ldq_64, work, &lwork_64, iwork,
                        &info_64);
...
void aocl_lapack_sggsvd3(char *jobu, char *jobv, char *jobq, aocl_int64_t *m, aocl_int64_t *n,
                         aocl_int64_t *p, aocl_int64_t *k, aocl_int64_t *l, real *a,
                         aocl_int64_t *lda, real *b, aocl_int64_t *ldb, real *alpha, real *beta,
                         real *u, aocl_int64_t *ldu, real *v, aocl_int64_t *ldv, real *q,
                         aocl_int64_t *ldq, real *work, aocl_int64_t *lwork, aocl_int_t *iwork,
                         aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        aocl_lapack_sggsvp3(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, &tola,
                            &tolb, k, l, &u[u_offset], ldu, &v[v_offset], ldv, &q[q_offset], ldq,
                            &iwork[1], &work[1], &work[1], &c_n1, info);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SGGSVD3", &i__1, (ftnlen)7);
    ...
    bnorm = aocl_lapack_slange("1", p, n, &b[b_offset], ldb, &work[1]);
    ...
    aocl_lapack_sggsvp3(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, &tola,
                        &tolb, k, l, &u[u_offset], ldu, &v[v_offset], ldv, &q[q_offset], ldq,
                        &iwork[1], &work[1], &work[*n + 1], &i__1, info);
