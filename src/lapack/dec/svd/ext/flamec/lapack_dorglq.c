/* dorglq.f -- translated by f2c (version 20160102). You must link the resulting object file with
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dorglq.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dorglq.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dorglq.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                  ...
                  aocl_int64_t *info)
{
    ...
    extern int lapack_dorgl2(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, doublereal *,
    ...
    *info = 0;
    ...
    if(nb > 1 && nb < *k)
    {
        ...
        /* Computing MAX */
        i__1 = 0;
        i__2 = aocl_lapack_ilaenv(&c__3, "DORGLQ", " ", m, n, k, &c_n1); // , expr subst
        ...
        if(nx < *k)
        {
            ...
            if(*lwork < iws)
            {
                ...
                /* Computing MAX */
                i__1 = 2;
                i__2 = aocl_lapack_ilaenv(&c__2, "DORGLQ", " ", m, n, k, &c_n1); // , expr subst
    ...
    if(kk < *m)
    {
        ...
        i__2 = *n - kk;
        i__3 = *k - kk;
        lapack_dorgl2(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &tau[kk + 1],
                      &work[1], &iinfo);
    }
    if(kk > 0)
    {
        ...
        for(i__ = ki + 1; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            i__2 = *n - i__ + 1;
            lapack_dorgl2(&ib, &i__2, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1],
                          &iinfo);
