...
/* ==================================================================== */
/* Subroutine */
void ssytrs_3_(char *uplo, integer *n, integer *nrhs, real * a, integer *lda, real *e, integer *ipiv, real *b, integer *ldb, integer *info)
{
    ...
    logical upper;
    extern /* Subroutine */
    void sswap_(integer *, real *, integer *, real *, integer *), strsm_(char *, char *, char *, char *, integer *, integer *, real *, real *, integer *, real *, integer *), xerbla_(const char *srname, const integer *info, ftnlen srname_len);
