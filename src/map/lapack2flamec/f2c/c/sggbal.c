...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggbal.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggbal.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggbal.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void sggbal_(char *job, aocl_int_t *n, real *a, aocl_int_t *lda, real *b, aocl_int_t *ldb,
                        ...
                        real *rscale, real *work, aocl_int64_t *info)
{
    ...
    real r__1, r__2, r__3;
    /* Builtin functions */
    double r_lg10(real *), r_sign(real *, real *), pow_ri(real *, aocl_int64_t *);
    /* Local variables */
...
L160:
    ...
    i__1 = *n - k + 1;
    aocl_blas_sswap(&i__1, &a[i__ + k * a_dim1], lda, &a[m + k * a_dim1], lda);
    i__1 = *n - k + 1;
    aocl_blas_sswap(&i__1, &b[i__ + k * b_dim1], ldb, &b[m + k * b_dim1], ldb);
...
L170:
    ...
    aocl_blas_sswap(&l, &a[j * a_dim1 + 1], &c__1, &a[m * a_dim1 + 1], &c__1);
    aocl_blas_sswap(&l, &b[j * b_dim1 + 1], &c__1, &b[m * b_dim1 + 1], &c__1);
L180:
    switch(iflow)
    {
        case 1:
...
L350:
    ...
    {
        i__2 = *n - *ilo + 1;
        irab = aocl_blas_isamax(&i__2, &a[i__ + *ilo * a_dim1], lda);
        rab = (r__1 = a[i__ + (irab + *ilo - 1) * a_dim1], f2c_abs(r__1));
        i__2 = *n - *ilo + 1;
        irab = aocl_blas_isamax(&i__2, &b[i__ + *ilo * b_dim1], ldb);
        /* Computing MAX */
        r__2 = rab;
        ...
        icab = aocl_blas_isamax(ihi, &a[i__ * a_dim1 + 1], &c__1);
        cab = (r__1 = a[icab + i__ * a_dim1], f2c_abs(r__1));
        icab = aocl_blas_isamax(ihi, &b[i__ * b_dim1 + 1], &c__1);
        /* Computing MAX */
        r__2 = cab;
    ...
    {
        i__2 = *n - *ilo + 1;
        aocl_blas_sscal(&i__2, &lscale[i__], &a[i__ + *ilo * a_dim1], lda);
        i__2 = *n - *ilo + 1;
        aocl_blas_sscal(&i__2, &lscale[i__], &b[i__ + *ilo * b_dim1], ldb);
        /* L370: */
    }
    ...
    for(j = *ilo; j <= i__1; ++j)
    {
        aocl_blas_sscal(ihi, &rscale[j], &a[j * a_dim1 + 1], &c__1);
        aocl_blas_sscal(ihi, &rscale[j], &b[j * b_dim1 + 1], &c__1);
        /* L380: */
    }
    AOCL_DTL_TRACE_LOG_EXIT
    return;
