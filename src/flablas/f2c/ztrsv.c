...
#include "FLA_f2c.h"
/* Subroutine */
int ztrsv_(char *uplo, char *trans, char *diag, integer *n, dcomplex *a, integer *lda, dcomplex *x, integer *incx)
{
                        ...
                        --j)
                {
                    ...
                    if (x[i__1].real != 0. || x[i__1].imag != 0.)
                    {
                                ...
                                --i__)
                        {
                            ...
                            i__2 = i__;
                            i__3 = i__ + j * a_dim1;
                            z__2.real = temp.real * a[i__3].real - temp.imag * a[i__3].imag, z__2.imag = temp.real * a[i__3].imag + temp.imag * a[ i__3].real;
