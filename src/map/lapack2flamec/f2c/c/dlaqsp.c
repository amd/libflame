/* ../netlib/dlaqsp.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqsp.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqsp.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqsp.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dlaqsp(uplo, n, ap, s, scond, amax, equed);
#else
    aocl_int64_t n_64 = *n;

    aocl_lapack_dlaqsp(uplo, &n_64, ap, s, scond, amax, equed);
#endif
}

void aocl_lapack_dlaqsp(char *uplo, aocl_int64_t *n, doublereal *ap, doublereal *s,
