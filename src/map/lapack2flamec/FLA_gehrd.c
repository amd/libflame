...
LAPACK_gehrd(s)
{
                      ...
                      *m, *ilo, *ihi, *ldim_A);
    {
        LAPACK_RETURN_CHECK_VAR1(
            sgehrd_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, lwork, info), fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
        LAPACK_gehrd_body(s) fla_error = 0;
    }
...
LAPACK_gehrd(d)
{
    ...
    {
        LAPACK_RETURN_CHECK_VAR1(
            dgehrd_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, lwork, info), fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
        LAPACK_gehrd_body(d)
...
LAPACK_gehrd(c)
{
    int fla_error = LAPACK_SUCCESS;
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("cgehrd inputs: n %" FLA_IS ", ilo %" FLA_IS ", ihi %" FLA_IS ", lda %" FLA_IS
                      "",
                      *m, *ilo, *ihi, *ldim_A);
    {
        LAPACK_RETURN_CHECK_VAR1(
            cgehrd_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, lwork, info), fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
        LAPACK_gehrd_body(c)
...
LAPACK_gehrd(z)
{
    ...
    {
        LAPACK_RETURN_CHECK_VAR1(
            zgehrd_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, lwork, info), fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
        LAPACK_gehrd_body(z)
...
#define LAPACK_gehd2(prefix)                                                           \
    void F77_##prefix##gehd2(integer *m, integer *ilo, integer *ihi,                   \
                             PREFIX2LAPACK_TYPEDEF(prefix) * buff_A, integer * ldim_A, \
                             PREFIX2LAPACK_TYPEDEF(prefix) * buff_t,                   \
                             PREFIX2LAPACK_TYPEDEF(prefix) * buff_w, int *info)
...
LAPACK_gehd2(s)
{
    ...
    AOCL_DTL_SNPRINTF("sgehd2 inputs: n %" FLA_IS ", ilo %" FLA_IS ", ihi %" FLA_IS ", lda %" FLA_IS
                      ...
                      *m, *ilo, *ihi, *ldim_A);
    {
        LAPACK_RETURN_CHECK_VAR1(sgehd2_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, info),
                                 fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
...
LAPACK_gehd2(d)
{
    ...
    AOCL_DTL_SNPRINTF("dgehd2 inputs: n %" FLA_IS ", ilo %" FLA_IS ", ihi %" FLA_IS ", lda %" FLA_IS
                      ...
                      *m, *ilo, *ihi, *ldim_A);
    {
        LAPACK_RETURN_CHECK_VAR1(dgehd2_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, info),
                                 fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
...
LAPACK_gehd2(c)
{
    int fla_error = LAPACK_SUCCESS;
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("cgehd2 inputs: n %" FLA_IS ", ilo %" FLA_IS ", ihi %" FLA_IS ", lda %" FLA_IS
                      "",
                      *m, *ilo, *ihi, *ldim_A);
    {
        LAPACK_RETURN_CHECK_VAR1(cgehd2_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, info),
                                 fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
...
LAPACK_gehd2(z)
{
    ...
    AOCL_DTL_SNPRINTF("zgehd2 inputs: n %" FLA_IS ", ilo %" FLA_IS ", ihi %" FLA_IS ", lda %" FLA_IS
                      ...
                      *m, *ilo, *ihi, *ldim_A);
    {
        LAPACK_RETURN_CHECK_VAR1(zgehd2_check(m, ilo, ihi, buff_A, ldim_A, buff_t, buff_w, info),
                                 fla_error)
    }
    if(fla_error == LAPACK_SUCCESS)
    {
