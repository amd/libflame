...
int sgesdd_check(char *jobz, integer *m, integer *n, real *a, integer *lda, real *s, real *u,
        ...
        if(*m >= *n && minmn > 0)
        {
            ...
            if(*m >= mnthr)
            {
                ...
                else if(wntqo)
                {
                    ...
                    i__1 = wrkbl;
                    i__2 = *n * 3
                           + *n * ilaenv_(&c__1, "SORMBR", "QLN", n, n, n, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *n * 3
                           + *n * ilaenv_(&c__1, "SORMBR", "PRT", n, n, n, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
            ...
            else
            {
                ...
                else if(wntqo)
                {
                    ...
                    i__1 = wrkbl;
                    i__2 = *n * 3
                           + *n * ilaenv_(&c__1, "SORMBR", "QLN", m, n, n, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *n * 3
                ...
                else if(wntqa)
                {
                    ...
                    i__1 = wrkbl;
                    i__2 = *n * 3
                           + *m * ilaenv_(&c__1, "SORMBR", "QLN", m, m, n, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *n * 3
        ...
        else if(minmn > 0)
        {
            ...
            if(*n >= mnthr)
            {
                ...
                else if(wntqo)
                {
                    ...
                    i__1 = wrkbl;
                    i__2 = *m * 3
                           + *m * ilaenv_(&c__1, "SORMBR", "QLN", m, m, m, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *m * 3
                           + *m * ilaenv_(&c__1, "SORMBR", "PRT", m, m, m, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
            ...
            else
            {
                ...
                else if(wntqo)
                {
                    ...
                    i__1 = wrkbl;
                    i__2 = *m * 3
                           + *m * ilaenv_(&c__1, "SORMBR", "PRT", m, n, m, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = bdspac + *m * 3; // , expr subst
                ...
                else if(wntqa)
                {
                    ...
                    i__1 = wrkbl;
                    i__2 = *m * 3
                           + *m * ilaenv_(&c__1, "SORMBR", "PRT", n, n, m, &c_n1); // , expr subst
                    wrkbl = fla_max(i__1, i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = bdspac + *m * 3; // , expr subst
