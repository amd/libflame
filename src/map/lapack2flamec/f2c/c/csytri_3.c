/* ../netlib/v3.9.0/csytri_3.f -- translated by f2c (version 20160102). You must link the resulting
               ...
               complex *work, integer *lwork, integer *info)
{
    ...
    char buffer[256];
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256, "csytri_3 inputs: uplo %c, n %lld, lda %lld, lwork %lld", *uplo, *n, *lda,
             *lwork);
#else
    snprintf(buffer, 256, "csytri_3 inputs: uplo %c, n %d, lda %d, lwork %d", *uplo, *n, *lda,
             *lwork);
#endif
