...
/* ===================================================================== */
/* Subroutine */
void zhetrs_aa_(char *uplo, integer *n, integer *nrhs, doublecomplex *a, integer *lda,
    ...
    *info = 0;
    ...
    if(upper)
    {
        ...
        if(*n > 1)
        {
            ...
            i__1 = *n - 1;
            ztrsm_("L", "U", "C", "U", &i__1, nrhs, &c_b9, &a[(a_dim1 << 1) + 1], lda,
                   &b[b_dim1 + 2], ldb);
        }
    ...
    else
    {
        ...
        if(*n > 1)
        {
            ...
            i__1 = *n - 1;
            ztrsm_("L", "L", "C", "U", &i__1, nrhs, &c_b9, &a[a_dim1 + 2], lda, &b[b_dim1 + 2],
                   ldb);
