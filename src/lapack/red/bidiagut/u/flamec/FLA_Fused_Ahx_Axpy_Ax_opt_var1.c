...
*/
  ...
  fla_dim_t          m_A, n_A;
  fla_dim_t          rs_A, cs_A;
  fla_dim_t          inc_u, inc_a, inc_y, inc_w;
                                          ...
                                          double* buff_w, fla_dim_t inc_w )
{
  ...
  fla_dim_t       stepcs_A  = 2*cs_A;
  fla_dim_t       stepinc_y = 2*inc_y;
  fla_dim_t       stepinc_a = 2*inc_a;
                                          ...
                                          dcomplex* buff_w, fla_dim_t inc_w )
{
  ...
  fla_dim_t       n_run    = n_A / 2;
  fla_dim_t       n_left   = n_A % 2;
  fla_dim_t       twocs_A  = 2*cs_A;
  fla_dim_t       twoinc_y = 2*inc_y;
  fla_dim_t       twoinc_a = 2*inc_a;
