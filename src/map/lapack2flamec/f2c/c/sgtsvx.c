/* ../netlib/sgtsvx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgtsvx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgtsvx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgtsvx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void sgtsvx_(char *fact, char *trans, aocl_int_t *n, aocl_int_t *nrhs, real *dl, real *d__,
             real *du, real *dlf, real *df, real *duf, real *du2, aocl_int_t *ipiv, real *b,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(nofact)
    {
        ...
        {
            i__1 = *n - 1;
            aocl_blas_scopy(&i__1, &dl[1], &c__1, &dlf[1], &c__1);
            i__1 = *n - 1;
            aocl_blas_scopy(&i__1, &du[1], &c__1, &duf[1], &c__1);
        }
        aocl_lapack_sgttrf(n, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[1], info);
    ...
    aocl_lapack_sgtrfs(trans, n, nrhs, &dl[1], &d__[1], &du[1], &dlf[1], &df[1], &duf[1], &du2[1],
