    ...
    *info = 0;
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        if(i__ == 1)
        {
            ...
            phantom[1] = 1.;
            phantom[*p + 1] = 1.;
            aocl_lapack_dlarf("L", p, q, &phantom[1], &c__1, &taup1[1], &x11[x11_offset], ldx11,
                              &work[ilarf]);
            i__2 = *m - *p;
            aocl_lapack_dlarf("L", &i__2, q, &phantom[*p + 1], &c__1, &taup2[1], &x21[x21_offset],
                              ldx21, &work[ilarf]);
        }
        else
        {
            ...
            i__2 = *p - i__ + 1;
            i__3 = *q - i__ + 1;
            aocl_lapack_dlarf("L", &i__2, &i__3, &x11[i__ + (i__ - 1) * x11_dim1], &c__1,
                              &taup1[i__], &x11[i__ + i__ * x11_dim1], ldx11, &work[ilarf]);
            i__2 = *m - *p - i__ + 1;
            i__3 = *q - i__ + 1;
            aocl_lapack_dlarf("L", &i__2, &i__3, &x21[i__ + (i__ - 1) * x21_dim1], &c__1,
    ...
    for(i__ = *m - *q + 1; i__ <= i__1; ++i__)
    {
        ...
        i__2 = *p - i__;
        i__3 = *q - i__ + 1;
        aocl_lapack_dlarf("R", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], ldx11, &tauq1[i__],
                          &x11[i__ + 1 + i__ * x11_dim1], ldx11, &work[ilarf]);
        i__2 = *q - *p;
        i__3 = *q - i__ + 1;
        aocl_lapack_dlarf("R", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], ldx11, &tauq1[i__],
    ...
    for(i__ = *p + 1; i__ <= i__1; ++i__)
    {
        ...
        i__2 = *q - i__;
        i__3 = *q - i__ + 1;
        aocl_lapack_dlarf("R", &i__2, &i__3, &x21[*m - *q + i__ - *p + i__ * x21_dim1], ldx21,
