/* ../netlib/cla_herpvgrw.f -- translated by f2c (version 20160102). You must link the resulting
                   ...
                   integer *ldaf, integer *ipiv, real *work)
{
    ...
    char buffer[256];
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256, "cla_herpvgrw inputs: uplo %c, n %lld, lda %lld, ldaf %lld", *uplo, *n,
             *lda, *ldaf);
#else
    snprintf(buffer, 256, "cla_herpvgrw inputs: uplo %c, n %d, lda %d, ldaf %d", *uplo, *n, *lda,
             *ldaf);
#endif
