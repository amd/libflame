/* ../netlib/sgsvj0.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgsvj0.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgsvj0.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgsvj0.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void sgsvj0_(char *jobv, aocl_int_t *m, aocl_int_t *n, real *a, aocl_int_t *lda, real *d__,
             real *sva, aocl_int_t *mv, real *v, aocl_int_t *ldv, real *eps, real *sfmin, real *tol,
             aocl_int_t *nsweep, real *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_sgsvj0(jobv, m, n, a, lda, d__, sva, mv, v, ldv, eps, sfmin, tol, nsweep, work,
                       lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_sgsvj0(jobv, &m_64, &n_64, a, &lda_64, d__, sva, &mv_64, v, &ldv_64, eps, sfmin,
...
void aocl_lapack_sgsvj0(char *jobv, aocl_int64_t *m, aocl_int64_t *n, real *a, aocl_int64_t *lda,
                        real *d__, real *sva, aocl_int64_t *mv, real *v, aocl_int64_t *ldv,
                        real *eps, real *sfmin, real *tol, aocl_int64_t *nsweep, real *work,
                        aocl_int64_t *lwork, aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("sgsvj0 inputs: jobv %c ,m %" FLA_IS ",n %" FLA_IS ",lda %" FLA_IS
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SGSVJ0", &i__1, (ftnlen)6);
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        ...
        for(ibr = 1; ibr <= i__2; ++ibr)
        {
            ...
            for(ir1 = 0; ir1 <= i__3; ++ir1)
            {
                ...
                for(p = igl; p <= i__4; ++p)
                {
                    /* .. de Rijk's pivoting */
                    i__5 = *n - p + 1;
                    q = aocl_blas_isamax(&i__5, &sva[p], &c__1) + p - 1;
                    if(p != q)
                    {
                    ...
                    if(ir1 == 0)
                    {
                        ...
                        {
                            sva[p] = aocl_blas_snrm2(m, &a[p * a_dim1 + 1], &c__1) * d__[p];
                        }
                        else
                        {
                            temp1 = 0.f;
                        ...
                        for(q = p + 1; q <= i__5; ++q)
                        {
                            ...
                            if(aaqq > 0.f)
                            {
                                ...
                                if(aaqq >= 1.f)
                                {
                                    ...
                                    {
                                        aocl_blas_scopy(m, &a[p * a_dim1 + 1], &c__1, &work[1],
                                                        &c__1);
                                        aocl_lapack_slascl("G", &c__0, &c__0, &aapp, &d__[p], m,
                                                           &c__1, &work[1], lda, &ierr);
                                        aapq = aocl_blas_sdot(m, &work[1], &c__1,
                                                              &a[q * a_dim1 + 1], &c__1)
                                               * d__[q] / aaqq;
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        aocl_blas_scopy(m, &a[q * a_dim1 + 1], &c__1, &work[1],
                                                        &c__1);
                                        aocl_lapack_slascl("G", &c__0, &c__0, &aaqq, &d__[q], m,
                                                           &c__1, &work[1], lda, &ierr);
                                        aapq = aocl_blas_sdot(m, &work[1], &c__1,
                                                              &a[p * a_dim1 + 1], &c__1)
                                               * d__[p] / aapp;
                                ...
                                if(f2c_abs(aapq) > *tol)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        aocl_blas_scopy(m, &a[p * a_dim1 + 1], &c__1, &work[1],
                                                        &c__1);
                                        aocl_lapack_slascl("G", &c__0, &c__0, &aapp, &c_b42, m,
                                                           &c__1, &work[1], lda, &ierr);
                                        aocl_lapack_slascl("G", &c__0, &c__0, &aaqq, &c_b42, m,
                                                           &c__1, &a[q * a_dim1 + 1], lda, &ierr);
                                        temp1 = -aapq * d__[p] / d__[q];
                                        aocl_blas_saxpy(m, &temp1, &work[1], &c__1,
                                                        &a[q * a_dim1 + 1], &c__1);
                                        aocl_lapack_slascl("G", &c__0, &c__0, &c_b42, &aaqq, m,
                                                           &c__1, &a[q * a_dim1 + 1], lda, &ierr);
                                        /* Computing MAX */
                                        r__1 = 0.f;
                                    ...
                                    if(r__1 * r__1 <= rooteps)
                                    {
                                        ...
                                        {
                                            sva[q] = aocl_blas_snrm2(m, &a[q * a_dim1 + 1], &c__1) * d__[q];
                                        }
                                        else
                                        {
                                            t = 0.f;
                                    ...
                                    if(aapp / aapp0 <= rooteps)
                                    {
                                        ...
                                        {
                                            aapp = aocl_blas_snrm2(m, &a[p * a_dim1 + 1], &c__1) * d__[p];
                                        }
                                        else
                                        {
                                            t = 0.f;
                                ...
                                if(f2c_abs(aapq) > *tol)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            aocl_blas_saxpy(m, &temp1, &work[1], &c__1,
                                                            &a[p * a_dim1 + 1], &c__1);
                                            aocl_lapack_slascl("G", &c__0, &c__0, &c_b42, &aapp, m,
                                                               &c__1, &a[p * a_dim1 + 1], lda,
                                                               &ierr);
                                            /* Computing MAX */
                                            r__1 = 0.f;
        ...
        {
            sva[*n] = aocl_blas_snrm2(m, &a[*n * a_dim1 + 1], &c__1) * d__[*n];
        }
        else
        {
            t = 0.f;
