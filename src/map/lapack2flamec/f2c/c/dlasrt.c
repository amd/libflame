...
void dlasrt_(char *id, aocl_int_t *n, doublereal *d__, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dlasrt(id, n, d__, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t info_64 = *info;

    aocl_lapack_dlasrt(id, &n_64, d__, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dlasrt(char *id, aocl_int64_t *n, doublereal *d__, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DLASRT", &i__1, (ftnlen)6);
