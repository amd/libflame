...
/* ===================================================================== */
/* Subroutine */
void cunmql_(char *side, char *trans, integer *m, integer *n, integer *k, complex *a, integer *lda,
             complex *tau, complex *c__, integer *ldc, complex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        cunm2l_(char *, char *, integer *, integer *, integer *, complex *, integer *, complex *,
    ...
    *info = 0;
    ...
    {
        /* Use unblocked code */
        cunm2l_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[c_offset], ldc, &work[1],
                &iinfo);
    }
    else
    {
        ...
        for(i__ = i1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            i__4 = nq - *k + i__ + ib - 1;
            clarft_("Backward", "Columnwise", &i__4, &ib, &a[i__ * a_dim1 + 1], lda, &tau[i__],
                    &work[iwt], &c__65);
            if(left)
            {
            ...
            /* Apply H or H**H */
            clarfb_(side, trans, "Backward", "Columnwise", &mi, &ni, &ib, &a[i__ * a_dim1 + 1], lda,
