...
/* ===================================================================== */
/* Subroutine */
void ztpmqrt_(char *side, char *trans, integer *m, integer *n, integer *k, integer *l, integer *nb,
    ...
    *info = 0;
    ...
    if(left && tran)
    {
        ...
        for(i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            ztprfb_("L", "C", "F", "C", &mb, n, &ib, &lb, &v[i__ * v_dim1 + 1], ldv,
    ...
    else if(right && notran)
    {
        ...
        for(i__ = 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            ...
            ztprfb_("R", "N", "F", "C", m, &mb, &ib, &lb, &v[i__ * v_dim1 + 1], ldv,
    ...
    else if(left && notran)
    {
        ...
        for(i__ = kf; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            ztprfb_("L", "N", "F", "C", &mb, n, &ib, &lb, &v[i__ * v_dim1 + 1], ldv,
                    &t[i__ * t_dim1 + 1], ldt, &a[i__ + a_dim1], lda, &b[b_offset], ldb, &work[1],
                    &ib);
        }
    }
    else if(right && tran)
    {
        ...
        for(i__ = kf; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            ztprfb_("R", "C", "F", "C", m, &mb, &ib, &lb, &v[i__ * v_dim1 + 1], ldv,
                    &t[i__ * t_dim1 + 1], ldt, &a[i__ * a_dim1 + 1], lda, &b[b_offset], ldb,
                    &work[1], m);
        }
    }
