...
/* ===================================================================== */
/* Subroutine */
void zunmrq_(char *side, char *trans, integer *m, integer *n, integer *k, doublecomplex *a,
             ...
             doublecomplex *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
    ...
    {
        /* Use unblocked code */
        zunmr2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[c_offset], ldc, &work[1],
                &iinfo);
    }
    else
    {
        ...
        for(i__ = i1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            i__4 = nq - *k + i__ + ib - 1;
            zlarft_("Backward", "Rowwise", &i__4, &ib, &a[i__ + a_dim1], lda, &tau[i__], &work[iwt],
                    &c__65);
            if(left)
            {
            ...
            /* Apply H or H**H */
            zlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &a[i__ + a_dim1], lda,
