...
#include "FLA_f2c.h"
/* Subroutine */
int ctbsv_(char *uplo, char *trans, char *diag, integer *n, integer *k, scomplex *a, integer *lda, scomplex *x, integer *incx)
{
                        ...
                        --j)
                {
                    ...
                    if (noconj)
                    {
                                ...
                                --i__)
                        {
                            i__1 = l + i__ + j * a_dim1;
                            i__4 = i__;
                            q__2.real = a[i__1].real * x[i__4].real - a[i__1].imag * x[ i__4].imag, q__2.imag = a[i__1].real * x[i__4].imag + a[i__1].imag * x[i__4].real;
                            q__1.real = temp.real - q__2.real, q__1.imag = temp.imag - q__2.imag;
                            temp.real = q__1.real, temp.imag = q__1.imag;
                            /* L150: */
                        }
