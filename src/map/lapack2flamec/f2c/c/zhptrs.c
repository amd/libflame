/* ../netlib/zhptrs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zhptrs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zhptrs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zhptrs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > ZHPTRS solves a system of linear equations A*X = B with a scomplex */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhptrs(uplo, n, nrhs, ap, ipiv, b, ldb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zhptrs(uplo, &n_64, &nrhs_64, ap, ipiv, b, &ldb_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zhptrs(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, dcomplex *ap,
                        aocl_int_t *ipiv, dcomplex *b, aocl_int64_t *ldb, aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("zhptrs inputs: uplo %c, n %" FLA_IS ", nrhs %" FLA_IS ", ldb %" FLA_IS "",
                      *uplo, *n, *nrhs, *ldb);
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHPTRS", &i__1, (ftnlen)6);
