...
/* ../netlib/csysvxx.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/csysvxx
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/csysvxx
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/csysvxx
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void csysvxx_(char *fact, char *uplo, integer *n, integer *nrhs, scomplex *a, integer *lda,
              ...
              real *params, scomplex *work, real *rwork, integer *info)
{
...
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,
             "csysvxx inputs: fact %c, uplo %c, n %lld, nrhs %lld, lda %lld, ldaf %lld, ldb %lld, "
             "ldx %lld, n_err_bnds__ %lld, nparams %lld",
             *fact, *uplo, *n, *nrhs, *lda, *ldaf, *ldb, *ldx, *n_err_bnds__, *nparams);
#else
    snprintf(buffer, 256,
             "csysvxx inputs: fact %c, uplo %c, n %d, nrhs %d, lda %d, ldaf %d, ldb %d, ldx %d, "
    ...
    integer j;
    real amax, smin, smax;
    extern real cla_syrpvgrw_(char *, integer *, integer *, scomplex *, integer *, scomplex *,
    ...
    extern /* Subroutine */
        void
        claqsy_(char *, integer *, scomplex *, integer *, real *, real *, real *, char *),
        csytrf_(char *, integer *, scomplex *, integer *, integer *, scomplex *, integer *,
                integer *);
    real smlnum;
    extern /* Subroutine */
        void
        ...
        csytrs_(char *, integer *, integer *, scomplex *, integer *, integer *, scomplex *, integer *,
                integer *),
        csyequb_(char *, integer *, scomplex *, integer *, real *, real *, real *, scomplex *,
                 integer *),
        csyrfsx_(char *, char *, integer *, integer *, scomplex *, integer *, scomplex *, integer *,
    ...
    *rpvgrw = 0.f;
    ...
    if(nofact || equil)
    {
        ...
        if(*info > 0)
        {
            ...
            if(*n > 0)
            {
                *rpvgrw = cla_syrpvgrw_(uplo, n, info, &a[a_offset], lda, &af[af_offset], ldaf,
                                        &ipiv[1], &rwork[1]);
            }
            AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
            return;
    ...
    if(*n > 0)
    {
        *rpvgrw = cla_syrpvgrw_(uplo, n, info, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1],
                                &rwork[1]);
    }
    ...
    csyrfsx_(uplo, equed, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], &s[1],
