...
/* ../netlib/cgbsvxx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbsvxx
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbsvxx
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbsvxx
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void cgbsvxx_(char *fact, char *trans, integer *n, integer *kl, integer *ku, integer *nrhs,
              scomplex *ab, integer *ldab, scomplex *afb, integer *ldafb, integer *ipiv, char *equed,
              real *r__, real *c__, scomplex *b, integer *ldb, scomplex *x, integer *ldx, real *rcond,
              ...
              integer *info)
{
    ...
    integer i__, j;
    real amax;
    extern real cla_gbrpvgrw_(integer *, integer *, integer *, integer *, scomplex *, integer *,
                              scomplex *, integer *);
    ...
    extern /* Subroutine */
        void
        claqgb_(integer *, integer *, integer *, integer *, scomplex *, integer *, real *, real *,
                real *, real *, real *, char *);
    real colcnd;
    extern real slamch_(char *);
    extern /* Subroutine */
        void
        cgbtrf_(integer *, integer *, integer *, integer *, scomplex *, integer *, integer *,
                integer *);
    logical nofact;
    extern /* Subroutine */
        void
    ...
    extern /* Subroutine */
        ...
        cgbequb_(integer *, integer *, integer *, integer *, scomplex *, integer *, real *, real *,
                 real *, real *, real *, integer *),
        cgbrfsx_(char *, char *, integer *, integer *, integer *, integer *, scomplex *, integer *,
                 scomplex *, integer *, integer *, real *, real *, scomplex *, integer *, scomplex *,
                 integer *, real *, real *, integer *, real *, real *, integer *, real *, scomplex *,
                 real *, integer *);
    ...
    *rpvgrw = 0.f;
    ...
    if(equil)
    {
        ...
        cgbequb_(n, n, kl, ku, &ab[ab_offset], ldab, &r__[1], &c__[1], &rowcnd, &colcnd, &amax,
                 &infequ);
        if(infequ == 0)
        {
    ...
    *rpvgrw = cla_gbrpvgrw_(n, kl, ku, n, &ab[ab_offset], ldab, &afb[afb_offset], ldafb);
    ...
    cgbrfsx_(trans, equed, n, kl, ku, nrhs, &ab[ab_offset], ldab, &afb[afb_offset], ldafb, &ipiv[1],
