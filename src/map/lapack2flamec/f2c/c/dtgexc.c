/* ../netlib/dtgexc.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgexc.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgexc.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgexc.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dtgexc(wantq, wantz, n, a, lda, b, ldb, q, ldq, z__, ldz, ifst, ilst, work, lwork,
                       info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dtgexc(wantq, wantz, &n_64, a, &lda_64, b, &ldb_64, q, &ldq_64, z__, &ldz_64,
                       &ifst_64, &ilst_64, work, &lwork_64, &info_64);
...
void aocl_lapack_dtgexc(logical *wantq, logical *wantz, aocl_int64_t *n, doublereal *a,
                        aocl_int64_t *lda, doublereal *b, aocl_int64_t *ldb, doublereal *q,
                        aocl_int64_t *ldq, doublereal *z__, aocl_int64_t *ldz, aocl_int64_t *ifst,
                        aocl_int64_t *ilst, doublereal *work, aocl_int64_t *lwork,
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DTGEXC", &i__1, (ftnlen)6);
