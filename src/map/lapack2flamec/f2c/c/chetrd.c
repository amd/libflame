...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_chetrd(uplo, n, a, lda, d__, e, tau, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_chetrd(uplo, &n_64, a, &lda_64, d__, e, tau, work, &lwork_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_chetrd(char *uplo, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda, real *d__,
                        real *e, scomplex *tau, scomplex *work, aocl_int64_t *lwork,
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(upper)
    {
        ...
        aocl_lapack_chetd2(uplo, &kk, &a[a_offset], lda, &d__[1], &e[1], &tau[1], &iinfo);
    }
    else
    {
