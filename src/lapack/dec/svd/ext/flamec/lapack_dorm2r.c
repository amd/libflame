/* lapack_dorm2r.f -- translated by f2c (version 20160102). You must link the resulting object file
 with libf2c: on Microsoft Windows system, link with libf2c.lib; on Linux or Unix systems, link with
...
/* > \brief \b lapack_dorm2r multiplies a general matrix by the orthogonal matrix from a QR
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/lapack_dorm2r.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/lapack_dorm2r.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/lapack_dorm2r.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                  ...
                  aocl_int64_t *ldc, doublereal *work, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("lapack_dorm2r", &i__1, (ftnlen)13);
        return 0;
    }
