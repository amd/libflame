...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chegv_2
 * stage.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chegv_2
 * stage.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chegv_2
 * stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void chegv_2stage_(aocl_int_t *itype, char *jobz, char *uplo, aocl_int_t *n, scomplex *a,
                   aocl_int_t *lda, scomplex *b, aocl_int_t *ldb, real *w, scomplex *work,
                   aocl_int_t *lwork, real *rwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_chegv_2stage(itype, jobz, uplo, n, a, lda, b, ldb, w, work, lwork, rwork, info);
#else
    ...
    aocl_lapack_chegv_2stage(&itype_64, jobz, uplo, &n_64, a, &lda_64, b, &ldb_64, w, work,
...
void aocl_lapack_chegv_2stage(aocl_int64_t *itype, char *jobz, char *uplo, aocl_int64_t *n,
                              scomplex *a, aocl_int64_t *lda, scomplex *b, aocl_int64_t *ldb, real *w,
                              scomplex *work, aocl_int64_t *lwork, real *rwork, aocl_int64_t *info)
{
    ...
    snprintf(
        buffer, 256,
        "chegv_2stage inputs: itype %lld, jobz %c, uplo %c, n %lld, lda %lld, ldb %lld, lwork %lld",
        *itype, *jobz, *uplo, *n, *lda, *ldb, *lwork);
#else
    snprintf(buffer, 256,
             "chegv_2stage inputs: itype %d, jobz %c, uplo %c, n %d, lda %d, ldb %d, lwork %d",
             *itype, *jobz, *uplo, *n, *lda, *ldb, *lwork);
#endif
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHEGV_2STAGE", &i__1, (ftnlen)12);
    ...
    aocl_lapack_cheev_2stage(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &rwork[1],
                             info);
    if(wantz)
    {
