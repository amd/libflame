/* ../netlib/sorgqr.f -- translated by f2c (version 20000121). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sorgqr.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sorgqr.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sorgqr.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                  ...
                  real *tau, real *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    /* Local variables */
    aocl_int64_t i__, j, l, nbmin, iinfo, ib;
    extern /* Subroutine */
        int
        lapack_sorg2r(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, real *, aocl_int64_t *,
                      real *, real *, aocl_int64_t *);
    aocl_int64_t nb, ki, kk, nx;
    ...
    *info = 0;
    ...
    if(nb > 1 && nb < *k)
    {
        ...
        /* Computing MAX */
        i__1 = 0;
        i__2 = aocl_lapack_ilaenv(&c__3, "SORGQR", " ", m, n, k, &c_n1); // , expr subst
        ...
        if(nx < *k)
        {
            ...
            if(*lwork < iws)
            {
                ...
                /* Computing MAX */
                i__1 = 2;
                i__2 = aocl_lapack_ilaenv(&c__2, "SORGQR", " ", m, n, k, &c_n1); // , expr subst
    ...
    if(kk < *n)
    {
        ...
        i__2 = *n - kk;
        i__3 = *k - kk;
        lapack_sorg2r(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &tau[kk + 1],
                      &work[1], &iinfo);
    }
    if(kk > 0)
    {
        ...
        for(i__ = ki + 1; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            i__2 = *m - i__ + 1;
            lapack_sorg2r(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1],
                          &iinfo);
