...
/* > \verbatim */
/* > */
/* > ZHPTRF computes the factorization of a scomplex Hermitian packed */
    ...
    L10:
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    i__1 = kpc + imax - 1;
                    if((d__1 = ap[i__1].real, f2c_dabs(d__1)) >= alpha * rowmax)
                    {
            ...
            if(kstep == 1)
            {
                ...
                i__1 = k - 1;
                d__1 = -r1;
                aocl_blas_zhpr(uplo, &i__1, &d__1, &ap[kc], &c__1, &ap[1]);
                /* Store U(k) in column k */
                i__1 = k - 1;
                aocl_blas_zdscal(&i__1, &r1, &ap[kc], &c__1);
            }
            else
            {
                ...
                if(k > 2)
                {
                    ...
                    tt = 1. / (d11 * d22 - 1.);
                    i__1 = k - 1 + (k - 1) * k / 2;
                    z__1.real = ap[i__1].real / d__;
                    z__1.imag = ap[i__1].imag / d__; // , expr subst
                    d12.real = z__1.real;
        ...
        else
        {
            ...
            if(kstep == 1)
            {
                ...
                if(k < *n)
                {
                    ...
                    i__1 = *n - k;
                    d__1 = -r1;
                    aocl_blas_zhpr(uplo, &i__1, &d__1, &ap[kc + 1], &c__1, &ap[kc + *n - k + 1]);
                    /* Store L(k) in column K */
                    i__1 = *n - k;
                    aocl_blas_zdscal(&i__1, &r1, &ap[kc + 1], &c__1);
                }
            }
            else
            {
