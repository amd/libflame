...
/* ===================================================================== */
/* Subroutine */
void ssbevx_2stage_(char *jobz, char *range, char *uplo, integer *n, integer *kd, real *ab,
                    ...
                    real *work, integer *lwork, integer *iwork, integer *ifail, integer *info)
{
    ...
    char buffer[256];
    snprintf(buffer, 256,
             "ssbevx_2stage inputs: jobz %c, range %c, uplo %c, n %" FLA_IS ", kd %" FLA_IS
    ...
    *m = 0;
    ...
    ssytrd_sb2st_("N", jobz, uplo, n, kd, &ab[ab_offset], ldab, &work[indd], &work[inde],
    ...
    if(wantz)
    {
        ...
        for(j = 1; j <= i__1; ++j)
        {
            ...
            sgemv_("N", n, n, &c_b24, &q[q_offset], ldq, &work[1], &c__1, &c_b45,
                   &z__[j * z_dim1 + 1], &c__1);
            /* L20: */
        }
    }
