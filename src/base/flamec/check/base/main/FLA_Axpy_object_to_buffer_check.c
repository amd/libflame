...
FLA_Error FLA_Axpy_object_to_buffer_check( FLA_Trans trans, FLA_Obj alpha, fla_dim_t i, fla_dim_t j, FLA_Obj A, fla_dim_t m, fla_dim_t n, void* B_buffer, fla_dim_t rs, fla_dim_t cs )
{
  FLA_Error e_val;
