...
FLA_Error FLA_Househ3UD_UT_ops( fla_dim_t       m_x1,
                                fla_dim_t       m_y2,
                                float*    chi_0,
                                float*    x1, fla_dim_t inc_x1,
                                float*    y2, fla_dim_t inc_y2,
                                float*    tau )
{
...
FLA_Error FLA_Househ3UD_UT_opd( fla_dim_t       m_x1,
                                fla_dim_t       m_y2,
                                double*   chi_0,
                                double*   x1, fla_dim_t inc_x1,
                                double*   y2, fla_dim_t inc_y2,
                                double*   tau )
{
...
FLA_Error FLA_Househ3UD_UT_opc( fla_dim_t       m_x1,
                                fla_dim_t       m_y2,
                                scomplex* chi_0,
                                scomplex* x1, fla_dim_t inc_x1,
                                scomplex* y2, fla_dim_t inc_y2,
                                scomplex* tau )
{
...
FLA_Error FLA_Househ3UD_UT_opz( fla_dim_t       m_x1,
                                fla_dim_t       m_y2,
                                dcomplex* chi_0,
                                dcomplex* x1, fla_dim_t inc_x1,
                                dcomplex* y2, fla_dim_t inc_y2,
                                dcomplex* tau )
{
