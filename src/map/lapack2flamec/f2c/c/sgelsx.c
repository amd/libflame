/* ../netlib/sgelsx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgelsx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgelsx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgelsx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
             ...
             real *work, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SGELSX", &i__1, (ftnlen)6);
    ...
    /* A * P = Q * R */
    aocl_lapack_sgeqpf(m, n, &a[a_offset], lda, &jpvt[1], &work[1], &work[mn + 1], info);
...
L10:
    ...
    if(*rank < *n)
    {
        aocl_lapack_stzrqf(rank, n, &a[a_offset], lda, &work[mn + 1], info);
    }
