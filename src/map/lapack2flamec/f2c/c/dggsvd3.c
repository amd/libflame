...
void dggsvd3_(char *jobu, char *jobv, char *jobq, aocl_int_t *m, aocl_int_t *n, aocl_int_t *p,
              aocl_int_t *k, aocl_int_t *l, doublereal *a, aocl_int_t *lda, doublereal *b,
              aocl_int_t *ldb, doublereal *alpha, doublereal *beta, doublereal *u, aocl_int_t *ldu,
              doublereal *v, aocl_int_t *ldv, doublereal *q, aocl_int_t *ldq, doublereal *work,
              aocl_int_t *lwork, aocl_int_t *iwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dggsvd3(jobu, jobv, jobq, m, n, p, k, l, a, lda, b, ldb, alpha, beta, u, ldu, v,
    ...
    aocl_lapack_dggsvd3(jobu, jobv, jobq, &m_64, &n_64, &p_64, &k_64, &l_64, a, &lda_64, b, &ldb_64,
...
void aocl_lapack_dggsvd3(char *jobu, char *jobv, char *jobq, aocl_int64_t *m, aocl_int64_t *n,
                         aocl_int64_t *p, aocl_int64_t *k, aocl_int64_t *l, doublereal *a,
                         aocl_int64_t *lda, doublereal *b, aocl_int64_t *ldb, doublereal *alpha,
                         doublereal *beta, doublereal *u, aocl_int64_t *ldu, doublereal *v,
                         aocl_int64_t *ldv, doublereal *q, aocl_int64_t *ldq, doublereal *work,
                         aocl_int64_t *lwork, aocl_int_t *iwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        aocl_lapack_dggsvp3(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, &tola,
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DGGSVD3", &i__1, (ftnlen)7);
    ...
    bnorm = aocl_lapack_dlange("1", p, n, &b[b_offset], ldb, &work[1]);
