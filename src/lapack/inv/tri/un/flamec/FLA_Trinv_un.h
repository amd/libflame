...
FLA_Error FLA_Trinv_un_ops_var1( fla_dim_t mn_A,
                                 float*    A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opd_var1( fla_dim_t mn_A,
                                 double*   A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opc_var1( fla_dim_t mn_A,
                                 scomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opz_var1( fla_dim_t mn_A,
...
FLA_Error FLA_Trinv_un_ops_var3( fla_dim_t mn_A,
                                 float*    A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opd_var3( fla_dim_t mn_A,
                                 double*   A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opc_var3( fla_dim_t mn_A,
                                 scomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opz_var3( fla_dim_t mn_A,
                                 dcomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );

FLA_Error FLA_Trinv_un_opt_var4( FLA_Obj A );
FLA_Error FLA_Trinv_un_ops_var4( fla_dim_t mn_A,
                                 float*    A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opd_var4( fla_dim_t mn_A,
                                 double*   A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opc_var4( fla_dim_t mn_A,
                                 scomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Trinv_un_opz_var4( fla_dim_t mn_A,
                                 dcomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
