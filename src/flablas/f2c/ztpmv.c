                        ...
                        ++j)
                {
                    ...
                    if (x[i__2].real != 0. || x[i__2].imag != 0.)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__3 = j;
                            i__4 = kk + j - 1;
                            z__1.real = x[i__3].real * ap[i__4].real - x[i__3].imag * ap[ i__4].imag, z__1.imag = x[i__3].real * ap[i__4].imag + x[i__3].imag * ap[i__4].real;
                        ...
                        --j)
                {
                    ...
                    if (x[i__1].real != 0. || x[i__1].imag != 0.)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__2 = j;
                            i__3 = kk - *n + j;
                            z__1.real = x[i__2].real * ap[i__3].real - x[i__2].imag * ap[ i__3].imag, z__1.imag = x[i__2].real * ap[i__3].imag + x[i__2].imag * ap[i__3].real;
            ...
            if (*incx == 1)
            {
                        ...
                        --j)
                {
                    ...
                    if (noconj)
                    {
                        ...
                        {
                            i__1 = kk;
                            z__1.real = temp.real * ap[i__1].real - temp.imag * ap[i__1] .imag, z__1.imag = temp.real * ap[i__1].imag + temp.imag * ap[i__1].real;
                                ...
                                --i__)
                        {
                            i__1 = k;
                            i__2 = i__;
                            z__2.real = ap[i__1].real * x[i__2].real - ap[i__1].imag * x[ i__2].imag, z__2.imag = ap[i__1].real * x[i__2].imag + ap[i__1].imag * x[i__2].real;
            ...
            if (*incx == 1)
            {
                        ...
                        ++j)
                {
                    ...
                    if (noconj)
                    {
                        ...
                        {
                            i__2 = kk;
                            z__1.real = temp.real * ap[i__2].real - temp.imag * ap[i__2] .imag, z__1.imag = temp.real * ap[i__2].imag + temp.imag * ap[i__2].real;
                            temp.real = z__1.real, temp.imag = z__1.imag;
                        }
                        i__2 = *n;
                        for (i__ = j + 1;
