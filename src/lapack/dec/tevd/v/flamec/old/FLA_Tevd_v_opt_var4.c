...
FLA_Error FLA_Tevd_v_ops_var4( aocl_int64_t       m_A,
                               aocl_int64_t       m_U,
                               aocl_int64_t       n_G,
                               aocl_int64_t       n_G_extra,
...
FLA_Error FLA_Tevd_v_opd_var4( aocl_int64_t       m_A,
                               aocl_int64_t       m_U,
                               aocl_int64_t       n_G,
                               aocl_int64_t       n_G_extra,
...
FLA_Error FLA_Tevd_v_opc_var4( aocl_int64_t       m_A,
                               aocl_int64_t       m_U,
                               aocl_int64_t       n_G,
                               aocl_int64_t       n_G_extra,
                               float*    buff_d, aocl_int64_t inc_d, 
...
FLA_Error FLA_Tevd_v_opz_var4( aocl_int64_t       m_A,
                               aocl_int64_t       m_U,
                               aocl_int64_t       n_G,
                               aocl_int64_t       n_G_extra,
                               double*   buff_d, aocl_int64_t inc_d, 
                               ...
                               aocl_int64_t       b_alg )
{
	dcomplex  one        = bl1_z1();
	double    zero       = bl1_d0();
	aocl_int64_t       n_iter_max = n_G_extra;

	dcomplex* G;
	double*   d1;
	double*   e1;
	aocl_int64_t       total_eigs_found;
	aocl_int64_t       n_eigs_found;
	aocl_int64_t       n_iter_perf;
	aocl_int64_t       n_U_apply;
	aocl_int64_t       m_G_sweep_max;
	aocl_int64_t       ij_begin;
	aocl_int64_t       ijTL, ijBR;
	aocl_int64_t       m_A11;
