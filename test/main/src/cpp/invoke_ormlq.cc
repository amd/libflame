                      ...
                      integer *lwork, integer *info)
{
    switch(datatype)
    {
        case FLOAT:
        {
            libflame::ormlq<float>(side, trans, m, n, k, (float *)A, lda, (float *)tau, (float *)C,
        ...
        case DOUBLE:
        {
            libflame::ormlq<double>(side, trans, m, n, k, (double *)A, lda, (double *)tau,
                                    (double *)C, ldc, (double *)work, lwork, info);
            break;
        }
        case COMPLEX:
        {
            libflame::unmlq<scomplex>(side, trans, m, n, k, (scomplex *)A, lda, (scomplex *)tau,
        ...
        case DOUBLE_COMPLEX:
        {
            libflame::unmlq<dcomplex>(side, trans, m, n, k, (dcomplex *)A, lda, (dcomplex *)tau,
