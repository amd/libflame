...
/* ===================================================================== */
/* Subroutine */
void spprfs_(char *uplo, integer *n, integer *nrhs, real *ap, real *afp, real *b, integer *ldb,
             ...
             integer *info)
{
    ...
    char buffer[256];
    snprintf(buffer, 256, "spprfs inputs: uplo %c, n %d, nrhs %d, ldb %d, ldx %d", *uplo, *n, *nrhs,
             *ldb, *ldx);
