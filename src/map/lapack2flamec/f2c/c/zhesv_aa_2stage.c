...
/* ===================================================================== */
/* Subroutine */
void zhesv_aa_2stage_(char *uplo, integer *n, integer *nrhs, doublecomplex *a, integer *lda,
                      ...
                      integer *info)
{
    ...
    extern /* Subroutine */
        void
        zhetrf_aa_2stage_(char *, integer *, doublecomplex *, integer *, doublecomplex *, integer *,
                          integer *, integer *, doublecomplex *, integer *, integer *),
        zhetrs_aa_2stage_(char *, integer *, integer *, doublecomplex *, integer *, doublecomplex *,
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        zhetrf_aa_2stage_(uplo, n, &a[a_offset], lda, &tb[1], &c_n1, &ipiv[1], &ipiv2[1], &work[1],
                          &c_n1, info);
    ...
    zhetrf_aa_2stage_(uplo, n, &a[a_offset], lda, &tb[1], ltb, &ipiv[1], &ipiv2[1], &work[1], lwork,
                      info);
    if(*info == 0)
    {
        /* Solve the system A*X = B, overwriting B with X. */
        zhetrs_aa_2stage_(uplo, n, nrhs, &a[a_offset], lda, &tb[1], ltb, &ipiv[1], &ipiv2[1],
                          &b[b_offset], ldb, info);
    }
