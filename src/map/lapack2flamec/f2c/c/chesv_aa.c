...
/* > \verbatim */
/* > */
/* > CHESV_AA computes the solution to a scomplex system of linear equations */
/* > A * X = B, */
...
void chesv_aa_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, scomplex *a, aocl_int_t *lda,
               aocl_int_t *ipiv, scomplex *b, aocl_int_t *ldb, scomplex *work, aocl_int_t *lwork,
               aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_chesv_aa(uplo, n, nrhs, a, lda, ipiv, b, ldb, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_chesv_aa(uplo, &n_64, &nrhs_64, a, &lda_64, ipiv, b, &ldb_64, work, &lwork_64,
                         &info_64);
...
void aocl_lapack_chesv_aa(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, scomplex *a,
                          ...
                          scomplex *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    real r__1;
    /* Local variables */
    aocl_int64_t lwkopt_hetrf__, lwkopt_hetrs__;
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        /* Computing MAX */
        i__1 = fla_max(lwkmin, lwkopt_hetrf__);
        lwkopt = fla_max(i__1, lwkopt_hetrs__);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHESV_AA", &i__1, (ftnlen)8);
    ...
    aocl_lapack_chetrf_aa(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if(*info == 0)
    {
