/* ../netlib/dgesvx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dgesvx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dgesvx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dgesvx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(nofact || equil)
    {
        ...
        aocl_lapack_dlacpy("Full", n, n, &a[a_offset], lda, &af[af_offset], ldaf);
        aocl_lapack_dgetrf(n, n, &af[af_offset], ldaf, &ipiv[1], info);
        ...
        if(*info > 0)
        {
            ...
            {
                rpvgrw = aocl_lapack_dlange("M", n, info, &a[a_offset], lda, &work[1]) / rpvgrw;
            }
            work[1] = rpvgrw;
            *rcond = 0.;
            AOCL_DTL_TRACE_LOG_EXIT
    ...
    {
        rpvgrw = aocl_lapack_dlange("M", n, n, &a[a_offset], lda, &work[1]) / rpvgrw;
    }
    /* Compute the reciprocal of the condition number of A. */
    aocl_lapack_dgecon(norm, n, &af[af_offset], ldaf, &anorm, rcond, &work[1], &iwork[1], info);
