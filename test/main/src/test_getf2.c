...
void invoke_getf2(integer datatype, integer *m, integer *n, void *a, integer *lda, 
                               ...
                               integer einfo)
{
    ...
    else
    {
        ...
        create_svd_matrix(datatype, range, m, n, A, lda, s_test, GETF2_VL, GETF2_VU, i_zero, i_zero,
                          info);
    }
