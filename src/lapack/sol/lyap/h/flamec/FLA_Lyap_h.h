...
FLA_Error FLA_Lyap_h_ops_var1( fla_dim_t m_AC,
                               float* buff_sgn,
...
FLA_Error FLA_Lyap_h_opd_var1( fla_dim_t m_AC,
                               double* buff_sgn,
...
FLA_Error FLA_Lyap_h_opc_var1( fla_dim_t m_AC,
                               scomplex* buff_sgn,
...
FLA_Error FLA_Lyap_h_opz_var1( fla_dim_t m_AC,
                               dcomplex* buff_sgn,
...
FLA_Error FLA_Lyap_h_ops_var3( fla_dim_t m_AC,
                               float* buff_sgn,
                               float* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               float* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               float* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
FLA_Error FLA_Lyap_h_opd_var3( fla_dim_t m_AC,
                               double* buff_sgn,
                               double* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               double* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               double* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
FLA_Error FLA_Lyap_h_opc_var3( fla_dim_t m_AC,
                               scomplex* buff_sgn,
                               scomplex* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               scomplex* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               scomplex* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
FLA_Error FLA_Lyap_h_opz_var3( fla_dim_t m_AC,
                               dcomplex* buff_sgn,
                               dcomplex* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               dcomplex* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               dcomplex* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
...
FLA_Error FLA_Lyap_h_ops_var4( fla_dim_t m_AC,
                               float* buff_sgn,
                               float* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               float* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               float* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
FLA_Error FLA_Lyap_h_opd_var4( fla_dim_t m_AC,
                               double* buff_sgn,
                               double* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               double* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               double* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
FLA_Error FLA_Lyap_h_opc_var4( fla_dim_t m_AC,
                               scomplex* buff_sgn,
                               scomplex* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               scomplex* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               scomplex* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
FLA_Error FLA_Lyap_h_opz_var4( fla_dim_t m_AC,
                               dcomplex* buff_sgn,
                               dcomplex* buff_A, fla_dim_t rs_A, fla_dim_t cs_A, 
                               dcomplex* buff_W, fla_dim_t rs_W, fla_dim_t cs_W, 
                               dcomplex* buff_C, fla_dim_t rs_C, fla_dim_t cs_C );
