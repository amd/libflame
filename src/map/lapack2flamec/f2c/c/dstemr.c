/* ./dstemr.f -- translated by f2c (version 20190311). You must link the resulting object file with
...
void dstemr_(char *jobz, char *range, aocl_int_t *n, doublereal *d__, doublereal *e, doublereal *vl,
             doublereal *vu, aocl_int_t *il, aocl_int_t *iu, aocl_int_t *m, doublereal *w,
             doublereal *z__, aocl_int_t *ldz, aocl_int_t *nzc, aocl_int_t *isuppz, logical *tryrac,
             doublereal *work, aocl_int_t *lwork, aocl_int_t *iwork, aocl_int_t *liwork,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dstemr(jobz, range, n, d__, e, vl, vu, il, iu, m, w, z__, ldz, nzc, isuppz, tryrac,
    ...
    aocl_lapack_dstemr(jobz, range, &n_64, d__, e, vl, vu, &il_64, &iu_64, &m_64, w, z__, &ldz_64,
...
void aocl_lapack_dstemr(char *jobz, char *range, aocl_int64_t *n, doublereal *d__, doublereal *e,
                        ...
                        aocl_int64_t *info)
{
    ...
    doublereal thresh;
    aocl_int64_t iinspl, ifirst, indwrk, liwmin, nzcmin;
    doublereal pivmin;
    aocl_int64_t nsplit;
    doublereal smlnum;
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DSTEMR", &i__1, (ftnlen)6);
    ...
    *m = 0;
    ...
    else
    {
        ...
        if(wantz)
        {
            ...
            /* eigenvalues */
            aocl_lapack_dlarrv(n, &wl, &wu, &d__[1], &e[1], &pivmin, &iwork[iinspl], m, &c__1, m,
        ...
        else
        {
            ...
            for(j = 1; j <= i__1; ++j)
            {
                ...
                if(i__ != 0)
                {
                    ...
                    if(wantz)
                    {
                        aocl_blas_dswap(n, &z__[i__ * z_dim1 + 1], &c__1, &z__[j * z_dim1 + 1],
                                        &c__1);
                        itmp = isuppz[(i__ << 1) - 1];
