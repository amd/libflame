...
/* ===================================================================== */
/* Subroutine */
void slaqp3rk_(integer *m, integer *n, integer *nrhs, integer *ioffset, integer *nb, real *abstol,
               real *reltol, integer *kp1, real *maxc2nrm, real *a, integer *lda, logical *done,
               integer *kb, real *maxc2nrmk, real *relmaxc2nrmk, integer *jpiv, real *tau,
               real *vn1, real *vn2, real *auxv, real *f, integer *ldf, integer *iwork,
               integer *info)
{
    ...
    *done = FALSE_;
    while(k < *nb && lsticc == 0)
    {
            ...
            if(*maxc2nrmk <= *abstol || *relmaxc2nrmk <= *reltol)
            {
                ...
                *kb = k - 1;
                ...
                if(*kb < minmnupdt)
                {
                    i__1 = *m - if__;
                    i__2 = *n + *nrhs - *kb;
                    sgemm_("No transpose", "Transpose", &i__1, &i__2, kb, &c_b7,
        ...
        if(k > 1)
        {
            i__1 = *m - i__ + 1;
            i__2 = k - 1;
            sgemv_("No transpose", &i__1, &i__2, &c_b7, &a[i__ + a_dim1], lda, &f[k + f_dim1], ldf,
        ...
        {
            i__1 = *m - i__ + 1;
            slarfg_(&i__1, &a[i__ + k * a_dim1], &a[i__ + 1 + k * a_dim1], &c__1, &tau[k]);
        }
        else
        {
            tau[k] = 0.f;
        ...
        if(sisnan_(&tau[k]))
        {
            ...
            *relmaxc2nrmk = tau[k];
            ...
            {
                i__1 = *m - if__;
                sgemm_("No transpose", "Transpose", &i__1, nrhs, kb, &c_b7, &a[if__ + 1 + a_dim1],
        ...
        if(k < *n + *nrhs)
        {
            i__1 = *m - i__ + 1;
            i__2 = *n + *nrhs - k;
            sgemv_("Transpose", &i__1, &i__2, &tau[k], &a[i__ + (k + 1) * a_dim1], lda,
        ...
        if(k > 1)
        {
            ...
            i__2 = k - 1;
            r__1 = -tau[k];
            sgemv_("Transpose", &i__1, &i__2, &r__1, &a[i__ + a_dim1], lda, &a[i__ + k * a_dim1],
                   &c__1, &c_b30, &auxv[1], &c__1);
            i__1 = *n + *nrhs;
            i__2 = k - 1;
            sgemv_("No transpose", &i__1, &i__2, &c_b8, &f[f_dim1 + 1], ldf, &auxv[1], &c__1, &c_b8,
                   &f[k * f_dim1 + 1], &c__1);
        }
        /* =============================================================== */
        ...
        {
            i__1 = *n + *nrhs - k;
            sgemv_("No transpose", &i__1, &k, &c_b7, &f[k + 1 + f_dim1], ldf, &a[i__ + a_dim1], lda,
    ...
    *kb = k;
    ...
    if(*kb < minmnupdt)
    {
        i__1 = *m - if__;
        i__2 = *n + *nrhs - *kb;
        sgemm_("No transpose", "Transpose", &i__1, &i__2, kb, &c_b7, &a[if__ + 1 + a_dim1], lda,
