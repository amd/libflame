...
/* > \brief <b> SGGES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgges.f
 * "> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgges.f
 * "> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgges.f
 * "> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void sgges_(char *jobvsl, char *jobvsr, char *sort, L_fps3 selctg, aocl_int_t *n, real *a,
            aocl_int_t *lda, real *b, aocl_int_t *ldb, aocl_int_t *sdim, real *alphar, real *alphai,
            real *beta, real *vsl, aocl_int_t *ldvsl, real *vsr, aocl_int_t *ldvsr, real *work,
            aocl_int_t *lwork, logical *bwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_sgges(jobvsl, jobvsr, sort, selctg, n, a, lda, b, ldb, sdim, alphar, alphai, beta,
    ...
    aocl_lapack_sgges(jobvsl, jobvsr, sort, selctg, &n_64, a, &lda_64, b, &ldb_64, &sdim_64, alphar,
                      alphai, beta, vsl, &ldvsl_64, vsr, &ldvsr_64, work, &lwork_64, bwork,
                      &info_64);
...
void aocl_lapack_sgges(char *jobvsl, char *jobvsr, char *sort, L_fps3 selctg, aocl_int64_t *n,
                       ...
                       logical *bwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SGGES ", &i__1, (ftnlen)6);
    ...
    if(ilvsl)
    {
        aocl_lapack_slaset("Full", n, n, &c_b38, &c_b39, &vsl[vsl_offset], ldvsl);
        if(irows > 1)
        {
            i__1 = irows - 1;
            i__2 = irows - 1;
    ...
    if(ilvsr)
    {
        aocl_lapack_slaset("Full", n, n, &c_b38, &c_b39, &vsr[vsr_offset], ldvsr);
    }
