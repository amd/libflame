/* ../netlib/v3.9.0/cheevd_2stage.f -- translated by f2c (version 20160102). You must link the
...
/* > \brief <b> CHEEVD_2STAGE computes the eigenvalues and, optionally, the left and/or right
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cheevd_
 * 2stage.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cheevd_
 * 2stage.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cheevd_
 * 2stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void cheevd_2stage_(char *jobz, char *uplo, aocl_int_t *n, scomplex *a, aocl_int_t *lda, real *w,
                    scomplex *work, aocl_int_t *lwork, real *rwork, aocl_int_t *lrwork,
                    aocl_int_t *iwork, aocl_int_t *liwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cheevd_2stage(jobz, uplo, n, a, lda, w, work, lwork, rwork, lrwork, iwork, liwork,
                              info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_cheevd_2stage(jobz, uplo, &n_64, a, &lda_64, w, work, &lwork_64, rwork, &lrwork_64,
...
void aocl_lapack_cheevd_2stage(char *jobz, char *uplo, aocl_int64_t *n, scomplex *a,
                               aocl_int64_t *lda, real *w, scomplex *work, aocl_int64_t *lwork,
                               real *rwork, aocl_int64_t *lrwork, aocl_int_t *iwork,
                               aocl_int64_t *liwork, aocl_int64_t *info)
{
...
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,
             "cheevd_2stage inputs: jobz %c, uplo %c, n %lld, lda %lld, lwork %lld, lrwork %lld, "
             "liwork %lld",
             *jobz, *uplo, *n, *lda, *lwork, *lrwork, *liwork);
#else
    snprintf(buffer, 256,
             "cheevd_2stage inputs: jobz %c, uplo %c, n %d, lda %d, lwork %d, lrwork %d, liwork %d",
             *jobz, *uplo, *n, *lda, *lwork, *lrwork, *liwork);
#endif
    ...
    real safmin;
    real bignum;
    aocl_int64_t indtau, indrwk, indwrk, liwmin;
    aocl_int64_t lrwmin;
    aocl_int64_t llwork;
    real smlnum;
    logical lquery;
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHEEVD_2STAGE", &i__1, (ftnlen)13);
    ...
    {
        aocl_lapack_cstedc("I", n, &w[1], &rwork[inde], &work[indwrk], n, &work[indwk2], &llwrk2,
                           &rwork[indrwk], &llrwk, &iwork[1], liwork, info);
        aocl_lapack_cunmtr("L", uplo, "N", n, n, &a[a_offset], lda, &work[indtau], &work[indwrk], n,
                           &work[indwk2], &llwrk2, &iinfo);
        aocl_lapack_clacpy("A", n, n, &work[indwrk], n, &a[a_offset], lda);
    }
