/* ../netlib/slahrd.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > \brief \b SLAHRD reduces the first nb columns of a general rectangular matrix A so that
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slahrd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slahrd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slahrd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
             ...
             real *tau, real *t, aocl_int64_t *ldt, real *y, aocl_int64_t *ldy)
{
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        if(i__ > 1)
        {
            ...
            i__2 = i__ - 1;
            aocl_blas_sgemv("No transpose", n, &i__2, &c_b4, &y[y_offset], ldy,
                            &a[*k + i__ - 1 + a_dim1], lda, &c_b5, &a[i__ * a_dim1 + 1], &c__1);
        ...
        /* Compute Y(1:n,i) */
        i__2 = *n - *k - i__ + 1;
        aocl_blas_sgemv("No transpose", n, &i__2, &c_b5, &a[(i__ + 1) * a_dim1 + 1], lda,
        ...
        i__2 = i__ - 1;
        aocl_blas_sgemv("No transpose", n, &i__2, &c_b4, &y[y_offset], ldy, &t[i__ * t_dim1 + 1],
                        &c__1, &c_b5, &y[i__ * y_dim1 + 1], &c__1);
        aocl_blas_sscal(n, &tau[i__], &y[i__ * y_dim1 + 1], &c__1);
        /* Compute T(1:i,i) */
        i__2 = i__ - 1;
        r__1 = -tau[i__];
