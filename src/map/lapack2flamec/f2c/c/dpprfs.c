/* ../netlib/dpprfs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dpprfs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dpprfs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dpprfs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dpprfs(uplo, n, nrhs, ap, afp, b, ldb, x, ldx, ferr, berr, work, iwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dpprfs(uplo, &n_64, &nrhs_64, ap, afp, b, &ldb_64, x, &ldx_64, ferr, berr, work,
                       iwork, &info_64);
...
void aocl_lapack_dpprfs(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, doublereal *ap,
                        doublereal *afp, doublereal *b, aocl_int64_t *ldb, doublereal *x,
                        ...
                        aocl_int_t *iwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DPPRFS", &i__1, (ftnlen)6);
