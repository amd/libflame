...
/* ../netlib/sgbrfsx.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbrfsx
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbrfsx
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbrfsx
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void sgbrfsx_(char *trans, char *equed, integer *n, integer *kl, integer *ku, integer *nrhs,
              real *ab, integer *ldab, real *afb, integer *ldafb, integer *ipiv, real *r__,
              real *c__, real *b, integer *ldb, real *x, integer *ldx, real *rcond, real *berr,
              ...
              real *params, real *work, integer *iwork, integer *info)
{
    ...
    extern real sla_gbrcond_(char *, integer *, integer *, integer *, real *, integer *, real *,
                             integer *, integer *, integer *, real *, integer *, real *, integer *);
    real cwise_wrong__;
    extern /* Subroutine */
        void
        sla_gbrfsx_extended_(integer *, integer *, integer *, integer *, integer *, integer *,
                             real *, integer *, real *, integer *, integer *, logical *, real *,
    ...
    *rcond = 0.f;
    ...
    if(ref_type__ != 0 && *info == 0)
    {
        ...
        if(notran)
        {
            sla_gbrfsx_extended_(&prec_type__, &trans_type__, n, kl, ku, nrhs, &ab[ab_offset], ldab,
    ...
    if(*n_err_bnds__ >= 1 && n_norms__ >= 1)
    {
        ...
        if(colequ && notran)
        {
            rcond_tmp__ = sla_gbrcond_(trans, n, kl, ku, &ab[ab_offset], ldab, &afb[afb_offset],
    ...
    if(*n_err_bnds__ >= 1 && n_norms__ >= 2)
    {
        ...
        for(j = 1; j <= i__1; ++j)
        {
            ...
            {
                rcond_tmp__
                    = sla_gbrcond_(trans, n, kl, ku, &ab[ab_offset], ldab, &afb[afb_offset], ldafb,
