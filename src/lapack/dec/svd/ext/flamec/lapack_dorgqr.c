                  ...
                  aocl_int64_t *info)
{
    ...
    extern int lapack_dorg2r(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, doublereal *,
    ...
    *info = 0;
    ...
    if(kk < *n)
    {
        ...
        i__2 = *n - kk;
        i__3 = *k - kk;
        lapack_dorg2r(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &tau[kk + 1],
                      &work[1], &iinfo);
    }
    if(kk > 0)
    {
        ...
        for(i__ = ki + 1; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            i__2 = *m - i__ + 1;
            lapack_dorg2r(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1],
                          &iinfo);
