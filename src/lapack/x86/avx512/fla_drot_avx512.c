                    ...
                    doublereal *c__, doublereal *s)
{
    ...
    __m512d vd8_idy0, vd8_idy1, vd8_ody0, vd8_ody1;

    __m256d vd4_c, vd4_s;
    __m256d vd4_idx0, vd4_odx0;
    __m256d vd4_idy0, vd4_ody0;
    ...
    /* 2 iterations at once using SIMD */
    if(i__1 >= 0x02)
    {
...
L20:
    vd8_c = _mm512_broadcastsd_pd(vd2_c);
    vd8_s = _mm512_broadcastsd_pd(vd2_s);

    /* Process 16 iterations at once using AVX512 */
    if(i__1 >= 0x10)
    {
        for(; i__ <= (i__1 - 15); i__ += 16)
        {
            /* load input vectors */
            vd8_idx0 = _mm512_loadu_pd((double const *)&dx[i__]);
            vd8_idy0 = _mm512_loadu_pd((double const *)&dy[i__]);
            vd8_idx1 = _mm512_loadu_pd((double const *)&dx[i__ + 8]);
            vd8_idy1 = _mm512_loadu_pd((double const *)&dy[i__ + 8]);

            /* apply the plane rotation matrix */
            vd8_odx0 = _mm512_mul_pd(vd8_c, vd8_idx0);
            vd8_odx1 = _mm512_mul_pd(vd8_c, vd8_idx1);
            vd8_ody0 = _mm512_mul_pd(vd8_s, vd8_idx0);
            vd8_ody1 = _mm512_mul_pd(vd8_s, vd8_idx1);

            vd8_odx0 = _mm512_fmadd_pd(vd8_s, vd8_idy0, vd8_odx0);
            vd8_odx1 = _mm512_fmadd_pd(vd8_s, vd8_idy1, vd8_odx1);
            vd8_ody0 = _mm512_fmsub_pd(vd8_c, vd8_idy0, vd8_ody0);
            vd8_ody1 = _mm512_fmsub_pd(vd8_c, vd8_idy1, vd8_ody1);

            /* store the outputs */
            _mm512_storeu_pd((double *)&dx[i__], vd8_odx0);
            _mm512_storeu_pd((double *)&dx[i__ + 8], vd8_odx1);
            _mm512_storeu_pd((double *)&dy[i__], vd8_ody0);
            _mm512_storeu_pd((double *)&dy[i__ + 8], vd8_ody1);
        }
    }
    if(i__1 & 0x08)
    {
