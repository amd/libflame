/* ../netlib/cunm2r.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cunm2r.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cunm2r.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cunm2r.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void cunm2r_(char *side, char *trans, aocl_int_t *m, aocl_int_t *n, aocl_int_t *k, scomplex *a,
             aocl_int_t *lda, scomplex *tau, scomplex *c__, aocl_int_t *ldc, scomplex *work,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cunm2r(side, trans, m, n, k, a, lda, tau, c__, ldc, work, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t k_64 = *k;
    ...
    aocl_lapack_cunm2r(side, trans, &m_64, &n_64, &k_64, a, &lda_64, tau, c__, &ldc_64, work,
                       &info_64);
...
void aocl_lapack_cunm2r(char *side, char *trans, aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *k,
                        ...
                        aocl_int64_t *ldc, scomplex *work, aocl_int64_t *info)
{
    ...
    char buffer[256];
    snprintf(buffer, 256,
             "cunm2r inputs: side %c, trans %c, m %" FLA_IS ", n %" FLA_IS ", k %" FLA_IS
