/* ../netlib/zgelsx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgelsx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgelsx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgelsx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > */
/* > ZGELSX computes the minimum-norm solution to a scomplex linear least */
/* > squares problem: */
/* > minimize || A * X - B || */
...
/* ===================================================================== */
/* Subroutine */
void zgelsx_(integer *m, integer *n, integer *nrhs, doublecomplex *a, integer *lda,
             ...
             doublecomplex *work, doublereal *rwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        zlatzm_(char *, integer *, integer *, doublecomplex *, integer *, doublecomplex *,
                doublecomplex *, doublecomplex *, integer *, doublecomplex *),
        ztzrqf_(integer *, integer *, doublecomplex *, integer *, doublecomplex *, integer *);
...
L10:
    ...
    if(*rank < *n)
    {
        aocl_lapack_ztzrqf(rank, n, &a[a_offset], lda, &work[mn + 1], info);
    }
    /* Details of Householder rotations stored in WORK(MN+1:2*MN) */
    /* B(1:M,1:NRHS) := Q**H * B(1:M,1:NRHS) */
    zunm2r_("Left", "Conjugate transpose", m, nrhs, &mn, &a[a_offset], lda, &work[1], &b[b_offset],
    ...
    if(*rank < *n)
    {
        ...
        for(i__ = 1; i__ <= i__1; ++i__)
        {
            ...
            zlatzm_("Left", &i__2, nrhs, &a[i__ + (*rank + 1) * a_dim1], lda, &z__1,
