...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ssysv.f
 * "> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ssysv.f
 * "> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ssysv.f
 * "> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_ssysv(uplo, n, nrhs, a, lda, ipiv, b, ldb, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_ssysv(uplo, &n_64, &nrhs_64, a, &lda_64, ipiv, b, &ldb_64, work, &lwork_64,
                      &info_64);
...
void aocl_lapack_ssysv(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, real *a, aocl_int64_t *lda,
                       aocl_int_t *ipiv, real *b, aocl_int64_t *ldb, real *work,
                       aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SSYSV ", &i__1, (ftnlen)6);
    ...
    if(*info == 0)
    {
        ...
        if(*lwork < *n)
        {
            ...
            aocl_lapack_ssytrs(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], ldb, info);
        }
        else
        {
            /* Solve with TRS2 ( Use Level BLAS 3) */
            aocl_lapack_ssytrs2(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], ldb,
                                &work[1], info);
        }
    }
    work[1] = aocl_lapack_sroundup_lwork(&lwkopt);
