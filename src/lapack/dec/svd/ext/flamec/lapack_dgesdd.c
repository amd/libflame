    ...
    if(*m >= *n)
    {
        ...
        if(*m >= mnthr)
        {
            ...
            else if(wntqo)
            {
                ...
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[itauq], &work[iu],
                              n, &work[nwork], &i__1, &ierr);
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("P", "R", "T", n, n, n, &work[ir], &ldwrkr, &work[itaup],
            ...
            else if(wntqs)
            {
                ...
                i__2 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[itauq],
            ...
            else if(wntqa)
            {
                ...
                i__2 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", n, n, n, &a[a_offset], lda, &work[itauq], &work[iu],
                              &ldwrku, &work[nwork], &i__2, &ierr);
                i__2 = *lwork - nwork + 1;
                lapack_dormbr("P", "R", "T", n, n, n, &a[a_offset], lda, &work[itaup],
                              &vt[vt_offset], ldvt, &work[nwork], &i__2, &ierr);
        ...
        else
        {
            ...
            else if(wntqs)
            {
                ...
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[itauq], &u[u_offset],
            ...
            else if(wntqa)
            {
                ...
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[itauq], &u[u_offset],
                              ldu, &work[nwork], &i__1, &ierr);
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("P", "R", "T", n, n, m, &a[a_offset], lda, &work[itaup],
                              &vt[vt_offset], ldvt, &work[nwork], &i__1, &ierr);
            }
        }
    }
    else
    {
        ...
        if(*n >= mnthr)
        {
            ...
            else if(wntqo)
            {
                ...
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[itauq],
                              &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
                i__1 = *lwork - nwork + 1;
                lapack_dormbr("P", "R", "T", m, m, m, &work[il], &ldwrkl, &work[itaup], &work[ivt],
            ...
            else if(wntqs)
            {
                ...
                lapack_dormbr("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[itauq],
                              &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
                i__2 = *lwork - nwork + 1;
                lapack_dormbr("P", "R", "T", m, m, m, &work[il], &ldwrkl, &work[itaup],
                              &vt[vt_offset], ldvt, &work[nwork], &i__2, &ierr);
            ...
            else if(wntqa)
            {
                ...
                i__2 = *lwork - nwork + 1;
                lapack_dormbr("Q", "L", "N", m, m, m, &a[a_offset], lda, &work[itauq], &u[u_offset],
                              ldu, &work[nwork], &i__2, &ierr);
                i__2 = *lwork - nwork + 1;
                lapack_dormbr("P", "R", "T", m, m, m, &a[a_offset], lda, &work[itaup], &work[ivt],
