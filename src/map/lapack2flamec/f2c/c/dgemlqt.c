...
/* ===================================================================== */
/* Subroutine */
void dgemlqt_(char *side, char *trans, integer *m, integer *n, integer *k, integer *mb,
    ...
    *info = 0;
    ...
    if(left && notran)
    {
        ...
        for(i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            i__3 = *m - i__ + 1;
            dlarfb_("L", "T", "F", "R", &i__3, n, &ib, &v[i__ + i__ * v_dim1], ldv,
    ...
    else if(right && tran)
    {
        ...
        for(i__ = 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            ...
            ib = fla_min(i__3, i__4);
            i__3 = *n - i__ + 1;
            dlarfb_("R", "N", "F", "R", m, &i__3, &ib, &v[i__ + i__ * v_dim1], ldv,
    ...
    else if(left && tran)
    {
        ...
        for(i__ = kf; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            i__2 = *m - i__ + 1;
            dlarfb_("L", "N", "F", "R", &i__2, n, &ib, &v[i__ + i__ * v_dim1], ldv,
                    &t[i__ * t_dim1 + 1], ldt, &c__[i__ + c_dim1], ldc, &work[1], &ldwork);
        }
    }
    else if(right && notran)
    {
        ...
        for(i__ = kf; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            ib = fla_min(i__2, i__3);
            i__2 = *n - i__ + 1;
            dlarfb_("R", "T", "F", "R", m, &i__2, &ib, &v[i__ + i__ * v_dim1], ldv,
                    &t[i__ * t_dim1 + 1], ldt, &c__[i__ * c_dim1 + 1], ldc, &work[1], &ldwork);
        }
    }
    AOCL_DTL_TRACE_LOG_EXIT
