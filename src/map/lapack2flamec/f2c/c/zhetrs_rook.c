...
/* > \verbatim */
/* > */
/* > ZHETRS_ROOK solves a system of linear equations A*X = B with a scomplex */
...
void zhetrs_rook_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, dcomplex *a, aocl_int_t *lda,
                  aocl_int_t *ipiv, dcomplex *b, aocl_int_t *ldb, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhetrs_rook(uplo, n, nrhs, a, lda, ipiv, b, ldb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zhetrs_rook(uplo, &n_64, &nrhs_64, a, &lda_64, ipiv, b, &ldb_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zhetrs_rook(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, dcomplex *a,
                             ...
                             aocl_int64_t *ldb, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHETRS_ROOK", &i__1, (ftnlen)11);
