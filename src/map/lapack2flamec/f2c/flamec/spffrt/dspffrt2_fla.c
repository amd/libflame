...
extern void dgemm_(char *transa, char *transb, integer *m, integer * n, integer *k, doublereal *alpha, doublereal *a, integer *lda, doublereal *b, integer *ldb, doublereal *beta, doublereal *c__, integer *ldc);

#ifdef FLA_ENABLE_BLAS_EXT_GEMMT
extern void dgemmt_( char *, char *, char *, integer *, integer *, doublereal *, doublereal *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer * );
#endif
...
void dsffrk2_fla( doublereal *au, integer *m, integer *n, integer *lda, doublereal *bt, integer *ldbt )
{
    ...
    integer c__1 = 1;
    doublereal r1;
    extern void dger_(integer *m, integer *n, doublereal *alpha, doublereal *x, integer *incx, doublereal *y, integer *incy, doublereal *a, integer *lda);
