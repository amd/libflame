...
void zhbevx_2stage_(char *jobz, char *range, char *uplo, aocl_int_t *n, aocl_int_t *kd,
                    dcomplex *ab, aocl_int_t *ldab, dcomplex *q, aocl_int_t *ldq,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhbevx_2stage(jobz, range, uplo, n, kd, ab, ldab, q, ldq, vl, vu, il, iu, abstol, m,
    ...
    aocl_lapack_zhbevx_2stage(jobz, range, uplo, &n_64, &kd_64, ab, &ldab_64, q, &ldq_64, vl, vu,
...
void aocl_lapack_zhbevx_2stage(char *jobz, char *range, char *uplo, aocl_int64_t *n,
                               aocl_int64_t *kd, dcomplex *ab, aocl_int64_t *ldab,
                               dcomplex *q, aocl_int64_t *ldq, doublereal *vl, doublereal *vu,
                               ...
                               aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHBEVX_2STAGE", &i__1, (ftnlen)13);
    ...
    *m = 0;
    ...
    if(iscale == 1)
    {
        if(lower)
        {
            aocl_lapack_zlascl("B", kd, kd, &c_b26, &sigma, n, n, &ab[ab_offset], ldab, info);
        }
        else
        {
            aocl_lapack_zlascl("Q", kd, kd, &c_b26, &sigma, n, n, &ab[ab_offset], ldab, info);
        }
        if(*abstol > 0.)
        {
            abstll = *abstol * sigma;
    ...
    aocl_lapack_zhetrd_hb2st("N", jobz, uplo, n, kd, &ab[ab_offset], ldab, &rwork[indd], &rwork[inde],
