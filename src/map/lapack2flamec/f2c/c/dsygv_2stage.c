/* ../netlib/v3.9.0/dsygv_2stage.f -- translated by f2c (version 20160102). You must link the
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsygv_2
 * stage.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsygv_2
 * stage.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsygv_2
 * stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dsygv_2stage_(aocl_int_t *itype, char *jobz, char *uplo, aocl_int_t *n, doublereal *a,
                   aocl_int_t *lda, doublereal *b, aocl_int_t *ldb, doublereal *w, doublereal *work,
                   aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dsygv_2stage(itype, jobz, uplo, n, a, lda, b, ldb, w, work, lwork, info);
#else
    ...
    aocl_lapack_dsygv_2stage(&itype_64, jobz, uplo, &n_64, a, &lda_64, b, &ldb_64, w, work,
                             &lwork_64, &info_64);
...
void aocl_lapack_dsygv_2stage(aocl_int64_t *itype, char *jobz, char *uplo, aocl_int64_t *n,
                              doublereal *a, aocl_int64_t *lda, doublereal *b, aocl_int64_t *ldb,
                              doublereal *w, doublereal *work, aocl_int64_t *lwork,
                              aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("dsygv_2stage inputs: itype %" FLA_IS ", jobz %c, uplo %c, n %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DSYGV_2STAGE ", &i__1, (ftnlen)13);
    ...
    aocl_lapack_dsyev_2stage(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, info);
    if(wantz)
    {
        ...
        if(*itype == 1 || *itype == 2)
        {
            ...
            aocl_blas_dtrsm("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[b_offset], ldb,
                            &a[a_offset], lda);
        }
        else if(*itype == 3)
        {
            ...
            aocl_blas_dtrmm("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[b_offset], ldb,
                            &a[a_offset], lda);
        }
    }
    work[1] = (doublereal)lwmin;
