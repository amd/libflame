...
void spbtrs_(char *uplo, aocl_int_t *n, aocl_int_t *kd, aocl_int_t *nrhs, real *ab,
             aocl_int_t *ldab, real *b, aocl_int_t *ldb, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_spbtrs(uplo, n, kd, nrhs, ab, ldab, b, ldb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_spbtrs(uplo, &n_64, &kd_64, &nrhs_64, ab, &ldab_64, b, &ldb_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_spbtrs(char *uplo, aocl_int64_t *n, aocl_int64_t *kd, aocl_int64_t *nrhs, real *ab,
                        aocl_int64_t *ldab, real *b, aocl_int64_t *ldb, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SPBTRS", &i__1, (ftnlen)6);
