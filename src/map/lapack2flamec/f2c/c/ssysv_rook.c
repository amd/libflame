...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_ssysv_rook(uplo, n, nrhs, a, lda, ipiv, b, ldb, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_ssysv_rook(uplo, &n_64, &nrhs_64, a, &lda_64, ipiv, b, &ldb_64, work, &lwork_64,
                           &info_64);
...
void aocl_lapack_ssysv_rook(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, real *a,
                            ...
                            real *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        {
            aocl_lapack_ssytrf_rook(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, info);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SSYSV_ROOK", &i__1, (ftnlen)10);
    ...
    if(*info == 0)
    {
        ...
        aocl_lapack_ssytrs_rook(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], ldb,
                                info);
    }
    work[1] = aocl_lapack_sroundup_lwork(&lwkopt);
    AOCL_DTL_TRACE_LOG_EXIT
