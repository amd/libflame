/* ../netlib/zsytf2.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zsytf2.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zsytf2.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zsytf2.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > ZSYTF2 computes the factorization of a scomplex symmetric matrix A */
    ...
    L10: /* If K < 1, exit from loop */
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    i__1 = imax - 1;
                    jmax = aocl_blas_izamax(&i__1, &a[imax * a_dim1 + 1], &c__1);
                    /* Computing MAX */
                    i__1 = jmax + imax * a_dim1;
                    d__3 = rowmax;
                    d__4 = (d__1 = a[i__1].real, f2c_dabs(d__1))
                           + (d__2 = d_imag(&a[jmax + imax * a_dim1]),
                ...
                else /* if(complicated condition) */
                {
                    ...
                    if((d__1 = a[i__1].real, f2c_dabs(d__1))
                           + (d__2 = d_imag(&a[imax + imax * a_dim1]), f2c_dabs(d__2))
                       >= alpha * rowmax)
                    {
            ...
            if(kp != kk)
            {
                ...
                i__1 = kk - kp - 1;
                aocl_blas_zswap(&i__1, &a[kp + 1 + kk * a_dim1], &c__1, &a[kp + (kp + 1) * a_dim1],
                                lda);
                i__1 = kk + kk * a_dim1;
                t.real = a[i__1].real;
            ...
            else
            {
                ...
                if(k > 2)
                {
                    ...
                    {
                        i__1 = j + (k - 1) * a_dim1;
                        z__3.real = d11.real * a[i__1].real - d11.imag * a[i__1].imag;
                        z__3.imag = d11.real * a[i__1].imag + d11.imag * a[i__1].real; // , expr subst
                        i__2 = j + k * a_dim1;
                        z__2.real = z__3.real - a[i__2].real;
                        z__2.imag = z__3.imag - a[i__2].imag; // , expr subst
                        ...
                        i__1 = j + k * a_dim1;
                        z__3.real = d22.real * a[i__1].real - d22.imag * a[i__1].imag;
                        z__3.imag = d22.real * a[i__1].imag + d22.imag * a[i__1].real; // , expr subst
                        i__2 = j + (k - 1) * a_dim1;
                        z__2.real = z__3.real - a[i__2].real;
                        z__2.imag = z__3.imag - a[i__2].imag; // , expr subst
                        z__1.real = d12.real * z__2.real - d12.imag * z__2.imag;
                        ...
                        for(i__ = j; i__ >= 1; --i__)
                        {
                            ...
                            i__2 = i__ + j * a_dim1;
                            i__3 = i__ + k * a_dim1;
                            z__3.real = a[i__3].real * wk.real - a[i__3].imag * wk.imag;
                            z__3.imag = a[i__3].real * wk.imag + a[i__3].imag * wk.real; // , expr subst
                            z__2.real = a[i__2].real - z__3.real;
                            z__2.imag = a[i__2].imag - z__3.imag; // , expr subst
                            i__4 = i__ + (k - 1) * a_dim1;
                            z__4.real = a[i__4].real * wkm1.real - a[i__4].imag * wkm1.imag;
                            z__4.imag = a[i__4].real * wkm1.imag + a[i__4].imag * wkm1.real; // , expr subst
                        ...
                        i__1 = j + k * a_dim1;
                        a[i__1].real = wk.real;
                        a[i__1].imag = wk.imag; // , expr subst
                        i__1 = j + (k - 1) * a_dim1;
                        a[i__1].real = wkm1.real;
                        a[i__1].imag = wkm1.imag; // , expr subst
                        /* L30: */
                    }
                }
            }
    ...
    L40: /* If K > N, exit from loop */
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    i__1 = *n - imax;
                    jmax = imax + aocl_blas_izamax(&i__1, &a[imax + 1 + imax * a_dim1], &c__1);
                    /* Computing MAX */
                    i__1 = jmax + imax * a_dim1;
                    d__3 = rowmax;
                    d__4 = (d__1 = a[i__1].real, f2c_dabs(d__1))
            ...
            if(kp != kk)
            {
                ...
                i__1 = kp - kk - 1;
                aocl_blas_zswap(&i__1, &a[kk + 1 + kk * a_dim1], &c__1, &a[kp + (kk + 1) * a_dim1],
                                lda);
                i__1 = kk + kk * a_dim1;
                t.real = a[i__1].real;
                t.imag = a[i__1].imag; // , expr subst
            ...
            else
            {
                ...
                if(k < *n - 1)
                {
                    ...
                    {
                        i__2 = j + k * a_dim1;
                        z__3.real = d11.real * a[i__2].real - d11.imag * a[i__2].imag;
                        z__3.imag = d11.real * a[i__2].imag + d11.imag * a[i__2].real; // , expr subst
                        i__3 = j + (k + 1) * a_dim1;
                        z__2.real = z__3.real - a[i__3].real;
                        z__2.imag = z__3.imag - a[i__3].imag; // , expr subst
                        z__1.real = d21.real * z__2.real - d21.imag * z__2.imag;
                        z__1.imag = d21.real * z__2.imag + d21.imag * z__2.real; // , expr subst
                        wk.real = z__1.real;
                        wk.imag = z__1.imag; // , expr subst
                        i__2 = j + (k + 1) * a_dim1;
                        z__3.real = d22.real * a[i__2].real - d22.imag * a[i__2].imag;
                        z__3.imag = d22.real * a[i__2].imag + d22.imag * a[i__2].real; // , expr subst
                        i__3 = j + k * a_dim1;
                        z__2.real = z__3.real - a[i__3].real;
                        z__2.imag = z__3.imag - a[i__3].imag; // , expr subst
                        z__1.real = d21.real * z__2.real - d21.imag * z__2.imag;
                        ...
                        for(i__ = j; i__ <= i__2; ++i__)
                        {
                            ...
                            i__4 = i__ + j * a_dim1;
                            i__5 = i__ + k * a_dim1;
                            z__3.real = a[i__5].real * wk.real - a[i__5].imag * wk.imag;
                            z__3.imag = a[i__5].real * wk.imag + a[i__5].imag * wk.real; // , expr subst
                            z__2.real = a[i__4].real - z__3.real;
                            z__2.imag = a[i__4].imag - z__3.imag; // , expr subst
                            i__6 = i__ + (k + 1) * a_dim1;
                            z__4.real = a[i__6].real * wkp1.real - a[i__6].imag * wkp1.imag;
                            z__4.imag = a[i__6].real * wkp1.imag + a[i__6].imag * wkp1.real; // , expr subst
                            z__1.real = z__2.real - z__4.real;
                            z__1.imag = z__2.imag - z__4.imag; // , expr subst
                        ...
                        i__2 = j + k * a_dim1;
                        a[i__2].real = wk.real;
                        a[i__2].imag = wk.imag; // , expr subst
                        i__2 = j + (k + 1) * a_dim1;
                        a[i__2].real = wkp1.real;
                        a[i__2].imag = wkp1.imag; // , expr subst
                        /* L60: */
                    }
                }
            }
