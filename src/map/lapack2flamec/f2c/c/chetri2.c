...
/* ===================================================================== */
/* Subroutine */
void chetri2_(char *uplo, integer *n, complex *a, integer * lda, integer *ipiv, complex *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern /* Subroutine */
    void chetri2x_(char *, integer *, complex *, integer *, integer *, complex *, integer *, integer *);
    ...
    extern /* Subroutine */
    void chetri_(char *, integer *, complex *, integer *, integer *, complex *, integer *);
    logical lquery;
    integer minsize;
