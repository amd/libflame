...
void dorbdb4_(aocl_int_t *m, aocl_int_t *p, aocl_int_t *q, doublereal *x11, aocl_int_t *ldx11,
              doublereal *x21, aocl_int_t *ldx21, doublereal *theta, doublereal *phi,
              doublereal *taup1, doublereal *taup2, doublereal *tauq1, doublereal *phantom,
              doublereal *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dorbdb4(m, p, q, x11, ldx11, x21, ldx21, theta, phi, taup1, taup2, tauq1, phantom,
                        work, lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t p_64 = *p;
    ...
    aocl_lapack_dorbdb4(&m_64, &p_64, &q_64, x11, &ldx11_64, x21, &ldx21_64, theta, phi, taup1,
...
void aocl_lapack_dorbdb4(aocl_int64_t *m, aocl_int64_t *p, aocl_int64_t *q, doublereal *x11,
                         aocl_int64_t *ldx11, doublereal *x21, aocl_int64_t *ldx21,
                         doublereal *theta, doublereal *phi, doublereal *taup1, doublereal *taup2,
                         doublereal *tauq1, doublereal *phantom, doublereal *work,
                         aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DORBDB4", &i__1, (ftnlen)7);
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        if(i__ == 1)
        {
            ...
            i__2 = *m - *p;
            aocl_lapack_dorbdb5(p, &i__2, q, &phantom[1], &c__1, &phantom[*p + 1], &c__1,
                                &x11[x11_offset], ldx11, &x21[x21_offset], ldx21, &work[iorbdb5],
                                &lorbdb5, &childinfo);
            aocl_blas_dscal(p, &c_b5, &phantom[1], &c__1);
            aocl_lapack_dlarfgp(p, &phantom[1], &phantom[2], &c__1, &taup1[1]);
            i__2 = *m - *p;
            aocl_lapack_dlarfgp(&i__2, &phantom[*p + 1], &phantom[*p + 2], &c__1, &taup2[1]);
            theta[i__] = atan2(phantom[1], phantom[*p + 1]);
            c__ = cos(theta[i__]);
            s = sin(theta[i__]);
            aocl_lapack_dlarf1f("L", p, q, &phantom[1], &c__1, &taup1[1], &x11[x11_offset], ldx11,
                              &work[ilarf]);
            i__2 = *m - *p;
            aocl_lapack_dlarf1f("L", &i__2, q, &phantom[*p + 1], &c__1, &taup2[1], &x21[x21_offset],
                              ldx21, &work[ilarf]);
        }
        else
        {
            ...
            i__2 = *p - i__ + 1;
            i__3 = *q - i__ + 1;
            aocl_lapack_dlarf1f("L", &i__2, &i__3, &x11[i__ + (i__ - 1) * x11_dim1], &c__1,
                              &taup1[i__], &x11[i__ + i__ * x11_dim1], ldx11, &work[ilarf]);
            i__2 = *m - *p - i__ + 1;
            i__3 = *q - i__ + 1;
            aocl_lapack_dlarf1f("L", &i__2, &i__3, &x21[i__ + (i__ - 1) * x21_dim1], &c__1,
                              &taup2[i__], &x21[i__ + i__ * x21_dim1], ldx21, &work[ilarf]);
        }
        i__2 = *q - i__ + 1;
        d__1 = -c__;
        aocl_blas_drot(&i__2, &x11[i__ + i__ * x11_dim1], ldx11, &x21[i__ + i__ * x21_dim1], ldx21,
                       &s, &d__1);
        i__2 = *q - i__ + 1;
        ...
        if(i__ < *m - *q)
        {
            i__2 = *p - i__;
            /* Computing 2nd power */
            d__1 = aocl_blas_dnrm2(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &c__1);
            i__3 = *m - *p - i__;
            /* Computing 2nd power */
            d__2 = aocl_blas_dnrm2(&i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1);
    ...
    for(i__ = *m - *q + 1; i__ <= i__1; ++i__)
    {
        ...
        i__2 = *p - i__;
        i__3 = *q - i__ + 1;
        aocl_lapack_dlarf1f("R", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], ldx11, &tauq1[i__],
                          &x11[i__ + 1 + i__ * x11_dim1], ldx11, &work[ilarf]);
        i__2 = *q - *p;
        i__3 = *q - i__ + 1;
        aocl_lapack_dlarf1f("R", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], ldx11, &tauq1[i__],
    ...
    {
        i__2 = *q - i__ + 1;
        aocl_lapack_dlarfgp(&i__2, &x21[*m - *q + i__ - *p + i__ * x21_dim1],
                            &x21[*m - *q + i__ - *p + (i__ + 1) * x21_dim1], ldx21, &tauq1[i__]);
        i__2 = *q - i__;
        i__3 = *q - i__ + 1;
        aocl_lapack_dlarf1f("R", &i__2, &i__3, &x21[*m - *q + i__ - *p + i__ * x21_dim1], ldx21,
