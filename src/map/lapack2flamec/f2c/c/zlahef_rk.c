...
/* > \brief \b ZLAHEF_RK computes a partial factorization of a complex Hermitian indefinite matrix
...
/* ===================================================================== */
/* Subroutine */
void zlahef_rk_(char *uplo, integer *n, integer *nb, integer *kb, doublecomplex *a, integer *lda,
