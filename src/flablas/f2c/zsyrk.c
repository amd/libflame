...
#include "FLA_f2c.h"
/* Subroutine */
int zsyrk_(char *uplo, char *trans, integer *n, integer *k, dcomplex *alpha, dcomplex *a, integer *lda, dcomplex * beta, dcomplex *c__, integer *ldc)
{
                    ...
                    ++j)
            {
                        ...
                        ++i__)
                {
                            ...
                            ++l)
                    {
                        i__4 = l + i__ * a_dim1;
                        i__5 = l + j * a_dim1;
                        z__2.real = a[i__4].real * a[i__5].real - a[i__4].imag * a[i__5] .imag, z__2.imag = a[i__4].real * a[i__5].imag + a[i__4] .imag * a[i__5].real;
