    ...
    *info = 0;
    ...
    switch(datatype)
    {
        case FLOAT:
        {
            ...
            if((*jobu == 'V' && *jobvt == 'V') || (*jobu == 'v' && *jobvt == 'v'))
            {
                ...
                sgemm_("N", "T", &min_m_n, &min_m_n, &n, &s_one, U_A, &m, V, &ldvt, &s_n_one, sigma,
                       &min_m_n);
                norm1 = fla_lapack_slange("1", &ns, &ns, sigma, &min_m_n, work);
            ...
            if(g_ext_fptr == NULL)
            {
                ...
                norm_s = fla_lapack_slange("1", &ns, &i_one, s_test, &i_one, work);
        ...
        case COMPLEX:
        {
            ...
            {
                /* Test 1: Compute (sigma_test - (U'A VT')) */
                norm_sigma = fla_lapack_clange("1", &ns, &ns, sigma, &min_m_n, work);
