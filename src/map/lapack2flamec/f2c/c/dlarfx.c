/* ../netlib/dlarfx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarfx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarfx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarfx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dlarfx(side, m, n, v, tau, c__, ldc, work);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t ldc_64 = *ldc;

    aocl_lapack_dlarfx(side, &m_64, &n_64, v, tau, c__, &ldc_64, work);
#endif
}

void aocl_lapack_dlarfx(char *side, aocl_int64_t *m, aocl_int64_t *n, doublereal *v,
                        doublereal *tau, doublereal *c__, aocl_int64_t *ldc, doublereal *work)
{
    ...
    if(lsame_(side, "L", 1, 1))
    {
        ...
        /* Code for general M */
        aocl_lapack_dlarf(side, m, n, &v[1], &c__1, tau, &c__[c_offset], ldc, &work[1]);
        goto L410;
