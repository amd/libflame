...
void F77_cgedmd(char *jobs, char *jobz, char *jobr, char *jobf, integer *whtsvd, integer *m, integer *n, complex *x, integer *ldx, complex *y, integer *ldy, integer *nrnk, real *tol, integer *k, complex *eigs, complex *z__, integer *ldz, real *res, complex *b, integer *ldb, complex *w, integer *ldw, complex *s, integer *lds, complex *zwork, integer *lzwork, real *rwork, integer *lrwork, integer *iwork, integer *liwork, integer *info);
void F77_zgedmd(char *jobs, char *jobz, char *jobr, char *jobf, integer *whtsvd, integer *m, integer *n, doublecomplex *x, integer *ldx, doublecomplex *y, integer *ldy, integer *nrnk, doublereal *tol, integer *k, doublecomplex *eigs, doublecomplex *z__, integer *ldz, doublereal *res, doublecomplex *b, integer *ldb, doublecomplex *w, integer *ldw, doublecomplex *s, integer *lds, doublecomplex *zwork, integer *lzwork, doublereal *rwork, integer *lrwork, integer *iwork, integer *liwork, integer *info);
...
void F77_cgedmdq(char *jobs, char *jobz, char *jobr, char *jobq, char *jobt, char *jobf, integer *whtsvd, integer *m, integer *n, complex *f, integer *ldf, complex *x, integer *ldx, complex *y, integer *ldy, integer *nrnk, real *tol, integer *k, complex *eigs, complex *z__, integer *ldz, real *res, complex *b, integer *ldb, complex *v, integer *ldv, complex *s, integer *lds, complex *zwork, integer *lzwork, real *work, integer *lwork, integer *iwork, integer *liwork, integer *info);
void F77_zgedmdq(char *jobs, char *jobz, char *jobr, char *jobq, char *jobt, char *jobf, integer *whtsvd, integer *m, integer *n, complex *f, integer *ldf, complex *x, integer *ldx, complex *y, integer *ldy, integer *nrnk, real *tol, integer *k, complex *eigs, complex *z__, integer *ldz, real *res, complex *b, integer *ldb, complex *v, integer *ldv, complex *s, integer *lds, complex *zwork, integer *lzwork, real *work, integer *lwork, integer *iwork, integer *liwork, integer *info);