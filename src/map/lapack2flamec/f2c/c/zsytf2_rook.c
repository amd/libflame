/* ../netlib/zsytf2_rook.f -- translated by f2c (version 20100827). You must link the resulting
...
/* > \brief \b ZSYTF2_ROOK computes the factorization of a scomplex symmetric indefinite matrix using
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zsytf2_
 * rook.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zsytf2_
 * rook.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zsytf2_
 * rook.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > ZSYTF2_ROOK computes the factorization of a scomplex symmetric matrix A */
...
void zsytf2_rook_(char *uplo, aocl_int_t *n, dcomplex *a, aocl_int_t *lda, aocl_int_t *ipiv,
                  aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zsytf2_rook(uplo, n, a, lda, ipiv, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;
    aocl_int64_t info_64 = *info;

    aocl_lapack_zsytf2_rook(uplo, &n_64, a, &lda_64, ipiv, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zsytf2_rook(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
                             aocl_int_t *ipiv, aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("zsytf2_rook inputs: uplo %c, n %" FLA_IS ", lda %" FLA_IS "", *uplo, *n,
                      *lda);
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZSYTF2_ROOK", &i__1, (ftnlen)11);
                ...
                if(k > 2)
                {
                    ...
                    for(j = k - 2; j >= 1; --j)
                    {
                        ...
                        for(i__ = j; i__ >= 1; --i__)
                        {
                            ...
                            z__3.real = z__4.real * wk.real - z__4.imag * wk.imag;
                            z__3.imag = z__4.real * wk.imag + z__4.imag * wk.real; // , expr subst
                            z__2.real = a[i__2].real - z__3.real;
                            z__2.imag = a[i__2].imag - z__3.imag; // , expr subst
                            z_div(&z__6, &a[i__ + (k - 1) * a_dim1], &d12);
                            z__5.real = z__6.real * wkm1.real - z__6.imag * wkm1.imag;
                            z__5.imag = z__6.real * wkm1.imag + z__6.imag * wkm1.real; // , expr subst
                ...
                if(k < *n - 1)
                {
                    ...
                    for(j = k + 2; j <= i__1; ++j)
                    {
                        ...
                        for(i__ = j; i__ <= i__2; ++i__)
                        {
                            ...
                            z__5.real = z__6.real * wkp1.real - z__6.imag * wkp1.imag;
                            z__5.imag = z__6.real * wkp1.imag + z__6.imag * wkp1.real; // , expr subst
                            z__1.real = z__2.real - z__5.real;
                            z__1.imag = z__2.imag - z__5.imag; // , expr subst
