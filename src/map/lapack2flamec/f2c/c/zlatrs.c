/* zlatrs.f -- translated by f2c (version 20190311). You must link the resulting object file with
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zlatrs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zlatrs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zlatrs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
            ...
            if(upper)
            {
                ...
                for(j = 2; j <= i__1; ++j)
                {
                    ...
                    for(i__ = 1; i__ <= i__2; ++i__)
                    {
                        /* Computing MAX */
                        i__3 = i__ + j * a_dim1;
                        d__3 = tmax, d__4 = (d__1 = a[i__3].real, f2c_dabs(d__1));
                    ...
                    else
                    {
                        ...
                        if(upper)
                        {
                            ...
                            for(i__ = 1; i__ <= i__2; ++i__)
                            {
                                i__3 = i__ + j * a_dim1;
                                cnorm[j] += tscal
                                            * ((d__1 = a[i__3].real / 2., f2c_dabs(d__1))
                                               + (d__2 = d_imag(&a[i__ + j * a_dim1]) / 2.,
                                                  f2c_dabs(d__2)));
                            }
                        }
                        else
    ...
    else
    {
        ...
        if(notran)
        {
            ...
            for(j = jfirst; i__2 < 0 ? j >= i__1 : j <= i__1; j += i__2)
            {
                ...
                {
                    i__3 = j + j * a_dim1;
                    z__1.real = tscal * a[i__3].real;
                    z__1.imag = tscal * a[i__3].imag; // , expr subst
                    tjjs.real = z__1.real;
            ...
            for(j = jfirst; i__1 < 0 ? j >= i__2 : j <= i__2; j += i__1)
            {
                ...
                else
                {
                    ...
                    if(upper)
                    {
                        ...
                        {
                            i__4 = i__ + j * a_dim1;
                            z__3.real = a[i__4].real * uscal.real - a[i__4].imag * uscal.imag;
                            z__3.imag = a[i__4].real * uscal.imag + a[i__4].imag * uscal.real; // , expr subst
                            i__5 = i__;
