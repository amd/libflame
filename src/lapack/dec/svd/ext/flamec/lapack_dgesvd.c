                  ...
                  aocl_int64_t *info)
{
    ...
    extern /* Subroutine */
        ...
        lapack_dbdsqr(char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *,
                      doublereal *, doublereal *, doublereal *, aocl_int64_t *, doublereal *,
                      aocl_int64_t *, doublereal *, aocl_int64_t *, doublereal *, aocl_int64_t *),
    ...
    extern /* Subroutine */
        int
        lapack_dormbr(char *, char *, char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *,
                      doublereal *, aocl_int64_t *, doublereal *, doublereal *, aocl_int64_t *,
                      doublereal *, aocl_int64_t *, aocl_int64_t *),
        lapack_dorglq(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, doublereal *, aocl_int64_t *,
        ...
        if(*m >= mnthr)
        {
            if(wntun)
            {
...
#endif
                {
                    ...
                    lapack_dbdsqr("U", n, &ncvt, &c__0, &c__0, &s[1], &work[ie], &a[a_offset], lda,
            ...
            else if(wntuo && wntvn)
            {
                ...
                if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                {
                    ...
                    lapack_dbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &c__1, &work[ir],
            ...
            else if(wntuo && wntvas)
            {
                ...
                if(*lwork >= *n * *n + fla_max(i__3, bdspac))
                {
                    ...
                    /* (Workspace: need N*N + BDSPAC) */
                    lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                ...
                else
                {
                    ...
                    i__2 = *lwork - iwork + 1;
                    lapack_dormbr("Q", "R", "N", m, n, n, &vt[vt_offset], ldvt, &work[itauq],
                    ...
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                                  &a[a_offset], lda, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntus)
            {
                if(wntvn)
                {
                    ...
                    else
                    {
                        ...
                        /* (Workspace: need 3*N + M, prefer 3*N + M*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_dormbr("Q", "R", "N", m, n, n, &a[a_offset], lda, &work[itauq],
                ...
                else if(wntvo)
                {
                    ...
                    if(*lwork >= (*n << 1) * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                    ...
                    else
                    {
                        ...
                        /* singular vectors of A in A */
                        /* (Workspace: need BDSPAC) */
                        lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                      &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                    }
                }
                else if(wntvas)
        ...
        else
        {
...
#endif
            {
                ...
                if(!wntuo && !wntvo)
                {
                    ...
                    /* vectors in VT */
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[vt_offset],
                                  ldvt, &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
                else if(!wntuo && wntvo)
                {
                    ...
                    /* vectors in A */
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
                else
                {
        ...
        if(*n >= mnthr)
        {
            if(wntvn)
            {
...
#endif
                {
                    ...
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("U", m, &c__0, &nru, &c__0, &s[1], &work[ie], dum, &c__1,
                                  &a[a_offset], lda, dum, &c__1, &work[iwork], info);
            ...
            else if(wntvo && wntun)
            {
                ...
                if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                {
                    ...
                    /* (Workspace: need M*M + 2*M, prefer M*M + M + M*NB) */
                    i__2 = *lwork - iwork + 1;
                    lapack_dorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[iwork], &i__2,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *m;
                    itaup = itauq + *m;
                    ...
                    lapack_dbdsqr("U", m, m, &c__0, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                                  dum, &c__1, dum, &c__1, &work[iwork], info);
                    iu = ie + *m;
                ...
                else
                {
                    ...
                    /* singular vectors of A in A */
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("L", m, n, &c__0, &c__0, &s[1], &work[ie], &a[a_offset], lda, dum,
            ...
            else if(wntvo && wntuas)
            {
                ...
                if(*lwork >= *m * *m + fla_max(i__3, bdspac))
                {
                    ...
                    /* (Workspace: need M*M + 2*M, prefer M*M + M + M*NB) */
                    i__3 = *lwork - iwork + 1;
                    lapack_dorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[iwork], &i__3,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *m;
                    itaup = itauq + *m;
                    ...
                    /* singular vectors of L in WORK(IR) */
                    /* (Workspace: need M*M + BDSPAC) */
                    lapack_dbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                    iu = ie + *m;
                    /* Multiply right singular vectors of L in WORK(IR) by Q */
                    /* in A, storing result in WORK(IU) and copying to A */
                ...
                else
                {
                    ...
                    /* singular vectors of A in A */
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntvs)
            {
                if(wntun)
                {
                    ...
                    else
                    {
                        ...
                        /* (Workspace: need 2*M, prefer M + M*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_dorglq(m, n, m, &vt[vt_offset], ldvt, &work[itau], &work[iwork],
                                      &i__2, &ierr);
                        ie = itau;
                        itauq = ie + *m;
                        itaup = itauq + *m;
                        ...
                        /* (Workspace: need 3*M + N, prefer 3*M + N*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_dormbr("P", "L", "T", m, n, m, &a[a_offset], lda, &work[itaup],
                                      &vt[vt_offset], ldvt, &work[iwork], &i__2, &ierr);
                        iwork = ie + *m;
                        /* Perform bidiagonal QR iteration, computing right */
                        /* singular vectors of A in VT */
                        /* (Workspace: need BDSPAC) */
                        lapack_dbdsqr("U", m, n, &c__0, &c__0, &s[1], &work[ie], &vt[vt_offset],
                ...
                else if(wntuo)
                {
                    ...
                    if(*lwork >= (*m << 1) * *m + fla_max(i__2, bdspac))
                    {
                        ...
                        lapack_dbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[iu], &ldwrku,
                                      &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
                    ...
                    else
                    {
                        ...
                        /* singular vectors of A in VT */
                        /* (Workspace: need BDSPAC) */
                        lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                                      &a[a_offset], lda, dum, &c__1, &work[iwork], info);
                    }
                }
                else if(wntuas)
            ...
            else if(wntva)
            {
                if(wntun)
                {
                    ...
                    if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                    {
                        ...
                        i__2 = *lwork - iwork + 1;
                        lapack_dorglq(n, n, m, &vt[vt_offset], ldvt, &work[itau], &work[iwork],
                                      &i__2, &ierr);
                        ie = itau;
                        itauq = ie + *m;
                        itaup = itauq + *m;
        ...
        else
        {
...
#endif
            {
                ...
                if(!wntuo && !wntvo)
                {
                    ...
                    /* vectors in VT */
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[vt_offset],
                                  ldvt, &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
                else if(!wntuo && wntvo)
                {
                    ...
                    /* vectors in A */
                    /* (Workspace: need BDSPAC) */
                    lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
                else
                {
