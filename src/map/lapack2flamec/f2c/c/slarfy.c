...
void slarfy_(char *uplo, aocl_int_t *n, real *v, aocl_int_t *incv, real *tau, real *c__,
             aocl_int_t *ldc, real *work)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_slarfy(uplo, n, v, incv, tau, c__, ldc, work);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t incv_64 = *incv;
    aocl_int64_t ldc_64 = *ldc;

    aocl_lapack_slarfy(uplo, &n_64, v, &incv_64, tau, c__, &ldc_64, work);
#endif
}
