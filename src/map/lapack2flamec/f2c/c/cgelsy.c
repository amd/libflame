...
void cgelsy_(aocl_int_t *m, aocl_int_t *n, aocl_int_t *nrhs, scomplex *a, aocl_int_t *lda,
             scomplex *b, aocl_int_t *ldb, aocl_int_t *jpvt, real *rcond, aocl_int_t *rank,
             scomplex *work, aocl_int_t *lwork, real *rwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cgelsy(m, n, nrhs, a, lda, b, ldb, jpvt, rcond, rank, work, lwork, rwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_cgelsy(&m_64, &n_64, &nrhs_64, a, &lda_64, b, &ldb_64, jpvt, rcond, &rank_64, work,
...
void aocl_lapack_cgelsy(aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *nrhs, scomplex *a,
                        aocl_int64_t *lda, scomplex *b, aocl_int64_t *ldb, aocl_int_t *jpvt,
                        real *rcond, aocl_int64_t *rank, scomplex *work, aocl_int64_t *lwork,
                        real *rwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    nb1 = aocl_lapack_ilaenv(&c__1, "CGEQRF", " ", m, n, &c_n1, &c_n1);
    nb2 = aocl_lapack_ilaenv(&c__1, "CGERQF", " ", m, n, &c_n1, &c_n1);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CGELSY", &i__1, (ftnlen)6);
    ...
    /* A * P = Q * R */
    i__1 = *lwork - mn;
    aocl_lapack_cgeqp3(m, n, &a[a_offset], lda, &jpvt[1], &work[1], &work[mn + 1], &i__1, &rwork[1],
                       info);
    i__1 = mn + 1;
...
L10:
    if(*rank < mn)
    {
        ...
        if(smaxpr * *rcond <= sminpr)
        {
            ...
            for(i__ = 1; i__ <= i__1; ++i__)
            {
                i__2 = ismin + i__ - 1;
                i__3 = ismin + i__ - 1;
                q__1.real = s1.real * work[i__3].real - s1.imag * work[i__3].imag;
                q__1.imag = s1.real * work[i__3].imag + s1.imag * work[i__3].real; // , expr subst
                work[i__2].real = q__1.real;
                work[i__2].imag = q__1.imag; // , expr subst
                i__2 = ismax + i__ - 1;
                i__3 = ismax + i__ - 1;
                q__1.real = s2.real * work[i__3].real - s2.imag * work[i__3].imag;
                q__1.imag = s2.real * work[i__3].imag + s2.imag * work[i__3].real; // , expr subst
                work[i__2].real = q__1.real;
                work[i__2].imag = q__1.imag; // , expr subst
                /* L20: */
            }
    ...
    {
        i__1 = *lwork - (mn << 1);
        aocl_lapack_ctzrzf(rank, n, &a[a_offset], lda, &work[mn + 1], &work[(mn << 1) + 1], &i__1,
                           info);
    }
    ...
    i__1 = *lwork - (mn << 1);
    aocl_lapack_cunmqr("Left", "Conjugate transpose", m, nrhs, &mn, &a[a_offset], lda, &work[1],
    ...
    if(*rank < *n)
    {
        i__1 = *n - *rank;
        i__2 = *lwork - (mn << 1);
        aocl_lapack_cunmrz("Left", "Conjugate transpose", n, nrhs, rank, &i__1, &a[a_offset], lda,
    ...
    for(j = 1; j <= i__1; ++j)
    {
        ...
        aocl_blas_ccopy(n, &work[1], &c__1, &b[j * b_dim1 + 1], &c__1);
        /* L60: */
    }
    ...
    if(iascl == 1)
    {
        ...
        aocl_lapack_clascl("U", &c__0, &c__0, &smlnum, &anrm, rank, rank, &a[a_offset], lda, info);
    }
    else if(iascl == 2)
    {
        aocl_lapack_clascl("G", &c__0, &c__0, &anrm, &bignum, n, nrhs, &b[b_offset], ldb, info);
        aocl_lapack_clascl("U", &c__0, &c__0, &bignum, &anrm, rank, rank, &a[a_offset], lda, info);
    }
    if(ibscl == 1)
    {
