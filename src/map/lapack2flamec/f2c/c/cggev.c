...
void cggev_(char *jobvl, char *jobvr, aocl_int_t *n, scomplex *a, aocl_int_t *lda, scomplex *b,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cggev(jobvl, jobvr, n, a, lda, b, ldb, alpha, beta, vl, ldvl, vr, ldvr, work, lwork,
                      rwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_cggev(jobvl, jobvr, &n_64, a, &lda_64, b, &ldb_64, alpha, beta, vl, &ldvl_64, vr,
...
void aocl_lapack_cggev(char *jobvl, char *jobvr, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda,
                       ...
                       aocl_int64_t *lwork, real *rwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        i__1 = lwkopt;
        i__2 = *n
               + *n * aocl_lapack_ilaenv(&c__1, "CUNMQR", " ", n, &c__1, n, &c__0); // , expr subst
        lwkopt = fla_max(i__1, i__2);
        if(ilvl)
        {
            /* Computing MAX */
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CGGEV ", &i__1, (ftnlen)6);
