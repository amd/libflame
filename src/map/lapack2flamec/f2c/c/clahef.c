...
/* > \brief \b CLAHEF computes a partial factorization of a complex Hermitian indefinite matrix
...
/* ===================================================================== */
/* Subroutine */
void clahef_(char *uplo, integer *n, integer *nb, integer *kb, complex *a, integer *lda,
