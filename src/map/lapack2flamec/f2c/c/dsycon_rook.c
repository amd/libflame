/* ../netlib/dsycon_rook.f -- translated by f2c (version 20100827). You must link the resulting
...
void dsycon_rook_(char *uplo, aocl_int_t *n, doublereal *a, aocl_int_t *lda, aocl_int_t *ipiv,
                  doublereal *anorm, doublereal *rcond, doublereal *work, aocl_int_t *iwork,
                  aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dsycon_rook(uplo, n, a, lda, ipiv, anorm, rcond, work, iwork, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;
    aocl_int64_t info_64 = *info;

    aocl_lapack_dsycon_rook(uplo, &n_64, a, &lda_64, ipiv, anorm, rcond, work, iwork, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dsycon_rook(char *uplo, aocl_int64_t *n, doublereal *a, aocl_int64_t *lda,
                             aocl_int_t *ipiv, doublereal *anorm, doublereal *rcond,
                             doublereal *work, aocl_int_t *iwork, aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("dsycon_rook inputs: uplo %c, n %" FLA_IS ", lda %" FLA_IS "", *uplo, *n,
                      *lda);
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DSYCON_ROOK", &i__1, (ftnlen)11);
...
L30:
    ...
    if(kase != 0)
    {
        ...
        aocl_lapack_dsytrs_rook(uplo, n, &c__1, &a[a_offset], lda, &ipiv[1], &work[1], n, info);
        goto L30;
    }
