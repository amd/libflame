/* ../netlib/v3.9.0/chesv_aa_2stage.f -- translated by f2c (version 20160102). You must link the
...
/* ===================================================================== */
/* Subroutine */
void chesv_aa_2stage_(char *uplo, integer *n, integer *nrhs, complex *a, integer *lda, complex *tb,
                      ...
                      complex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        chetrs_aa_2stage_(char *, integer *, integer *, complex *, integer *, complex *, integer *,
    ...
    extern /* Subroutine */
        void
        chetrf_aa_2stage_(char *, integer *, complex *, integer *, complex *, integer *, integer *,
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        chetrf_aa_2stage_(uplo, n, &a[a_offset], lda, &tb[1], &c_n1, &ipiv[1], &ipiv2[1], &work[1],
                          &c_n1, info);
    ...
    chetrf_aa_2stage_(uplo, n, &a[a_offset], lda, &tb[1], ltb, &ipiv[1], &ipiv2[1], &work[1], lwork,
                      info);
    if(*info == 0)
    {
        /* Solve the system A*X = B, overwriting B with X. */
        chetrs_aa_2stage_(uplo, n, nrhs, &a[a_offset], lda, &tb[1], ltb, &ipiv[1], &ipiv2[1],
                          &b[b_offset], ldb, info);
    }
