...
/* > \brief \b ZSYTF2_ROOK computes the factorization of a complex symmetric indefinite matrix using
...
/* ===================================================================== */
/* Subroutine */
void zsytf2_rook_(char *uplo, integer *n, doublecomplex *a, integer *lda, integer *ipiv,
                  integer *info)
{
