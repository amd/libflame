...
/* ===================================================================== */
/* Subroutine */
void stplqt_(integer *m, integer *n, integer *l, integer *mb, real *a, integer *lda, real *b,
             integer *ldb, real *t, integer *ldt, real *work, integer *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF(
             "stplqt inputs: m %" FLA_IS ", n %" FLA_IS ", l %" FLA_IS ", mb %" FLA_IS
    ...
    extern /* Subroutine */
        ...
        stprfb_(char *, char *, char *, char *, integer *, integer *, integer *, integer *, real *,
                ...
                integer *),
        stplqt2_(integer *, integer *, integer *, real *, integer *, real *, integer *, real *,
                 integer *, integer *);
    ...
    *info = 0;
    ...
    for(i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
    {
        ...
        stplqt2_(&ib, &nb, &lb, &a[i__ + i__ * a_dim1], lda, &b[i__ + b_dim1], ldb,
        ...
        if(i__ + ib <= *m)
        {
            i__3 = *m - i__ - ib + 1;
            i__4 = *m - i__ - ib + 1;
            stprfb_("R", "N", "F", "R", &i__3, &nb, &ib, &lb, &b[i__ + b_dim1], ldb,
