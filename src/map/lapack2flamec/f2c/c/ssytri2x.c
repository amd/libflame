...
/* ===================================================================== */
/* Subroutine */
void ssytri2x_(char *uplo, integer *n, real *a, integer *lda, integer *ipiv, real *work, integer *nb, integer *info)
{
    ...
    extern /* Subroutine */
    void ssyconv_(char *, char *, integer *, real *, integer *, integer *, real *, integer *);
