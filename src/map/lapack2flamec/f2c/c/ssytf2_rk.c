/* ../netlib/v3.9.0/ssytf2_rk.f -- translated by f2c (version 20160102). You must link the resulting
                ...
                integer *info)
{
    ...
    char buffer[256];
    snprintf(buffer, 256, "ssytf2_rk inputs: uplo %c, n %" FLA_IS ", lda %" FLA_IS "", *uplo, *n,
             *lda);
