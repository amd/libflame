/* ../netlib/sporfs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sporfs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sporfs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sporfs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void sporfs_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, real *a, aocl_int_t *lda, real *af,
             aocl_int_t *ldaf, real *b, aocl_int_t *ldb, real *x, aocl_int_t *ldx, real *ferr,
             real *berr, real *work, aocl_int_t *iwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_sporfs(uplo, n, nrhs, a, lda, af, ldaf, b, ldb, x, ldx, ferr, berr, work, iwork,
                       info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_sporfs(uplo, &n_64, &nrhs_64, a, &lda_64, af, &ldaf_64, b, &ldb_64, x, &ldx_64,
...
void aocl_lapack_sporfs(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, real *a, aocl_int64_t *lda,
                        real *af, aocl_int64_t *ldaf, real *b, aocl_int64_t *ldb, real *x,
                        aocl_int64_t *ldx, real *ferr, real *berr, real *work, aocl_int_t *iwork,
                        aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("sporfs inputs: uplo %c, n %" FLA_IS ", nrhs %" FLA_IS ", lda %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SPORFS", &i__1, (ftnlen)6);
    ...
    L20: /* Loop until stopping criterion is satisfied. */
        ...
        if(berr[j] > eps && berr[j] * 2.f <= lstres && count <= 5)
        {
            ...
            aocl_lapack_spotrs(uplo, n, &c__1, &af[af_offset], ldaf, &work[*n + 1], n, info);
