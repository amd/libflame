...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chegv.f
 * "> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chegv.f
 * "> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chegv.f
 * "> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void chegv_(aocl_int_t *itype, char *jobz, char *uplo, aocl_int_t *n, scomplex *a, aocl_int_t *lda,
                       ...
                       aocl_int64_t *lwork, real *rwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    aocl_lapack_cheev(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &rwork[1], info);
    if(wantz)
    {
