                          ...
                          integer *info)
{
    ...
    extern /* Subroutine */
        void
        zla_geamv_(integer *, integer *, integer *, doublereal *, dcomplex *, integer *,
                   dcomplex *, integer *, doublereal *, doublereal *, integer *);
    ...
    extern /* Subroutine */
        ...
        blas_zgemv_x_(integer *, integer *, integer *, dcomplex *, dcomplex *, integer *,
    ...
    extern /* Subroutine */
        void
        zgemv_(char *, integer *, integer *, dcomplex *, dcomplex *, integer *,
               dcomplex *, integer *, dcomplex *, dcomplex *, integer *);
    ...
    *(unsigned char *)trans = *(unsigned char *)&ch__1[0];
    ...
    for(j = 1; j <= i__1; ++j)
    {
        ...
        for(cnt = 1; cnt <= i__2; ++cnt)
        {
            ...
            if(y_prec_state__ == 0)
            {
                zgemv_(trans, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 1], &c__1, &c_b8,
                       &res[1], &c__1);
            }
            else if(y_prec_state__ == 1)
            {
                blas_zgemv_x_(trans_type__, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 1],
                              &c__1, &c_b8, &res[1], &c__1, prec_type__);
            }
            else
            {
                blas_zgemv2_x_(trans_type__, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 1],
    ...
    L666: /* Set final_* when cnt hits ithresh */
        ...
        /* op(A) = A, A**T, or A**H depending on TRANS (and type). */
        zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
        zgemv_(trans, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 1], &c__1, &c_b8, &res[1],
               &c__1);
        i__2 = *n;
        for(i__ = 1; i__ <= i__2; ++i__)
        {
