...
/* > \verbatim */
/* > INFO is INTEGER */
/* > The value of INFO returned from CSYTRF, .imag.e., the pivot in */
...
real cla_syrpvgrw_(char *uplo, aocl_int_t *n, aocl_int_t *info, scomplex *a, aocl_int_t *lda,
                   scomplex *af, aocl_int_t *ldaf, aocl_int_t *ipiv, real *work)
{
#if FLA_ENABLE_ILP64
    return aocl_lapack_cla_syrpvgrw(uplo, n, info, a, lda, af, ldaf, ipiv, work);
#else
    aocl_int64_t n_64 = *n;
    ...
    return aocl_lapack_cla_syrpvgrw(uplo, &n_64, &info_64, a, &lda_64, af, &ldaf_64, ipiv, work);
#endif
}

real aocl_lapack_cla_syrpvgrw(char *uplo, aocl_int64_t *n, aocl_int64_t *info, scomplex *a,
