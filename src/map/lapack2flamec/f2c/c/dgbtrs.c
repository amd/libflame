...
void dgbtrs_(char *trans, aocl_int_t *n, aocl_int_t *kl, aocl_int_t *ku, aocl_int_t *nrhs,
             doublereal *ab, aocl_int_t *ldab, aocl_int_t *ipiv, doublereal *b, aocl_int_t *ldb,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dgbtrs(trans, n, kl, ku, nrhs, ab, ldab, ipiv, b, ldb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dgbtrs(trans, &n_64, &kl_64, &ku_64, &nrhs_64, ab, &ldab_64, ipiv, b, &ldb_64,
                       &info_64);
...
void aocl_lapack_dgbtrs(char *trans, aocl_int64_t *n, aocl_int64_t *kl, aocl_int64_t *ku,
                        aocl_int64_t *nrhs, doublereal *ab, aocl_int64_t *ldab, aocl_int_t *ipiv,
