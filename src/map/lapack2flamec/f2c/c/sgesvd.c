                  ...
                  aocl_int64_t *ldvt, real *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    extern
        void
        sormbr_fla(char *, char *, char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *,
    ...
    extern /* Subroutine */
        void
        sorglq_fla(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, real *, aocl_int64_t *,
                      real *, real *, aocl_int64_t *, aocl_int64_t *);
    real smlnum;
    extern /* Subroutine */
        void
        sorgqr_fla(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, real *, aocl_int64_t *,
                      real *, real *, aocl_int64_t *, aocl_int64_t *);
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        if(*m >= *n && minmn > 0)
        {
            ...
            sorgqr_fla(m, n, n, &a[a_offset], lda, dum, dum, &c_n1, &ierr);
            lwork_sorgqr_n__ = (aocl_int64_t)dum[0];
            sorgqr_fla(m, m, n, &a[a_offset], lda, dum, dum, &c_n1, &ierr);
        ...
        else if(minmn > 0)
        {
            ...
            sorglq_fla(n, n, m, dum, n, dum, dum, &c_n1, &ierr);
            lwork_sorglq_n__ = (aocl_int64_t)dum[0];
            sorglq_fla(m, n, m, &a[a_offset], lda, dum, dum, &c_n1, &ierr);
        ...
        if(*m >= mnthr)
        {
            ...
            else if(wntuo && wntvn)
            {
                ...
                if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                {
                    ...
                    aocl_lapack_sbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &c__1, &work[ir],
                ...
                else
                {
                    ...
                    /* (Workspace: need BDSPAC) */
                    aocl_lapack_sbdsqr("U", n, &c__0, m, &c__0, &s[1], &work[ie], dum, &c__1,
            ...
            else if(wntuo && wntvas)
            {
                ...
                if(*lwork >= *n * *n + fla_max(i__3, bdspac))
                {
                    ...
                    /* (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */
                    i__3 = *lwork - iwork + 1;
                    sorgqr_fla(m, n, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__3,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *n;
                    itaup = itauq + *n;
            ...
            else if(wntus)
            {
                if(wntvn)
                {
                    ...
                    if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        /* singular vectors of R in WORK(IR) */
                        /* (Workspace: need N*N+BDSPAC) */
                        aocl_lapack_sbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &c__1,
                                      &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
                        /* Multiply Q in A by left singular vectors of R in */
                    ...
                    else
                    {
                        ...
                        /* (Workspace: need 3*N+M, prefer 3*N+M*NB) */
                        i__2 = *lwork - iwork + 1;
                        sormbr_fla("Q", "R", "N", m, n, n, &a[a_offset], lda, &work[itauq],
                ...
                else if(wntvo)
                {
                    ...
                    if(*lwork >= (*n << 1) * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        aocl_lapack_sbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                    ...
                    else
                    {
                        ...
                        /* singular vectors of A in A */
                        /* (Workspace: need BDSPAC) */
                        aocl_lapack_sbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                      &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                    }
                }
                else if(wntvas)
            ...
            else if(wntua)
            {
                if(wntvn)
                {
                    ...
                    if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgqr_fla(m, m, n, &u[u_offset], ldu, &work[itau], &work[iwork], &i__2,
                                      &ierr);
                        ie = itau;
                        itauq = ie + *n;
                        itaup = itauq + *n;
        ...
        if(*n >= mnthr)
        {
            ...
            else if(wntvo && wntun)
            {
                ...
                if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                {
                    ...
                    aocl_lapack_sbdsqr("U", m, m, &c__0, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                ...
                else
                {
                    ...
                    /* singular vectors of A in A */
                    /* (Workspace: need BDSPAC) */
                    aocl_lapack_sbdsqr("L", m, n, &c__0, &c__0, &s[1], &work[ie], &a[a_offset], lda, dum,
                                  &c__1, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntvo && wntuas)
            {
                ...
                if(*lwork >= *m * *m + fla_max(i__3, bdspac))
                {
                    ...
                    /* (Workspace: need M*M+2*M, prefer M*M+M+M*NB) */
                    i__3 = *lwork - iwork + 1;
                    sorglq_fla(m, n, m, &a[a_offset], lda, &work[itau], &work[iwork], &i__3,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *m;
                    itaup = itauq + *m;
                    ...
                    /* singular vectors of L in WORK(IR) */
                    /* (Workspace: need M*M+BDSPAC) */
                    aocl_lapack_sbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                    iu = ie + *m;
                    /* Multiply right singular vectors of L in WORK(IR) by Q */
                    /* in A, storing result in WORK(IU) and copying to A */
                ...
                else
                {
                    ...
                    /* singular vectors of A in A */
                    /* (Workspace: need BDSPAC) */
                    aocl_lapack_sbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntvs)
            {
                if(wntun)
                {
                    ...
                    else
                    {
                        ...
                        /* (Workspace: need 3*M+N, prefer 3*M+N*NB) */
                        i__2 = *lwork - iwork + 1;
                        sormbr_fla("P", "L", "T", m, n, m, &a[a_offset], lda, &work[itaup],
                                      &vt[vt_offset], ldvt, &work[iwork], &i__2, &ierr);
                        iwork = ie + *m;
                        /* Perform bidiagonal QR iteration, computing right */
                        /* singular vectors of A in VT */
                        /* (Workspace: need BDSPAC) */
                        aocl_lapack_sbdsqr("U", m, n, &c__0, &c__0, &s[1], &work[ie], &vt[vt_offset],
            ...
            else if(wntva)
            {
                if(wntun)
                {
                    ...
                    if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                    {
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorglq_fla(n, n, m, &vt[vt_offset], ldvt, &work[itau], &work[iwork],
                                      &i__2, &ierr);
                        ie = itau;
                        itauq = ie + *m;
                        itaup = itauq + *m;
