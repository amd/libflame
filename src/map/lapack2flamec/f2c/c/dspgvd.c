/* ../netlib/dspgvd.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dspgvd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dspgvd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dspgvd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dspgvd_(aocl_int_t *itype, char *jobz, char *uplo, aocl_int_t *n, doublereal *ap,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dspgvd(itype, jobz, uplo, n, ap, bp, w, z__, ldz, work, lwork, iwork, liwork, info);
#else
    ...
    aocl_lapack_dspgvd(&itype_64, jobz, uplo, &n_64, ap, bp, w, z__, &ldz_64, work, &lwork_64,
...
void aocl_lapack_dspgvd(aocl_int64_t *itype, char *jobz, char *uplo, aocl_int64_t *n,
                        ...
                        aocl_int64_t *liwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DSPGVD", &i__1, (ftnlen)6);
