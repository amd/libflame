...
/* ===================================================================== */
/* Subroutine */
void sporfs_(char *uplo, integer *n, integer *nrhs, real *a, integer *lda, real *af, integer *ldaf,
             ...
             integer *iwork, integer *info)
{
    ...
    char buffer[256];
    snprintf(buffer, 256, "sporfs inputs: uplo %c, n %d, nrhs %d, lda %d, ldaf %d, ldb %d, ldx %d",
