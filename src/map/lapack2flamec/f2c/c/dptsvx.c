/* ../netlib/dptsvx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dptsvx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dptsvx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dptsvx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dptsvx_(char *fact, aocl_int_t *n, aocl_int_t *nrhs, doublereal *d__, doublereal *e,
             doublereal *df, doublereal *ef, doublereal *b, aocl_int_t *ldb, doublereal *x,
                        ...
                        doublereal *ferr, doublereal *berr, doublereal *work, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(nofact)
    {
        ...
        {
            i__1 = *n - 1;
            aocl_blas_dcopy(&i__1, &e[1], &c__1, &ef[1], &c__1);
        }
        aocl_lapack_dpttrf(n, &df[1], &ef[1], info);
    ...
    anorm = aocl_lapack_dlanst("1", n, &d__[1], &e[1]);
    /* Compute the reciprocal of the condition number of A. */
    aocl_lapack_dptcon(n, &df[1], &ef[1], &anorm, rcond, &work[1], info);
