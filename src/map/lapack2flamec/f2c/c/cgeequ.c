/* ../netlib/cgeequ.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeequ.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeequ.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeequ.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void cgeequ_(aocl_int_t *m, aocl_int_t *n, scomplex *a, aocl_int_t *lda, real *r__, real *c__,
             real *rowcnd, real *colcnd, real *amax, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cgeequ(m, n, a, lda, r__, c__, rowcnd, colcnd, amax, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_cgeequ(&m_64, &n_64, a, &lda_64, r__, c__, rowcnd, colcnd, amax, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_cgeequ(aocl_int64_t *m, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda, real *r__,
                        real *c__, real *rowcnd, real *colcnd, real *amax, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CGEEQU", &i__1, (ftnlen)6);
