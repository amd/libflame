...
FLA_Error FLA_Hess_unb_external( FLA_Obj A, FLA_Obj t, fla_dim_t ilo, fla_dim_t ihi )
{
  fla_dim_t          info = 0;
...
FLA_Error FLA_Hess_unb_ext( FLA_Obj A, FLA_Obj t, fla_dim_t ilo, fla_dim_t ihi )
{
