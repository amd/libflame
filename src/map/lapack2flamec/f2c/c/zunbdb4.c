    ...
    *info = 0;
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        if(i__ == 1)
        {
            ...
            i__2 = *m - *p;
            d_cnjg(&z__1, &taup2[1]);
            aocl_lapack_zlarf("L", &i__2, q, &phantom[*p + 1], &c__1, &z__1, &x21[x21_offset],
                              ldx21, &work[ilarf]);
        }
        else
        {
            ...
            aocl_lapack_zlarf("L", &i__2, &i__3, &x11[i__ + (i__ - 1) * x11_dim1], &c__1, &z__1,
                              &x11[i__ + i__ * x11_dim1], ldx11, &work[ilarf]);
            i__2 = *m - *p - i__ + 1;
            i__3 = *q - i__ + 1;
            d_cnjg(&z__1, &taup2[i__]);
            aocl_lapack_zlarf("L", &i__2, &i__3, &x21[i__ + (i__ - 1) * x21_dim1], &c__1, &z__1,
