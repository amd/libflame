/* ./dorbdb5.f -- translated by f2c (version 20190311). You must link the resulting object file with
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dorbdb5
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dorbdb5
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dorbdb5
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void dorbdb5_(integer *m1, integer *m2, integer *n, doublereal *x1, integer *incx1, doublereal *x2,
              ...
              doublereal *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
    ...
    if(norm > *n * eps)
    {
        ...
        /* orthogonalization. */
        d__1 = 1. / norm;
        dscal_(m1, &d__1, &x1[1], incx1);
        d__1 = 1. / norm;
        dscal_(m2, &d__1, &x2[1], incx2);
        dorbdb6_(m1, m2, n, &x1[1], incx1, &x2[1], incx2, &q1[q1_offset], ldq1, &q2[q2_offset],
