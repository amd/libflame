/* dgelqf.f -- translated by f2c (version 20160102). You must link the resulting object file with
...
extern void dgeqrf_fla(aocl_int64_t *m, aocl_int64_t *n, doublereal *a, aocl_int64_t *lda,
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dgelqf.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dgelqf.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dgelqf.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                  ...
                  doublereal *tau, doublereal *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    extern /* Subroutine */
        int
        lapack_dgelq2(aocl_int64_t *, aocl_int64_t *, doublereal *, aocl_int64_t *, doublereal *,
    ...
    *info = 0;
    ...
    if(nb > 1 && nb < k)
    {
        ...
        /* Computing MAX */
        i__1 = 0;
        i__2 = aocl_lapack_ilaenv(&c__3, "DGELQF", " ", m, n, &c_n1, &c_n1); // , expr subst
        ...
        if(nx < k)
        {
            ...
            if(*lwork < iws)
            {
                ...
                /* Computing MAX */
                i__1 = 2;
                i__2 = aocl_lapack_ilaenv(&c__2, "DGELQF", " ", m, n, &c_n1, &c_n1); // , expr subst
    ...
    if(nb >= nbmin && nb < k && nx < k)
    {
        ...
        for(i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            if(i__ + ib <= *m)
            {
                ...
                i__3 = *n - i__ + 1;
                aocl_lapack_dlarft("Forward", "Rowwise", &i__3, &ib, &a[i__ + i__ * a_dim1], lda,
                                   &tau[i__], &work[1], &ldwork);
                /* Apply H to A(i+ib:m,i:n) from the right */
                i__3 = *m - i__ - ib + 1;
                i__4 = *n - i__ + 1;
                aocl_lapack_dlarfb("Right", "No transpose", "Forward", "Rowwise", &i__3, &i__4, &ib,
