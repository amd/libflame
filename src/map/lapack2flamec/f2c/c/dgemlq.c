...
/* ===================================================================== */
/* Subroutine */
void dgemlq_(char *side, char *trans, integer *m, integer *n, integer *k, doublereal *a,
             integer *lda, doublereal *t, integer *tsize, doublereal *c__, integer *ldc,
             doublereal *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        dlamswlq_(char *, char *, integer *, integer *, integer *, integer *, integer *,
    ...
    *info = 0;
    ...
    {
        dgemlqt_(side, trans, m, n, k, &mb, &a[a_offset], lda, &t[6], &mb, &c__[c_offset], ldc,
                 &work[1], info);
    }
    else
    {
        dlamswlq_(side, trans, m, n, k, &mb, &nb, &a[a_offset], lda, &t[6], &mb, &c__[c_offset],
