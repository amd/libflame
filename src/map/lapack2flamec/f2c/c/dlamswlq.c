...
/* ===================================================================== */
/* Subroutine */
void dlamswlq_(char *side, char *trans, integer *m, integer *n, integer *k, integer *mb,
               ...
               doublereal *c__, integer *ldc, doublereal *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        ...
        dgemlqt_(char *, char *, integer *, integer *, integer *, integer *, doublereal *,
                 ...
                 integer *),
        dtpmlqt_(char *, char *, integer *, integer *, integer *, integer *, integer *,
    ...
    *info = 0;
    ...
    {
        dgemlqt_(side, trans, m, n, k, mb, &a[a_offset], lda, &t[t_offset], ldt, &c__[c_offset],
                 ldc, &work[1], info);
        AOCL_DTL_TRACE_LOG_EXIT
        return;
    }
    if(left && tran)
    {
        ...
        for(i__ = ii - (*nb - *k); i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            --ctr;
            i__3 = *nb - *k;
            dtpmlqt_("L", "T", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                     &c__[i__ + c_dim1], ldc, &work[1], info);
        }
        /* Multiply Q to the first block of C (1:M,1:NB) */
        dgemlqt_("L", "T", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1],
                 ldc, &work[1], info);
    }
    else if(left && notran)
    {
        ...
        ii = *m - kk + 1;
        ctr = 1;
        dgemlqt_("L", "N", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1],
                 ldc, &work[1], info);
        i__2 = ii - *nb + *k;
        i__1 = *nb - *k;
        for(i__ = *nb + 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            ...
            i__3 = *nb - *k;
            dtpmlqt_("L", "N", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                     &c__[i__ + c_dim1], ldc, &work[1], info);
            ++ctr;
        }
    ...
    else if(right && notran)
    {
        ...
        for(i__ = ii - (*nb - *k); i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            --ctr;
            i__3 = *nb - *k;
            dtpmlqt_("R", "N", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                     &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
        }
        /* Multiply Q to the first block of C (1:M,1:MB) */
        dgemlqt_("R", "N", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1],
                 ldc, &work[1], info);
    }
    else if(right && tran)
    {
        ...
        ctr = 1;
        ii = *n - kk + 1;
        dgemlqt_("R", "T", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1],
                 ldc, &work[1], info);
        i__2 = ii - *nb + *k;
        i__1 = *nb - *k;
        for(i__ = *nb + 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            /* Multiply Q to the current block of C (1:M,I:I+MB) */
            i__3 = *nb - *k;
            dtpmlqt_("R", "T", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                     &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
            ++ctr;
        }
