...
/* ===================================================================== */
/* Subroutine */
void spbsvx_(char *fact, char *uplo, integer *n, integer *kd, integer *nrhs, real *ab, integer *ldab, real *afb, integer *ldafb, char *equed, real *s, real *b, integer *ldb, real *x, integer *ldx, real *rcond, real *ferr, real *berr, real *work, integer *iwork, integer *info)
{
    ...
    extern /* Subroutine */
    void spbcon_(char *, integer *, integer *, real *, integer *, real *, real *, real *, integer *, integer *), slaqsb_(char *, integer *, integer *, real *, integer *, real *, real *, real *, char *);
    integer infequ;
    extern /* Subroutine */
    void slacpy_(char *, integer *, integer *, real *, integer *, real *, integer *), spbequ_(char *, integer *, integer *, real *, integer *, real *, real *, real *, integer *), spbrfs_(char *, integer *, integer *, integer *, real *, integer *, real *, integer *, real *, integer *, real *, integer *, real *, real *, real *, integer *, integer *), spbtrf_( char *, integer *, integer *, real *, integer *, integer *);
    real smlnum;
    extern /* Subroutine */
    void spbtrs_(char *, integer *, integer *, integer *, real *, integer *, real *, integer *, integer *);
    ...
    *info = 0;
    ...
    if(equil)
    {
        ...
        aocl_lapack_spbequ(uplo, n, kd, &ab[ab_offset], ldab, &s[1], &scond, &amax, &infequ);
        if(infequ == 0)
        {
            /* Equilibrate the matrix. */
            aocl_lapack_slaqsb(uplo, n, kd, &ab[ab_offset], ldab, &s[1], &scond, &amax, equed);
            rcequ = lsame_(equed, "Y", 1, 1);
        }
    }
    ...
    if(nofact || equil)
    {
        ...
        if(upper)
        {
            ...
            for(j = 1; j <= i__1; ++j)
            {
                ...
                j1 = fla_max(i__2,1);
                i__2 = j - j1 + 1;
                aocl_blas_scopy(&i__2, &ab[*kd + 1 - j + j1 + j * ab_dim1], &c__1,
        ...
        else
        {
            ...
            for(j = 1; j <= i__1; ++j)
            {
                ...
                j2 = fla_min(i__2,*n);
                i__2 = j2 - j + 1;
                aocl_blas_scopy(&i__2, &ab[j * ab_dim1 + 1], &c__1, &afb[j * afb_dim1 + 1], &c__1);
                /* L50: */
            }
        }
        aocl_lapack_spbtrf(uplo, n, kd, &afb[afb_offset], ldafb, info);
    ...
    anorm = aocl_lapack_slansb("1", uplo, n, kd, &ab[ab_offset], ldab, &work[1]);
    /* Compute the reciprocal of the condition number of A. */
    aocl_lapack_spbcon(uplo, n, kd, &afb[afb_offset], ldafb, &anorm, rcond, &work[1], &iwork[1],
                       info);
    /* Compute the solution matrix X. */
    aocl_lapack_slacpy("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    aocl_lapack_spbtrs(uplo, n, kd, nrhs, &afb[afb_offset], ldafb, &x[x_offset], ldx, info);
