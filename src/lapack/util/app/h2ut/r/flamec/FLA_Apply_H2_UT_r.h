...
FLA_Error FLA_Apply_H2_UT_r_ops_var1( fla_dim_t n_u2h_A2,
                                      fla_dim_t m_a1,
                                      float* tau,
                                      float* u2h, fla_dim_t inc_u2h,
                                      float* a1, fla_dim_t inc_a1,
                                      float* A2, fla_dim_t rs_A2, fla_dim_t cs_A2 );

FLA_Error FLA_Apply_H2_UT_r_opd_var1( fla_dim_t n_u2h_A2,
                                      fla_dim_t m_a1,
                                      double* tau,
                                      double* u2h, fla_dim_t inc_u2h,
                                      double* a1, fla_dim_t inc_a1,
                                      double* A2, fla_dim_t rs_A2, fla_dim_t cs_A2 );

FLA_Error FLA_Apply_H2_UT_r_opc_var1( fla_dim_t n_u2h_A2,
                                      fla_dim_t m_a1,
                                      scomplex* tau,
                                      scomplex* u2h, fla_dim_t inc_u2h,
                                      scomplex* a1, fla_dim_t inc_a1,
                                      scomplex* A2, fla_dim_t rs_A2, fla_dim_t cs_A2 );

FLA_Error FLA_Apply_H2_UT_r_opz_var1( fla_dim_t n_u2h_A2,
                                      fla_dim_t m_a1,
                                      dcomplex* tau,
                                      dcomplex* u2h, fla_dim_t inc_u2h,
