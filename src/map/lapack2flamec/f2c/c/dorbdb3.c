...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dorbdb3
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dorbdb3
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dorbdb3
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dorbdb3_(aocl_int_t *m, aocl_int_t *p, aocl_int_t *q, doublereal *x11, aocl_int_t *ldx11,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dorbdb3(m, p, q, x11, ldx11, x21, ldx21, theta, phi, taup1, taup2, tauq1, work,
                        lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t p_64 = *p;
    ...
    aocl_lapack_dorbdb3(&m_64, &p_64, &q_64, x11, &ldx11_64, x21, &ldx21_64, theta, phi, taup1,
...
void aocl_lapack_dorbdb3(aocl_int64_t *m, aocl_int64_t *p, aocl_int64_t *q, doublereal *x11,
                         ...
                         aocl_int64_t *info)
{
    ...
    AOCL_DTL_SNPRINTF("dorbdb3 inputs: m %" FLA_IS ", p %" FLA_IS ", q %" FLA_IS ", ldx11 %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DORBDB3", &i__1, (ftnlen)7);
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        ...
        {
            i__2 = *q - i__ + 1;
            aocl_blas_drot(&i__2, &x11[i__ - 1 + i__ * x11_dim1], ldx11, &x21[i__ + i__ * x21_dim1],
                           ldx11, &c__, &s);
        }
        i__2 = *q - i__ + 1;
        ...
        i__2 = *p - i__ + 1;
        /* Computing 2nd power */
        d__1 = aocl_blas_dnrm2(&i__2, &x11[i__ + i__ * x11_dim1], &c__1);
        i__3 = *m - *p - i__;
        /* Computing 2nd power */
        ...
        i__3 = *m - *p - i__;
        i__4 = *q - i__;
        aocl_lapack_dorbdb5(&i__2, &i__3, &i__4, &x11[i__ + i__ * x11_dim1], &c__1,
        ...
        {
            i__2 = *m - *p - i__;
            aocl_lapack_dlarfgp(&i__2, &x21[i__ + 1 + i__ * x21_dim1],
