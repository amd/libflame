/* ../netlib/dgttrs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dgttrs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dgttrs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dgttrs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                        ...
                        doublereal *b, aocl_int64_t *ldb, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    else
    {
        /* Computing MAX */
        i__1 = 1;
        i__2 = aocl_lapack_ilaenv(&c__1, "DGTTRS", trans, n, nrhs, &c_n1, &c_n1); // , expr subst
        nb = fla_max(i__1, i__2);
    }
    if(nb >= *nrhs)
    {
        aocl_lapack_dgtts2(&itrans, n, nrhs, &dl[1], &d__[1], &du[1], &du2[1], &ipiv[1],
                           &b[b_offset], ldb);
    }
    else
    {
        ...
        for(j = 1; i__2 < 0 ? j >= i__1 : j <= i__1; j += i__2)
        {
            ...
            i__3 = *nrhs - j + 1;
            jb = fla_min(i__3, nb);
            aocl_lapack_dgtts2(&itrans, n, &jb, &dl[1], &d__[1], &du[1], &du2[1], &ipiv[1],
                               &b[j * b_dim1 + 1], ldb);
            /* L10: */
        }
    }
