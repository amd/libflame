...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dpteqr(compz, n, d__, e, z__, ldz, work, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t ldz_64 = *ldz;
    aocl_int64_t info_64 = *info;

    aocl_lapack_dpteqr(compz, &n_64, d__, e, z__, &ldz_64, work, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dpteqr(char *compz, aocl_int64_t *n, doublereal *d__, doublereal *e,
                        doublereal *z__, aocl_int64_t *ldz, doublereal *work, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DPTEQR", &i__1, (ftnlen)6);
