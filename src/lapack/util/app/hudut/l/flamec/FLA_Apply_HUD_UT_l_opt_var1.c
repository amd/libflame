                                       ...
                                       FLA_Obj v1,  FLA_Obj D2 )
{
  ...
  fla_dim_t          inc_w12t;
  fla_dim_t          inc_r12t;
  fla_dim_t          rs_C2, cs_C2;
  fla_dim_t          rs_D2, cs_D2;
...
FLA_Error FLA_Apply_HUD_UT_l_ops_var1( fla_dim_t m_u1_C2,
                                       fla_dim_t m_v1_D2,
                                       fla_dim_t n_r12t,
                                       float* tau,
                                       float* w12t, fla_dim_t inc_w12t,
                                       float* r12t, fla_dim_t inc_r12t,
                                       float* u1, fla_dim_t inc_u1,
                                       float* C2, fla_dim_t rs_C2, fla_dim_t cs_C2,
                                       float* v1, fla_dim_t inc_v1,
                                       float* D2, fla_dim_t rs_D2, fla_dim_t cs_D2 )
{
...
FLA_Error FLA_Apply_HUD_UT_l_opd_var1( fla_dim_t m_u1_C2,
                                       fla_dim_t m_v1_D2,
                                       fla_dim_t n_r12t,
                                       double* tau,
                                       double* w12t, fla_dim_t inc_w12t,
                                       double* r12t, fla_dim_t inc_r12t,
                                       double* u1, fla_dim_t inc_u1,
                                       double* C2, fla_dim_t rs_C2, fla_dim_t cs_C2,
                                       double* v1, fla_dim_t inc_v1,
                                       double* D2, fla_dim_t rs_D2, fla_dim_t cs_D2 )
{
...
FLA_Error FLA_Apply_HUD_UT_l_opc_var1( fla_dim_t m_u1_C2,
                                       fla_dim_t m_v1_D2,
                                       fla_dim_t n_r12t,
                                       scomplex* tau,
                                       scomplex* w12t, fla_dim_t inc_w12t,
                                       scomplex* r12t, fla_dim_t inc_r12t,
                                       scomplex* u1, fla_dim_t inc_u1,
                                       scomplex* C2, fla_dim_t rs_C2, fla_dim_t cs_C2,
                                       scomplex* v1, fla_dim_t inc_v1,
                                       scomplex* D2, fla_dim_t rs_D2, fla_dim_t cs_D2 )
{
...
FLA_Error FLA_Apply_HUD_UT_l_opz_var1( fla_dim_t m_u1_C2,
                                       fla_dim_t m_v1_D2,
                                       fla_dim_t n_r12t,
                                       dcomplex* tau,
                                       dcomplex* w12t, fla_dim_t inc_w12t,
                                       dcomplex* r12t, fla_dim_t inc_r12t,
                                       dcomplex* u1, fla_dim_t inc_u1,
                                       dcomplex* C2, fla_dim_t rs_C2, fla_dim_t cs_C2,
                                       dcomplex* v1, fla_dim_t inc_v1,
                                       dcomplex* D2, fla_dim_t rs_D2, fla_dim_t cs_D2 )
{
