...
void ssyevr_2stage_(char *jobz, char *range, char *uplo, aocl_int_t *n, real *a, aocl_int_t *lda,
                    real *vl, real *vu, aocl_int_t *il, aocl_int_t *iu, real *abstol, aocl_int_t *m,
                    real *w, real *z__, aocl_int_t *ldz, aocl_int_t *isuppz, real *work,
                    aocl_int_t *lwork, aocl_int_t *iwork, aocl_int_t *liwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_ssyevr_2stage(jobz, range, uplo, n, a, lda, vl, vu, il, iu, abstol, m, w, z__, ldz,
    ...
    aocl_lapack_ssyevr_2stage(jobz, range, uplo, &n_64, a, &lda_64, vl, vu, &il_64, &iu_64, abstol,
...
void aocl_lapack_ssyevr_2stage(char *jobz, char *range, char *uplo, aocl_int64_t *n, real *a,
                               aocl_int64_t *lda, real *vl, real *vu, aocl_int64_t *il,
                               aocl_int64_t *iu, real *abstol, aocl_int64_t *m, real *w, real *z__,
                               aocl_int64_t *ldz, aocl_int_t *isuppz, real *work,
                               aocl_int64_t *lwork, aocl_int_t *iwork, aocl_int64_t *liwork,
                               aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("ssyevr_2stage inputs: jobz %c, range %c, uplo %c, n %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SSYEVR_2STAGE", &i__1, (ftnlen)13);
