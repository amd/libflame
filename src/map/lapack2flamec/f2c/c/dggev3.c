...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dggev3.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dggev3.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dggev3.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dggev3_(char *jobvl, char *jobvr, aocl_int_t *n, doublereal *a, aocl_int_t *lda, doublereal *b,
             aocl_int_t *ldb, doublereal *alphar, doublereal *alphai, doublereal *beta,
             doublereal *vl, aocl_int_t *ldvl, doublereal *vr, aocl_int_t *ldvr, doublereal *work,
             aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dggev3(jobvl, jobvr, n, a, lda, b, ldb, alphar, alphai, beta, vl, ldvl, vr, ldvr,
                       work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dggev3(jobvl, jobvr, &n_64, a, &lda_64, b, &ldb_64, alphar, alphai, beta, vl,
                       &ldvl_64, vr, &ldvr_64, work, &lwork_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dggev3(char *jobvl, char *jobvr, aocl_int64_t *n, doublereal *a, aocl_int64_t *lda,
                        doublereal *b, aocl_int64_t *ldb, doublereal *alphar, doublereal *alphai,
                        doublereal *beta, doublereal *vl, aocl_int64_t *ldvl, doublereal *vr,
                        aocl_int64_t *ldvr, doublereal *work, aocl_int64_t *lwork,
                        aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("dggev3 inputs: jobvl %c, jobvr %c, n %" FLA_IS ", lda %" FLA_IS
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        if(ilvl)
        {
            aocl_lapack_dorgqr(n, n, n, &vl[vl_offset], ldvl, &work[1], &work[1], &c_n1, &ierr);
            /* Computing MAX */
            i__1 = lwkopt;
            i__2 = *n * 3 + (integer)work[1]; // , expr subst
            lwkopt = fla_max(i__1, i__2);
        ...
        if(ilv)
        {
            aocl_lapack_dgghd3(jobvl, jobvr, n, &c__1, n, &a[a_offset], lda, &b[b_offset], ldb,
                               &vl[vl_offset], ldvl, &vr[vr_offset], ldvr, &work[1], &c_n1, &ierr);
            /* Computing MAX */
            i__1 = lwkopt;
            i__2 = *n * 3 + (integer)work[1]; // , expr subst
            lwkopt = fla_max(i__1, i__2);
            aocl_lapack_dhgeqz("S", jobvl, jobvr, n, &c__1, n, &a[a_offset], lda, &b[b_offset], ldb,
                               &alphar[1], &alphai[1], &beta[1], &vl[vl_offset], ldvl,
                               &vr[vr_offset], ldvr, &work[1], &c_n1, &ierr);
            /* Computing MAX */
            i__1 = lwkopt;
        ...
        {
            aocl_lapack_dgghd3("N", "N", n, &c__1, n, &a[a_offset], lda, &b[b_offset], ldb,
                               &vl[vl_offset], ldvl, &vr[vr_offset], ldvr, &work[1], &c_n1, &ierr);
            /* Computing MAX */
            i__1 = lwkopt;
            i__2 = *n * 3 + (integer)work[1]; // , expr subst
            lwkopt = fla_max(i__1, i__2);
            aocl_lapack_dhgeqz("E", jobvl, jobvr, n, &c__1, n, &a[a_offset], lda, &b[b_offset], ldb,
                               &alphar[1], &alphai[1], &beta[1], &vl[vl_offset], ldvl,
                               &vr[vr_offset], ldvr, &work[1], &c_n1, &ierr);
            /* Computing MAX */
            i__1 = lwkopt;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DGGEV3 ", &i__1, (ftnlen)6);
    ...
    if(ilvl)
    {
        aocl_lapack_dlaset("Full", n, n, &c_b40, &c_b41, &vl[vl_offset], ldvl);
        if(irows > 1)
        {
            i__1 = irows - 1;
            i__2 = irows - 1;
    ...
    if(ilvr)
    {
        aocl_lapack_dlaset("Full", n, n, &c_b40, &c_b41, &vr[vr_offset], ldvr);
    }
    ...
    if(ilv)
    {
        ...
        i__1 = *lwork + 1 - iwrk;
        aocl_lapack_dgghd3(jobvl, jobvr, n, &ilo, &ihi, &a[a_offset], lda, &b[b_offset], ldb,
                           &vl[vl_offset], ldvl, &vr[vr_offset], ldvr, &work[iwrk], &i__1, &ierr);
    }
    else
    {
        i__1 = *lwork + 1 - iwrk;
        aocl_lapack_dgghd3("N", "N", &irows, &c__1, &irows, &a[ilo + ilo * a_dim1], lda,
    ...
    if(ilv)
    {
        ...
        aocl_lapack_dtgevc(chtemp, "B", ldumma, n, &a[a_offset], lda, &b[b_offset], ldb,
                           &vl[vl_offset], ldvl, &vr[vr_offset], ldvr, n, &in, &work[iwrk], &ierr);
        if(ierr != 0)
        {
            *info = *n + 2;
            goto L110;
