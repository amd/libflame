/* ../netlib/zptsvx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zptsvx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zptsvx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zptsvx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void zptsvx_(char *fact, aocl_int_t *n, aocl_int_t *nrhs, doublereal *d__, dcomplex *e,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zptsvx(fact, n, nrhs, d__, e, df, ef, b, ldb, x, ldx, rcond, ferr, berr, work,
                       rwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zptsvx(fact, &n_64, &nrhs_64, d__, e, df, ef, b, &ldb_64, x, &ldx_64, rcond, ferr,
...
void aocl_lapack_zptsvx(char *fact, aocl_int64_t *n, aocl_int64_t *nrhs, doublereal *d__,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZPTSVX", &i__1, (ftnlen)6);
    ...
    if(nofact)
    {
        ...
        {
            i__1 = *n - 1;
            aocl_blas_zcopy(&i__1, &e[1], &c__1, &ef[1], &c__1);
        }
        aocl_lapack_zpttrf(n, &df[1], &ef[1], info);
    ...
    anorm = aocl_lapack_zlanht("1", n, &d__[1], &e[1]);
    /* Compute the reciprocal of the condition number of A. */
    aocl_lapack_zptcon(n, &df[1], &ef[1], &anorm, rcond, &rwork[1], info);
