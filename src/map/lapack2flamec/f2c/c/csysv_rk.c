...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/csysv_r
 * k.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/csysv_r
 * k.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/csysv_r
 * k.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > */
/* > \verbatim */
/* > CSYSV_RK computes the solution to a scomplex system of linear */
...
/* > */
/* > CSYTRF_RK is called to compute the factorization of a scomplex */
...
void csysv_rk_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, scomplex *a, aocl_int_t *lda, scomplex *e,
               aocl_int_t *ipiv, scomplex *b, aocl_int_t *ldb, scomplex *work, aocl_int_t *lwork,
               aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_csysv_rk(uplo, n, nrhs, a, lda, e, ipiv, b, ldb, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_csysv_rk(uplo, &n_64, &nrhs_64, a, &lda_64, e, ipiv, b, &ldb_64, work, &lwork_64,
                         &info_64);
...
void aocl_lapack_csysv_rk(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, scomplex *a,
                          ...
                          aocl_int64_t *ldb, scomplex *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        {
            aocl_lapack_csytrf_rk(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &c_n1,
                                  info);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CSYSV_RK", &i__1, (ftnlen)8);
    ...
    aocl_lapack_csytrf_rk(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], lwork, info);
    if(*info == 0)
    {
        /* Solve the system A*X = B with BLAS3 solver, overwriting B with X. */
        aocl_lapack_csytrs_3(uplo, n, nrhs, &a[a_offset], lda, &e[1], &ipiv[1], &b[b_offset], ldb,
                             info);
    }
    r__1 = aocl_lapack_sroundup_lwork(&lwkopt);
    work[1].real = r__1;
