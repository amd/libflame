...
void zpotrs_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, dcomplex *a, aocl_int_t *lda,
             dcomplex *b, aocl_int_t *ldb, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zpotrs(uplo, n, nrhs, a, lda, b, ldb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zpotrs(uplo, &n_64, &nrhs_64, a, &lda_64, b, &ldb_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zpotrs(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, dcomplex *a,
                        aocl_int64_t *lda, dcomplex *b, aocl_int64_t *ldb, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZPOTRS", &i__1, (ftnlen)6);
    ...
    if(upper)
    {
        ...
        aocl_blas_ztrsm("Left", "Upper", "Conjugate transpose", "Non-unit", n, nrhs, &c_b1,
    ...
    else
    {
        ...
        aocl_blas_ztrsm("Left", "Lower", "No transpose", "Non-unit", n, nrhs, &c_b1, &a[a_offset],
                        lda, &b[b_offset], ldb);
        /* Solve L**H *X = B, overwriting B with X. */
        aocl_blas_ztrsm("Left", "Lower", "Conjugate transpose", "Non-unit", n, nrhs, &c_b1,
                        &a[a_offset], lda, &b[b_offset], ldb);
    }
    AOCL_DTL_TRACE_LOG_EXIT
    return;
