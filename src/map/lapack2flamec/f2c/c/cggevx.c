...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggevx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggevx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggevx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > CGGEVX computes for a pair of N-by-N scomplex nonsymmetric matrices */
...
void cggevx_(char *balanc, char *jobvl, char *jobvr, char * sense, integer *n, complex *a, integer *lda, complex *b, integer *ldb, complex *alpha, complex *beta, complex *vl, integer *ldvl, complex * vr, integer *ldvr, integer *ilo, integer *ihi, real *lscale, real * rscale, real *abnrm, real *bbnrm, real *rconde, real *rcondv, complex *work, integer *lwork, real *rwork, integer *iwork, logical *bwork, integer *info)
{
    ...
    integer irows;
    extern /* Subroutine */
    void cggbak_(char *, char *, integer *, integer *, integer *, real *, real *, integer *, complex *, integer *, integer *), cggbal_(char *, integer *, complex *, integer *, complex *, integer *, integer *, integer *, real *, real *, real *, integer *), slabad_(real *, real *);
    ...
    extern /* Subroutine */
    void cgeqrf_(integer *, integer *, complex *, integer *, complex *, complex *, integer *, integer *), clacpy_( char *, integer *, integer *, complex *, integer *, complex *, integer *), claset_(char *, integer *, integer *, complex *, complex *, complex *, integer *), ctgevc_(char *, char *, logical *, integer *, complex *, integer *, complex *, integer *, complex *, integer *, complex *, integer *, integer *, integer *, complex *, real *, integer *);
    logical ldumma[1];
    char chtemp[1];
    real bignum;
    extern /* Subroutine */
    void chgeqz_(char *, char *, char *, integer *, integer *, integer *, complex *, integer *, complex *, integer *, complex *, complex *, complex *, integer *, complex *, integer *, complex *, integer *, real *, integer *), ctgsna_(char *, char *, logical *, integer *, complex *, integer *, complex *, integer *, complex *, integer *, complex *, integer *, real *, real *, integer *, integer *, complex *, integer *, integer *, integer *);
    integer ijobvl;
    extern /* Subroutine */
    ...
    *info = 0;
    ...
    aocl_lapack_cggbal(balanc, n, &a[a_offset], lda, &b[b_offset], ldb, ilo, ihi, &lscale[1],
                       &rscale[1], &rwork[1], &ierr);
    /* Compute ABNRM and BBNRM */
    *abnrm = aocl_lapack_clange("1", n, n, &a[a_offset], lda, &rwork[1]);
    if(ilascl)
    {
        rwork[1] = *abnrm;
        aocl_lapack_slascl("G", &c__0, &c__0, &anrmto, &anrm, &c__1, &c__1, &rwork[1], &c__1,
                           &ierr);
        *abnrm = rwork[1];
    }
    *bbnrm = aocl_lapack_clange("1", n, n, &b[b_offset], ldb, &rwork[1]);
    if(ilbscl)
    {
        rwork[1] = *bbnrm;
        aocl_lapack_slascl("G", &c__0, &c__0, &bnrmto, &bnrm, &c__1, &c__1, &rwork[1], &c__1,
                           &ierr);
        *bbnrm = rwork[1];
    }
    ...
    iwrk = itau + irows;
    i__1 = *lwork + 1 - iwrk;
    aocl_lapack_cgeqrf(&irows, &icols, &b[*ilo + *ilo * b_dim1], ldb, &work[itau], &work[iwrk],
                       &i__1, &ierr);
    ...
    if(ilv || !wantsn)
    {
        ...
        if(!wantsn)
        {
            ...
            for(i__ = 1; i__ <= i__1; ++i__)
            {
                ...
                if(wantse || wantsb)
                {
                    aocl_lapack_ctgevc("B", "S", &bwork[1], n, &a[a_offset], lda, &b[b_offset], ldb,
                ...
                i__2 = *lwork - iwrk1 + 1;
                aocl_lapack_ctgsna(sense, "S", &bwork[1], n, &a[a_offset], lda, &b[b_offset], ldb,
    ...
    if(ilvl)
    {
        aocl_lapack_cggbak(balanc, "L", n, ilo, ihi, &lscale[1], &rscale[1], n, &vl[vl_offset],
                           ldvl, &ierr);
        i__1 = *n;
        for(jc = 1; jc <= i__1; ++jc)
        {
    ...
    if(ilvr)
    {
        aocl_lapack_cggbak(balanc, "R", n, ilo, ihi, &lscale[1], &rscale[1], n, &vr[vr_offset],
                           ldvr, &ierr);
        i__1 = *n;
        for(jc = 1; jc <= i__1; ++jc)
        {
