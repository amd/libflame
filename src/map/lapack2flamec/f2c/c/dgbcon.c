...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dgbcon(norm, n, kl, ku, ab, ldab, ipiv, anorm, rcond, work, iwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dgbcon(norm, &n_64, &kl_64, &ku_64, ab, &ldab_64, ipiv, anorm, rcond, work, iwork,
                       &info_64);
...
void aocl_lapack_dgbcon(char *norm, aocl_int64_t *n, aocl_int64_t *kl, aocl_int64_t *ku,
                        doublereal *ab, aocl_int64_t *ldab, aocl_int_t *ipiv, doublereal *anorm,
                        doublereal *rcond, doublereal *work, aocl_int_t *iwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DGBCON", &i__1, (ftnlen)6);
