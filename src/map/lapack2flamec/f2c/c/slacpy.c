...
void slacpy_(char *uplo, aocl_int_t *m, aocl_int_t *n, real *a, aocl_int_t *lda, real *b,
             aocl_int_t *ldb)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_slacpy(uplo, m, n, a, lda, b, ldb);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_slacpy(uplo, &m_64, &n_64, a, &lda_64, b, &ldb_64);
#endif
}

void aocl_lapack_slacpy(char *uplo, aocl_int64_t *m, aocl_int64_t *n, real *a, aocl_int64_t *lda,
                        real *b, aocl_int64_t *ldb)
{
