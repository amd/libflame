/* ../netlib/csytf2_rook.f -- translated by f2c (version 20100827). You must link the resulting
...
/* > \verbatim */
/* > */
/* > CSYTF2_ROOK computes the factorization of a scomplex symmetric matrix A */
