/* ../netlib/v3.9.0/zheev_2stage.f -- translated by f2c (version 20160102). You must link the
...
/* ===================================================================== */
/* Subroutine */
void zheev_2stage_(char *jobz, char *uplo, integer *n, doublecomplex *a, integer *lda,
