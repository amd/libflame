/* ../netlib/dlaqge.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqge.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqge.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqge.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dlaqge_(aocl_int_t *m, aocl_int_t *n, doublereal *a, aocl_int_t *lda, doublereal *r__,
             doublereal *c__, doublereal *rowcnd, doublereal *colcnd, doublereal *amax, char *equed)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dlaqge(m, n, a, lda, r__, c__, rowcnd, colcnd, amax, equed);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;

    aocl_lapack_dlaqge(&m_64, &n_64, a, &lda_64, r__, c__, rowcnd, colcnd, amax, equed);
#endif
}

void aocl_lapack_dlaqge(aocl_int64_t *m, aocl_int64_t *n, doublereal *a, aocl_int64_t *lda,
