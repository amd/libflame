...
/* > \brief \b CHETRF_ROOK computes the factorization of a complex Hermitian indefinite matrix using
...
/* ===================================================================== */
/* Subroutine */
void chetrf_rook_(char *uplo, integer *n, complex *a, integer *lda, integer *ipiv, complex *work,
                  integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        chetf2_rook_(char *, integer *, complex *, integer *, integer *, integer *);
    integer iws;
    extern /* Subroutine */
        void
        clahef_rook_(char *, integer *, integer *, integer *, complex *, integer *, integer *,
    ...
    *info = 0;
    ...
    L10: /* If K < 1, exit from loop */
        ...
        if(k > nb)
        {
            ...
            clahef_rook_(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &work[1], &ldwork,
                         &iinfo);
        }
        else
        {
    ...
    L20: /* If K > N, exit from loop */
        ...
        if(k <= *n - nb)
        {
            ...
            i__1 = *n - k + 1;
            clahef_rook_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &ipiv[k], &work[1],
                         &ldwork, &iinfo);
        }
        else
        {
