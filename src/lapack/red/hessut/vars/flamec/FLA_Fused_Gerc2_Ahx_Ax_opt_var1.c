...
*/
  ...
  fla_dim_t          m_A, n_A;
  fla_dim_t          rs_A, cs_A;
  fla_dim_t          inc_u, inc_y, inc_z, inc_x, inc_v, inc_w;
                                           ...
                                           double* buff_w, fla_dim_t inc_w )
{
  ...
  fla_dim_t       n_run         = n_A / 1;
  //fla_dim_t       n_left        = n_A % 1;
  fla_dim_t       step_a1       = 1*cs_A;
  fla_dim_t       step_nu1      = 1*inc_v;
  fla_dim_t       step_chi1     = 1*inc_x;
  fla_dim_t       step_psi1     = 1*inc_y;
  fla_dim_t       step_upsilon1 = 1*inc_u;
  fla_dim_t       i;
