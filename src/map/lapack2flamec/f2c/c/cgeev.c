...
void cgeev_(char *jobvl, char *jobvr, aocl_int_t *n, scomplex *a, aocl_int_t *lda, scomplex *w,
            scomplex *vl, aocl_int_t *ldvl, scomplex *vr, aocl_int_t *ldvr, scomplex *work,
            aocl_int_t *lwork, real *rwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cgeev(jobvl, jobvr, n, a, lda, w, vl, ldvl, vr, ldvr, work, lwork, rwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_cgeev(jobvl, jobvr, &n_64, a, &lda_64, w, vl, &ldvl_64, vr, &ldvr_64, work,
...
void aocl_lapack_cgeev(char *jobvl, char *jobvr, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda,
                       scomplex *w, scomplex *vl, aocl_int64_t *ldvl, scomplex *vr, aocl_int64_t *ldvr,
                       scomplex *work, aocl_int64_t *lwork, real *rwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CGEEV ", &i__1, (ftnlen)6);
    ...
    /* (RWorkspace: need N) */
    ibal = 1;
    aocl_lapack_cgebal("B", n, &a[a_offset], lda, &ilo, &ihi, &rwork[ibal], &ierr);
    ...
    else
    {
        ...
        iwrk = itau;
        i__1 = *lwork - iwrk + 1;
        aocl_lapack_chseqr("E", "N", n, &ilo, &ihi, &a[a_offset], lda, &w[1], &vr[vr_offset], ldvr,
                           &work[iwrk], &i__1, info);
    }
    ...
    if(wantvl)
    {
        ...
        /* (CWorkspace: none) */
        /* (RWorkspace: need N) */
        aocl_lapack_cgebak("B", "L", n, &ilo, &ihi, &rwork[ibal], n, &vl[vl_offset], ldvl, &ierr);
    ...
    if(wantvr)
    {
        ...
        /* (CWorkspace: none) */
        /* (RWorkspace: need N) */
        aocl_lapack_cgebak("B", "R", n, &ilo, &ihi, &rwork[ibal], n, &vr[vr_offset], ldvr, &ierr);
