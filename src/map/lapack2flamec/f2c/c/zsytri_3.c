...
/* > */
/* > \verbatim */
/* > ZSYTRI_3 computes the inverse of a scomplex symmetric indefinite */
...
void zsytri_3_(char *uplo, aocl_int_t *n, dcomplex *a, aocl_int_t *lda, dcomplex *e,
               aocl_int_t *ipiv, dcomplex *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zsytri_3(uplo, n, a, lda, e, ipiv, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zsytri_3(uplo, &n_64, a, &lda_64, e, ipiv, work, &lwork_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zsytri_3(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
                          ...
                          aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    /* Computing MAX */
    i__1 = 1;
    i__2 = aocl_lapack_ilaenv(&c__1, "ZSYTRI_3", uplo, n, &c_n1, &c_n1, &c_n1); // , expr subst
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZSYTRI_3", &i__1, (ftnlen)8);
    ...
    aocl_lapack_zsytri_3x(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &nb, info);
    work[1].r = (doublereal)lwkopt;
    work[1].i = 0.; // , expr subst
    AOCL_DTL_TRACE_LOG_EXIT
    return;
