...
/* ../netlib/clahef.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > \brief \b CLAHEF computes a partial factorization of a scomplex Hermitian indefinite matrix
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/clahef.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/clahef.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/clahef.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > CLAHEF computes a partial factorization of a scomplex Hermitian */
        ...
        else
        {
            ...
            else
            {
                ...
                if(k > 2)
                {
                    ...
                    q__1.real = d11.real * d22.real - d11.imag * d22.imag;
                    q__1.imag = d11.real * d22.imag + d11.imag * d22.real; // , expr subst
                    t = 1.f / (q__1.real - 1.f);
                    q__2.real = t;
