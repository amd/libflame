...
/* ../netlib/dormtr.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dormtr.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dormtr.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dormtr.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                ...
                aocl_int64_t *ldc, doublereal *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    aocl_int64_t iinfo;
    logical upper;
    extern int lapack_dormqr(char *, char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, doublereal *,
    ...
    *info = 0;
    ...
    else
    {
        ...
        i__2 = nq - 1;
        lapack_dormqr(side, trans, &mi, &ni, &i__2, &a[a_dim1 + 2], lda, &tau[1],
