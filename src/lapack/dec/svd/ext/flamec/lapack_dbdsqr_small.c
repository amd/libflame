    ...
    *info = 0;
    ...
    if(lower)
    {
        ...
        for(i__ = 1; i__ <= i__1; ++i__)
        {
            ...
            if(*nru > 0)
            {
                FLA_APPLY_GIVENS_RVX(nru, u, ldu, i__, cs, sn);
            }
        }
    }
    ...
    if(shift == 0.)
    {
        if(idir == 1)
        {
            ...
            for(i__ = ll; i__ <= i__1; ++i__)
            {
                ...
                if(*ncvt > 0)
                {
                    FLA_APPLY_GIVENS_LVX(ncvt, vt, ldvt, i__, cs, sn);
                }
                if(*nru > 0)
                {
                    FLA_APPLY_GIVENS_RVX(nru, u, ldu, i__, oldcs, oldsn);
                }
            }
            h__ = d__[m] * cs;
            d__[m] = h__ * oldcs;
        ...
        else
        {
            ...
            for(i__ = m; i__ >= i__1; --i__)
            {
                ...
                {
                    tidx = i__ - 1;
                    FLA_APPLY_GIVENS_LVX(ncvt, vt, ldvt, tidx, oldcs, (-oldsn));
                }
                if(*nru > 0)
                {
                    tidx = i__ - 1;
                    FLA_APPLY_GIVENS_RVX(nru, u, ldu, tidx, cs, (-sn));
                }
            }
            h__ = d__[ll] * cs;
            d__[ll] = h__ * oldcs;
    ...
    else
    {
        ...
        if(idir == 1)
        {
            ...
            for(i__ = ll; i__ <= i__1; ++i__)
            {
                ...
                if(*ncvt > 0)
                {
                    FLA_APPLY_GIVENS_LVX(ncvt, vt, ldvt, i__, cosr, sinr);
                }
                if(*nru > 0)
                {
                    FLA_APPLY_GIVENS_RVX(nru, u, ldu, i__, cosl, sinl);
                }
            }
            e[m - 1] = f;
            /* Test convergence */
        ...
        else
        {
            ...
            for(i__ = m; i__ >= i__1; --i__)
            {
                ...
                {
                    tidx = i__ - 1;
                    FLA_APPLY_GIVENS_LVX(ncvt, vt, ldvt, tidx, cosl, (-sinl));
                }
                if(*nru > 0)
                {
                    tidx = i__ - 1;
                    FLA_APPLY_GIVENS_RVX(nru, u, ldu, tidx, cosr, (-sinr));
                }
            }
            e[ll] = f;
            /* Test convergence */
