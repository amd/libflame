...
/* > \brief \b ZHETF2_RK computes the factorization of a scomplex Hermitian indefinite matrix using
...
/* > */
/* > \verbatim */
/* > ZHETF2_RK computes the factorization of a scomplex Hermitian matrix A */
...
void zhetf2_rk_(char *uplo, aocl_int_t *n, dcomplex *a, aocl_int_t *lda, dcomplex *e,
                aocl_int_t *ipiv, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhetf2_rk(uplo, n, a, lda, e, ipiv, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;
    aocl_int64_t info_64 = *info;

    aocl_lapack_zhetf2_rk(uplo, &n_64, a, &lda_64, e, ipiv, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_zhetf2_rk(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
                           dcomplex *e, aocl_int_t *ipiv, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHETF2_RK", &i__1, (ftnlen)9);
