/* ../netlib/v3.9.0/chetrf_rk.f -- translated by f2c (version 20160102). You must link the resulting
...
/* > \brief \b CHETRF_RK computes the factorization of a complex Hermitian indefinite matrix using
...
/* ===================================================================== */
/* Subroutine */
void chetrf_rk_(char *uplo, integer *n, complex *a, integer *lda, complex *e, integer *ipiv,
                complex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        chetf2_rk_(char *, integer *, complex *, integer *, complex *, integer *, integer *);
    integer i__, k;
    extern /* Subroutine */
        void
        clahef_rk_(char *, integer *, integer *, integer *, complex *, integer *, complex *,
    ...
    *info = 0;
    ...
    L10: /* If K < 1, exit from loop */
        ...
        if(k > nb)
        {
            ...
            clahef_rk_(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &ldwork,
                       &iinfo);
        }
        else
        {
    ...
    L20: /* If K > N, exit from loop */
        ...
        if(k <= *n - nb)
        {
            ...
            i__1 = *n - k + 1;
            clahef_rk_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k], &ipiv[k], &work[1],
                       &ldwork, &iinfo);
        }
        else
        {
