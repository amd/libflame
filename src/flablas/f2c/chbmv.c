...
#include "FLA_f2c.h"
/* Subroutine */
int chbmv_(char *uplo, integer *n, integer *k, scomplex * alpha, scomplex *a, integer *lda, scomplex *x, integer *incx, scomplex * beta, scomplex *y, integer *incy)
{
    ...
    else
    {
        ...
        if (*incx == 1 && *incy == 1)
        {
            ...
            {
                i__3 = j;
                q__1.real = alpha->real * x[i__3].real - alpha->imag * x[i__3].imag, q__1.imag = alpha->real * x[i__3].imag + alpha->imag * x[i__3].real;
                temp1.real = q__1.real, temp1.imag = q__1.imag;
                temp2.real = 0.f, temp2.imag = 0.f;
                i__3 = j;
                i__4 = j;
