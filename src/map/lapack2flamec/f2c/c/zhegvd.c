/* ../netlib/zhegvd.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zhegvd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zhegvd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zhegvd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhegvd(itype, jobz, uplo, n, a, lda, b, ldb, w, work, lwork, rwork, lrwork, iwork,
                       liwork, info);
#else
    ...
    aocl_lapack_zhegvd(&itype_64, jobz, uplo, &n_64, a, &lda_64, b, &ldb_64, w, work, &lwork_64,
...
void aocl_lapack_zhegvd(aocl_int64_t *itype, char *jobz, char *uplo, aocl_int64_t *n,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHEGVD", &i__1, (ftnlen)6);
    ...
    if(wantz && *info == 0)
    {
        ...
        if(*itype == 1 || *itype == 2)
        {
            ...
            aocl_blas_ztrsm("Left", uplo, trans, "Non-unit", n, n, &c_b1, &b[b_offset], ldb,
                            &a[a_offset], lda);
        }
        else if(*itype == 3)
        {
            ...
            aocl_blas_ztrmm("Left", uplo, trans, "Non-unit", n, n, &c_b1, &b[b_offset], ldb,
                            &a[a_offset], lda);
        }
    }
    work[1].real = aocl_lapack_droundup_lwork(&lopt);
