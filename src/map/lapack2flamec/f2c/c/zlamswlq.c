/* zlamswlq.f -- translated by f2c (version 20190311). You must link the resulting object file with
...
/* > \verbatim */
/* > */
/* > ZLAMSWLQ overwrites the general scomplex M-by-N matrix C with */
/* > */
/* > */
/* > SIDE = 'L' SIDE = 'R' */
/* > TRANS = 'N': Q * C C * Q */
...
void zlamswlq_(char *side, char *trans, aocl_int_t *m, aocl_int_t *n, aocl_int_t *k, aocl_int_t *mb,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zlamswlq(side, trans, m, n, k, mb, nb, a, lda, t, ldt, c__, ldc, work, lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t k_64 = *k;
    ...
    aocl_lapack_zlamswlq(side, trans, &m_64, &n_64, &k_64, &mb_64, &nb_64, a, &lda_64, t, &ldt_64,
...
void aocl_lapack_zlamswlq(char *side, char *trans, aocl_int64_t *m, aocl_int64_t *n,
                          ...
                          aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    AOCL_DTL_SNPRINTF("zlamswlq inputs: side %c, trans %c, m %" FLA_IS ", n %" FLA_IS ", k %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZLAMSWLQ", &i__1, (ftnlen)8);
    ...
    {
        aocl_lapack_zgemlqt(side, trans, m, n, k, mb, &a[a_offset], lda, &t[t_offset], ldt,
    ...
    if(left && tran)
    {
        ...
        {
            ii = *m - kk + 1;
            aocl_lapack_ztpmlqt("L", "C", &kk, n, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
        ...
        for(i__ = ii - (*nb - *k); i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            --ctr;
            i__3 = *nb - *k;
            aocl_lapack_ztpmlqt("L", "C", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                                &c__[i__ + c_dim1], ldc, &work[1], info);
        }
        /* Multiply Q to the first block of C (1:M,1:NB) */
        aocl_lapack_zgemlqt("L", "C", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt,
    ...
    else if(left && notran)
    {
        ...
        ii = *m - kk + 1;
        ctr = 1;
        aocl_lapack_zgemlqt("L", "N", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt,
                            &c__[c_dim1 + 1], ldc, &work[1], info);
        i__2 = ii - *nb + *k;
        i__1 = *nb - *k;
        for(i__ = *nb + 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            ...
            i__3 = *nb - *k;
            aocl_lapack_ztpmlqt("L", "N", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                                &c__[i__ + c_dim1], ldc, &work[1], info);
            ++ctr;
        }
        ...
        {
            /* Multiply Q to the last block of C */
            aocl_lapack_ztpmlqt("L", "N", &kk, n, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                                &c__[ii + c_dim1], ldc, &work[1], info);
        }
    }
    else if(right && notran)
    {
        ...
        {
            ii = *n - kk + 1;
            aocl_lapack_ztpmlqt("R", "N", m, &kk, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
        ...
        for(i__ = ii - (*nb - *k); i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            --ctr;
            i__3 = *nb - *k;
            aocl_lapack_ztpmlqt("R", "N", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                                &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
        }
        /* Multiply Q to the first block of C (1:M,1:MB) */
        aocl_lapack_zgemlqt("R", "N", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt,
                            &c__[c_dim1 + 1], ldc, &work[1], info);
    }
    else if(right && tran)
    {
        ...
        kk = (*n - *k) % (*nb - *k);
        ii = *n - kk + 1;
        aocl_lapack_zgemlqt("R", "C", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt,
                            &c__[c_dim1 + 1], ldc, &work[1], info);
        ctr = 1;
        i__2 = ii - *nb + *k;
        i__1 = *nb - *k;
        for(i__ = *nb + 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            /* Multiply Q to the current block of C (1:M,I:I+MB) */
            i__3 = *nb - *k;
            aocl_lapack_ztpmlqt("R", "C", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                                &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
            ++ctr;
        }
        ...
        {
            /* Multiply Q to the last block of C */
            aocl_lapack_ztpmlqt("R", "C", m, &kk, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
                                &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc,
                                &c__[ii * c_dim1 + 1], ldc, &work[1], info);
        }
    }
