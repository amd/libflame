...
void spbsvx_(char *fact, char *uplo, aocl_int_t *n, aocl_int_t *kd, aocl_int_t *nrhs, real *ab,
             aocl_int_t *ldab, real *afb, aocl_int_t *ldafb, char *equed, real *s, real *b,
             aocl_int_t *ldb, real *x, aocl_int_t *ldx, real *rcond, real *ferr, real *berr,
             real *work, aocl_int_t *iwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_spbsvx(fact, uplo, n, kd, nrhs, ab, ldab, afb, ldafb, equed, s, b, ldb, x, ldx,
    ...
    aocl_lapack_spbsvx(fact, uplo, &n_64, &kd_64, &nrhs_64, ab, &ldab_64, afb, &ldafb_64, equed, s,
...
void aocl_lapack_spbsvx(char *fact, char *uplo, aocl_int64_t *n, aocl_int64_t *kd,
                        aocl_int64_t *nrhs, real *ab, aocl_int64_t *ldab, real *afb,
                        aocl_int64_t *ldafb, char *equed, real *s, real *b, aocl_int64_t *ldb,
                        real *x, aocl_int64_t *ldx, real *rcond, real *ferr, real *berr, real *work,
                        aocl_int_t *iwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SPBSVX", &i__1, (ftnlen)6);
    ...
    aocl_lapack_spbrfs(uplo, n, kd, nrhs, &ab[ab_offset], ldab, &afb[afb_offset], ldafb,
