...
/* > \brief \b CLATPS solves a triangular system of equations with the matrix held in packed
 * storage. */
/* =========== DOCUMENTATION =========== */
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/clatps.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/clatps.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/clatps.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void clatps_(char *uplo, char *trans, char *diag, char *normin, integer *n, complex *ap, complex *x,
    ...
    *scale = 1.f;
    if(lsame_(normin, "N", 1, 1))
    {
        ...
        if(upper)
        {
            ...
            {
                i__2 = j - 1;
                cnorm[j] = aocl_blas_scasum(&i__2, &ap[ip], &c__1);
                ip += j;
                /* L10: */
            }
        }
        else
        {
            ...
            {
                i__2 = *n - j;
                cnorm[j] = aocl_blas_scasum(&i__2, &ap[ip + 1], &c__1);
                ip = ip + *n - j + 1;
                /* L20: */
            }
            cnorm[*n] = 0.f;
    ...
    if(grow * tscal > smlnum)
    {
        ...
        aocl_blas_ctpsv(uplo, trans, diag, n, &ap[1], &x[1], &c__1);
    }
    else
    {
