...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsytrf.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsytrf.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsytrf.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
    ...
    *info = 0;
    ...
    L10: /* If K < 1, exit from loop */
        ...
        if(k > nb)
        {
            ...
            aocl_lapack_dlasyf(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &work[1], &ldwork,
                               &iinfo);
        }
        else
        {
            /* Use unblocked code to factorize columns 1:k of A */
            aocl_lapack_dsytf2(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
            kb = k;
        }
    ...
    L20: /* If K > N, exit from loop */
        ...
        else
        {
            ...
            i__1 = *n - k + 1;
            aocl_lapack_dsytf2(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &iinfo);
            kb = *n - k + 1;
        }
        /* Set INFO on the first occurrence of a zero pivot */
        if(*info == 0 && iinfo > 0)
