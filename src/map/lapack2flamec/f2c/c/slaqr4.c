...
/* > \brief \b SLAQR4 computes the eigenvalues of a Hessenberg matrix, and optionally the matrices
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slaqr4.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slaqr4.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slaqr4.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void slaqr4_(logical *wantt, logical *wantz, integer *n, integer *ilo, integer *ihi, real *h__, integer *ldh, real *wr, real * wi, integer *iloz, integer *ihiz, real *z__, integer *ldz, real *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
    void slaqr2_(logical *, logical *, integer *, integer *, integer *, integer *, real *, integer *, integer *, integer *, real *, integer *, integer *, integer *, real *, real *, real *, integer *, integer *, real *, integer *, integer *, real *, integer *, real *, integer *), slanv2_(real *, real *, real *, real *, real *, real *, real *, real *, real *, real *), slaqr5_(logical *, logical *, integer *, integer *, integer *, integer *, integer *, real *, real *, real *, integer *, integer *, integer *, real *, integer *, real *, integer *, real *, integer *, integer *, real *, integer *, integer *, real *, integer *);
    integer nibble;
    ...
    *info = 0;
    ...
    else
    {
        ...
        *info = 0;
        ...
        i__1 = nwr + 1;
        aocl_lapack_slaqr2(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, ihiz,
    ...
    AOCL_DTL_TRACE_LOG_EXIT
        ...
        L20:
            ...
            nve = *n - nw - kwv + 1;
            /* ==== Aggressive early deflation ==== */
            aocl_lapack_slaqr2(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, iloz, ihiz,
                ...
                else
                {
                    ...
                    if(kbot - ks + 1 <= ns / 2)
                    {
                        ...
                        aocl_lapack_slacpy("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh,
                                           &h__[kt + h_dim1], ldh);
                        aocl_lapack_slahqr(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt + h_dim1],
