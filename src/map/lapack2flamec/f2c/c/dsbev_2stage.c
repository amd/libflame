...
/* ===================================================================== */
/* Subroutine */
void dsbev_2stage_(char *jobz, char *uplo, integer *n, integer *kd, doublereal *ab, integer *ldab,
                   ...
                   integer *info)
{
    ...
    *info = 0;
    ...
    dsytrd_sb2st_("N", jobz, uplo, n, kd, &ab[ab_offset], ldab, &w[1], &work[inde], &work[indhous],
