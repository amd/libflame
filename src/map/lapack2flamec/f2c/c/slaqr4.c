...
/* ===================================================================== */
/* Subroutine */
void slaqr4_(logical *wantt, logical *wantz, integer *n, integer *ilo, integer *ihi, real *h__,
             ...
             integer *ldz, real *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        slaqr2_(logical *, logical *, integer *, integer *, integer *, integer *, real *, integer *,
