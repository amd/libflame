...
/* ===================================================================== */
/* Subroutine */
void chegv_2stage_(integer *itype, char *jobz, char *uplo, integer *n, complex *a, integer *lda,
                   ...
                   integer *info)
{
    ...
    extern /* Subroutine */
        void
        cheev_2stage_(char *, char *, integer *, complex *, integer *, real *, complex *, integer *,
                      real *, integer *);
    integer neig;
