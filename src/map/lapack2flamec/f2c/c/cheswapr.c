/* ../netlib/cheswapr.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cheswap
 * r.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cheswap
 * r.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cheswap
 * r.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void cheswapr_(char *uplo, integer *n, complex *a, integer *lda, integer *i1, integer *i2)
{
    ...
    char buffer[256];
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256, "cheswapr inputs: uplo %c, n %lld, lda %lld, i1 %lld, i2 %lld", *uplo, *n,
             *lda, *i1, *i2);
#else
    snprintf(buffer, 256, "cheswapr inputs: uplo %c, n %d, lda %d, i1 %d, i2 %d", *uplo, *n, *lda,
             *i1, *i2);
#endif
