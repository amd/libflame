...
/* ===================================================================== */
/* Subroutine */
void cgemqrt_(char *side, char *trans, integer *m, integer *n, integer *k, integer *nb, complex *v,
    ...
    *info = 0;
    ...
    if(left && tran)
    {
        ...
        for(i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            i__3 = *m - i__ + 1;
            clarfb_("L", "C", "F", "C", &i__3, n, &ib, &v[i__ + i__ * v_dim1], ldv,
    ...
    else if(right && notran)
    {
        ...
        for(i__ = 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1)
        {
            ...
            ib = fla_min(i__3, i__4);
            i__3 = *n - i__ + 1;
            clarfb_("R", "N", "F", "C", m, &i__3, &ib, &v[i__ + i__ * v_dim1], ldv,
    ...
    else if(left && notran)
    {
        ...
        for(i__ = kf; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            i__2 = *m - i__ + 1;
            clarfb_("L", "N", "F", "C", &i__2, n, &ib, &v[i__ + i__ * v_dim1], ldv,
                    &t[i__ * t_dim1 + 1], ldt, &c__[i__ + c_dim1], ldc, &work[1], &ldwork);
        }
    }
    else if(right && tran)
    {
        ...
        for(i__ = kf; i__1 < 0 ? i__ >= 1 : i__ <= 1; i__ += i__1)
        {
            ...
            ib = fla_min(i__2, i__3);
            i__2 = *n - i__ + 1;
            clarfb_("R", "C", "F", "C", m, &i__2, &ib, &v[i__ + i__ * v_dim1], ldv,
                    &t[i__ * t_dim1 + 1], ldt, &c__[i__ * c_dim1 + 1], ldc, &work[1], &ldwork);
        }
    }
    AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
