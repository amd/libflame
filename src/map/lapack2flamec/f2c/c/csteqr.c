/* ../netlib/csteqr.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/csteqr.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/csteqr.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/csteqr.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void csteqr_(char *compz, aocl_int_t *n, real *d__, real *e, scomplex *z__, aocl_int_t *ldz,
             real *work, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_csteqr(compz, n, d__, e, z__, ldz, work, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t ldz_64 = *ldz;
    aocl_int64_t info_64 = *info;

    aocl_lapack_csteqr(compz, &n_64, d__, e, z__, &ldz_64, work, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_csteqr(char *compz, aocl_int64_t *n, real *d__, real *e, scomplex *z__,
                        aocl_int64_t *ldz, real *work, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CSTEQR", &i__1, (ftnlen)6);
...
L30:
    ...
    i__1 = lend - l + 1;
    anorm = aocl_lapack_slanst("I", &i__1, &d__[l], &e[l]);
    iscale = 0;
    if(anorm == 0.f)
    {
        goto L10;
    ...
    L60:
        ...
        {
            mm = m - l + 1;
            aocl_lapack_clasr("R", "V", "B", n, &mm, &work[l], &work[*n - 1 + l],
                              &z__[l * z_dim1 + 1], ldz);
        }
        d__[l] -= p;
        e[l] = g;
    ...
    L110:
        ...
        {
            mm = l - m + 1;
            aocl_lapack_clasr("R", "V", "F", n, &mm, &work[m], &work[*n - 1 + m],
                              &z__[m * z_dim1 + 1], ldz);
        }
        d__[l] -= p;
        e[lm1] = g;
