/* ../netlib/ctbtrs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ctbtrs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ctbtrs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ctbtrs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_ctbtrs(uplo, trans, diag, n, kd, nrhs, ab, ldab, b, ldb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_ctbtrs(uplo, trans, diag, &n_64, &kd_64, &nrhs_64, ab, &ldab_64, b, &ldb_64,
                       &info_64);
...
void aocl_lapack_ctbtrs(char *uplo, char *trans, char *diag, aocl_int64_t *n, aocl_int64_t *kd,
                        ...
                        aocl_int64_t *ldb, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CTBTRS", &i__1, (ftnlen)6);
    ...
    *info = 0;
    ...
    for(j = 1; j <= i__1; ++j)
    {
        aocl_blas_ctbsv(uplo, trans, diag, n, kd, &ab[ab_offset], ldab, &b[j * b_dim1 + 1], &c__1);
        /* L30: */
    }
    AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
    return;
