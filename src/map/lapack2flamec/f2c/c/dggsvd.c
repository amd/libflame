/* ../netlib/dggsvd.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dggsvd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dggsvd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dggsvd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dggsvd(jobu, jobv, jobq, m, n, p, k, l, a, lda, b, ldb, alpha, beta, u, ldu, v, ldv, q, ldq, work, iwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t p_64 = *p;
    ...
    aocl_lapack_dggsvd(jobu, jobv, jobq, &m_64, &n_64, &p_64, &k_64, &l_64, a, &lda_64, b, &ldb_64, alpha, beta, u, &ldu_64, v, &ldv_64, q, &ldq_64, work, iwork, &info_64);
...
void aocl_lapack_dggsvd(char *jobu, char *jobv, char *jobq, aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *p,
             aocl_int64_t *k, aocl_int64_t *l, doublereal *a, aocl_int64_t *lda, doublereal *b,
             aocl_int64_t *ldb, doublereal *alpha, doublereal *beta, doublereal *u,
             aocl_int64_t *ldu, doublereal *v, aocl_int64_t *ldv, doublereal *q, aocl_int64_t *ldq,
             doublereal *work, aocl_int_t *iwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DGGSVD", &i__1, (ftnlen)6);
