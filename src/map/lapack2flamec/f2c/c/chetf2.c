/* ../netlib/chetf2.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chetf2.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chetf2.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chetf2.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > CHETF2 computes the factorization of a scomplex Hermitian matrix A */
        ...
        else
        {
            ...
            else
            {
                ...
                if(k > 2)
                {
                    ...
                    tt = 1.f / (d11 * d22 - 1.f);
                    i__1 = k - 1 + k * a_dim1;
                    q__1.real = a[i__1].real / d__;
                    q__1.imag = a[i__1].imag / d__; // , expr subst
                    d12.real = q__1.real;
                    ...
                    for(j = k - 2; j >= 1; --j)
                    {
                        ...
                        for(i__ = j; i__ >= 1; --i__)
                        {
                            ...
                            i__3 = i__ + k * a_dim1;
                            r_cnjg(&q__4, &wk);
                            q__3.real = a[i__3].real * q__4.real - a[i__3].imag * q__4.imag;
                            q__3.imag = a[i__3].real * q__4.imag + a[i__3].imag * q__4.real; // , expr subst
                            q__2.real = a[i__2].real - q__3.real;
                            q__2.imag = a[i__2].imag - q__3.imag; // , expr subst
                            i__4 = i__ + (k - 1) * a_dim1;
                            r_cnjg(&q__6, &wkm1);
                            q__5.real = a[i__4].real * q__6.real - a[i__4].imag * q__6.imag;
                            q__5.imag = a[i__4].real * q__6.imag + a[i__4].imag * q__6.real; // , expr subst
                ...
                if(k < *n - 1)
                {
                    ...
                    for(j = k + 2; j <= i__1; ++j)
                    {
                        ...
                        for(i__ = j; i__ <= i__2; ++i__)
                        {
                            ...
                            i__5 = i__ + k * a_dim1;
                            r_cnjg(&q__4, &wk);
                            q__3.real = a[i__5].real * q__4.real - a[i__5].imag * q__4.imag;
                            q__3.imag = a[i__5].real * q__4.imag + a[i__5].imag * q__4.real; // , expr subst
                            q__2.real = a[i__4].real - q__3.real;
                            q__2.imag = a[i__4].imag - q__3.imag; // , expr subst
                            i__6 = i__ + (k + 1) * a_dim1;
                            r_cnjg(&q__6, &wkp1);
                            q__5.real = a[i__6].real * q__6.real - a[i__6].imag * q__6.imag;
                            q__5.imag = a[i__6].real * q__6.imag + a[i__6].imag * q__6.real; // , expr subst
                            q__1.real = q__2.real - q__5.real;
                            q__1.imag = q__2.imag - q__5.imag; // , expr subst
