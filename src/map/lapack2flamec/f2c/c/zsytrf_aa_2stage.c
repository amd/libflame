...
/* > \verbatim */
/* > */
/* > ZSYTRF_AA_2STAGE computes the factorization of a scomplex symmetric matrix A */
...
void zsytrf_aa_2stage_(char *uplo, aocl_int_t *n, dcomplex *a, aocl_int_t *lda,
                       dcomplex *tb, aocl_int_t *ltb, aocl_int_t *ipiv, aocl_int_t *ipiv2,
                       dcomplex *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zsytrf_aa_2stage(uplo, n, a, lda, tb, ltb, ipiv, ipiv2, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zsytrf_aa_2stage(uplo, &n_64, a, &lda_64, tb, &ltb_64, ipiv, ipiv2, work, &lwork_64,
                                 &info_64);
...
void aocl_lapack_zsytrf_aa_2stage(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
                                  ...
                                  aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZSYTRF_AA_2STAGE", &i__1, (ftnlen)16);
        AOCL_DTL_TRACE_LOG_EXIT
        return;
    }
    /* Answer the query */
    nb = aocl_lapack_ilaenv(&c__1, "ZSYTRF_AA_2STAGE", uplo, n, &c_n1, &c_n1, &c_n1);
    if(*info == 0)
    {
        if(tquery)
        {
        ...
        for(j = 0; j <= i__1; ++j)
        {
            ...
            for(i__ = 1; i__ <= i__2; ++i__)
            {
                if(i__ == 1)
                {
                    ...
                    i__3 = ldtb - 1;
                    aocl_blas_zgemm("NoTranspose", "NoTranspose", &nb, &kb, &jb, &c_b2,
            ...
            if(j > 1)
            {
                ...
                i__3 = ldtb - 1;
                aocl_blas_zgemm("Transpose", "NoTranspose", &kb, &kb, &i__2, &z__1,
                                &a[(j * nb + 1) * a_dim1 + 1], lda, &work[nb + 1], n, &c_b2,
                                &tb[td + 1 + j * nb * ldtb], &i__3);
                /* T(J,J) += U(J,J)'*T(J,J-1)*U(J-1,J) */
                i__2 = ldtb - 1;
                aocl_blas_zgemm("Transpose", "NoTranspose", &kb, &nb, &kb, &c_b2,
                                &a[(j - 1) * nb + 1 + (j * nb + 1) * a_dim1], lda,
                                &tb[td + nb + 1 + (j - 1) * nb * ldtb], &i__2, &c_b1, &work[1], n);
                z__1.real = -1.;
                z__1.imag = -0.; // , expr subst
                i__2 = ldtb - 1;
                aocl_blas_zgemm("NoTranspose", "NoTranspose", &kb, &kb, &nb, &z__1, &work[1], n,
            ...
            if(j > 0)
            {
                ...
                i__2 = ldtb - 1;
                aocl_blas_ztrsm("L", "U", "T", "N", &kb, &kb, &c_b2,
                                &a[(j - 1) * nb + 1 + (j * nb + 1) * a_dim1], lda,
                                &tb[td + 1 + j * nb * ldtb], &i__2);
                i__2 = ldtb - 1;
                aocl_blas_ztrsm("R", "U", "N", "N", &kb, &kb, &c_b2,
                                &a[(j - 1) * nb + 1 + (j * nb + 1) * a_dim1], lda,
                                &tb[td + 1 + j * nb * ldtb], &i__2);
            }
            if(j < nt - 1)
            {
                if(j > 0)
                {
                    ...
                    {
                        i__2 = ldtb - 1;
                        aocl_blas_zgemm("NoTranspose", "NoTranspose", &kb, &kb, &kb, &c_b2,
                                        &tb[td + 1 + j * nb * ldtb], &i__2,
                    ...
                    else
                    {
                        i__2 = nb + kb;
                        i__3 = ldtb - 1;
                        aocl_blas_zgemm("NoTranspose", "NoTranspose", &kb, &kb, &i__2, &c_b2,
                    ...
                    z__1.real = -1.;
                    z__1.imag = -0.; // , expr subst
                    aocl_blas_zgemm("Transpose", "NoTranspose", &nb, &i__2, &i__3, &z__1,
                ...
                {
                    i__3 = *n - (j + 1) * nb;
                    aocl_blas_zcopy(&i__3, &work[(k - 1) * *n + 1], &c__1,
                ...
                kb = fla_min(i__2, i__3);
                i__2 = ldtb - 1;
                aocl_lapack_zlaset("Full", &kb, &nb, &c_b1, &c_b1, &tb[td + nb + 1 + j * nb * ldtb],
                                   &i__2);
                i__2 = ldtb - 1;
                ...
                {
                    i__2 = ldtb - 1;
                    aocl_blas_ztrsm("R", "U", "N", "U", &kb, &nb, &c_b2,
                                    &a[(j - 1) * nb + 1 + (j * nb + 1) * a_dim1], lda,
                ...
                aocl_lapack_zlaset("Lower", &kb, &nb, &c_b1, &c_b2,
        ...
        for(j = 0; j <= i__1; ++j)
        {
            ...
            for(i__ = 1; i__ <= i__2; ++i__)
            {
                if(i__ == 1)
                {
                    ...
                    i__3 = ldtb - 1;
                    aocl_blas_zgemm("NoTranspose", "Transpose", &nb, &kb, &jb, &c_b2,
                                    &tb[td + 1 + i__ * nb * ldtb], &i__3,
            ...
            if(j > 1)
            {
                ...
                z__1.imag = -0.; // , expr subst
                i__3 = ldtb - 1;
                aocl_blas_zgemm("NoTranspose", "NoTranspose", &kb, &kb, &i__2, &z__1,
                                &a[j * nb + 1 + a_dim1], lda, &work[nb + 1], n, &c_b2,
                                &tb[td + 1 + j * nb * ldtb], &i__3);
                /* T(J,J) += L(J,J)*T(J,J-1)*L(J,J-1)' */
                i__2 = ldtb - 1;
                aocl_blas_zgemm("NoTranspose", "NoTranspose", &kb, &nb, &kb, &c_b2,
                                &a[j * nb + 1 + ((j - 1) * nb + 1) * a_dim1], lda,
                                &tb[td + nb + 1 + (j - 1) * nb * ldtb], &i__2, &c_b1, &work[1], n);
                z__1.real = -1.;
                z__1.imag = -0.; // , expr subst
                i__2 = ldtb - 1;
                aocl_blas_zgemm("NoTranspose", "Transpose", &kb, &kb, &nb, &z__1, &work[1], n,
            ...
            if(j > 0)
            {
                ...
                i__2 = ldtb - 1;
                aocl_blas_ztrsm("L", "L", "N", "N", &kb, &kb, &c_b2,
                                &a[j * nb + 1 + ((j - 1) * nb + 1) * a_dim1], lda,
                                &tb[td + 1 + j * nb * ldtb], &i__2);
                i__2 = ldtb - 1;
                aocl_blas_ztrsm("R", "L", "T", "N", &kb, &kb, &c_b2,
                                &a[j * nb + 1 + ((j - 1) * nb + 1) * a_dim1], lda,
                                &tb[td + 1 + j * nb * ldtb], &i__2);
            }
            /* Symmetrize T(J,J) */
            ...
            if(j < nt - 1)
            {
                if(j > 0)
                {
                    ...
                    {
                        i__2 = ldtb - 1;
                        aocl_blas_zgemm("NoTranspose", "Transpose", &kb, &kb, &kb, &c_b2,
                                        &tb[td + 1 + j * nb * ldtb], &i__2,
                    ...
                    else
                    {
                        i__2 = nb + kb;
                        i__3 = ldtb - 1;
                        aocl_blas_zgemm("NoTranspose", "Transpose", &kb, &kb, &i__2, &c_b2,
                                        &tb[td + nb + 1 + (j - 1) * nb * ldtb], &i__3,
                    ...
                    z__1.real = -1.;
                    z__1.imag = -0.; // , expr subst
                    aocl_blas_zgemm("NoTranspose", "NoTranspose", &i__2, &nb, &i__3, &z__1,
                ...
                {
                    i__2 = ldtb - 1;
                    aocl_blas_ztrsm("R", "L", "T", "U", &kb, &nb, &c_b2,
                                    &a[j * nb + 1 + ((j - 1) * nb + 1) * a_dim1], lda,
                                    &tb[td + nb + 1 + j * nb * ldtb], &i__2);
                }
                ...
                aocl_lapack_zlaset("Upper", &kb, &nb, &c_b1, &c_b2,
                                   &a[(j + 1) * nb + 1 + (j * nb + 1) * a_dim1], lda);
                /* Apply pivots to trailing submatrix of A */
                i__2 = kb;
                for(k = 1; k <= i__2; ++k)
