...
/* ../netlib/sgesvxx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvxx
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvxx
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvxx
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
              ...
              real *params, real *work, integer *iwork, integer *info)
{
    ...
    AOCL_DTL_SNPRINTF("sgesvxx inputs: fact %c ,trans %c ,n %" FLA_IS ",nrhs %" FLA_IS
                      ...
                      ",nparams %" FLA_IS "",
                      *fact, *trans, *n, *nrhs, *lda, *ldaf, *equed, *ldb, *ldx, *nparams);
    ...
    *rpvgrw = sla_gerpvgrw_(n, n, &a[a_offset], lda, &af[af_offset], ldaf);
    ...
    sgerfsx_(trans, equed, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], &r__[1],
