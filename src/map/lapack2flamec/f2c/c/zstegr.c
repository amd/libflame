...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zstegr(jobz, range, n, d__, e, vl, vu, il, iu, abstol, m, w, z__, ldz, isuppz, work,
    ...
    aocl_lapack_zstegr(jobz, range, &n_64, d__, e, vl, vu, &il_64, &iu_64, abstol, &m_64, w, z__,
...
void aocl_lapack_zstegr(char *jobz, char *range, aocl_int64_t *n, doublereal *d__, doublereal *e,
