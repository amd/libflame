...
fla_dim_t fla_scomp_f( const void* a, const void* b );
fla_dim_t fla_scomp_b( const void* a, const void* b );
fla_dim_t fla_dcomp_f( const void* a, const void* b );
fla_dim_t fla_dcomp_b( const void* a, const void* b );
...
FLA_Error FLA_Sort_f_ops( fla_dim_t     m_x,
...
FLA_Error FLA_Sort_b_ops( fla_dim_t     m_x,
                          float*  x, fla_dim_t inc_x )
{
	qsort( x,
	       m_x,
...
FLA_Error FLA_Sort_f_opd( fla_dim_t     m_x,
...
FLA_Error FLA_Sort_b_opd( fla_dim_t     m_x,
                          double* x, fla_dim_t inc_x )
{
	qsort( x,
	       m_x,
