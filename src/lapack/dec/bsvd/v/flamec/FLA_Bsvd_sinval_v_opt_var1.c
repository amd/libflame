                                      ...
                                      FLA_Obj k )
{
    ...
    case FLA_FLOAT:
    {
        ...
        fla_dim_t*      buff_k      = FLA_INT_PTR( k );
...
FLA_Error FLA_Bsvd_sinval_v_ops_var1( fla_dim_t       m_A,
                                      fla_dim_t       n_GH,
                                      fla_dim_t       n_iter_allowed,
                                      float     tol,
                                      float     thresh,
...
FLA_Error FLA_Bsvd_sinval_v_opd_var1( fla_dim_t       m_A,
                                      fla_dim_t       n_GH,
                                      fla_dim_t       n_iter_allowed,
                                      double    tol,
                                      double    thresh,
