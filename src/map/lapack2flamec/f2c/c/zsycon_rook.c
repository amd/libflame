/* ../netlib/zsycon_rook.f -- translated by f2c (version 20100827). You must link the resulting
...
/* ===================================================================== */
/* Subroutine */
void zsycon_rook_(char *uplo, integer *n, doublecomplex *a, integer *lda, integer *ipiv,
...
L30:
    ...
    if(kase != 0)
    {
        ...
        aocl_lapack_zsytrs_rook(uplo, n, &c__1, &a[a_offset], lda, &ipiv[1], &work[1], n, info);
        goto L30;
    }
