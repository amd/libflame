...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ssyevx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ssyevx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ssyevx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void ssyevx_(char *jobz, char *range, char *uplo, aocl_int_t *n, real *a, aocl_int_t *lda, real *vl,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_ssyevx(jobz, range, uplo, n, a, lda, vl, vu, il, iu, abstol, m, w, z__, ldz, work,
    ...
    aocl_lapack_ssyevx(jobz, range, uplo, &n_64, a, &lda_64, vl, vu, &il_64, &iu_64, abstol, &m_64,
...
void aocl_lapack_ssyevx(char *jobz, char *range, char *uplo, aocl_int64_t *n, real *a,
                        ...
                        real *work, aocl_int64_t *lwork, aocl_int_t *iwork, aocl_int_t *ifail,
                        aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("ssyevx inputs: jobz %c, range %c, uplo %c, n %" FLA_IS ", lda %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SSYEVX", &i__1, (ftnlen)6);
