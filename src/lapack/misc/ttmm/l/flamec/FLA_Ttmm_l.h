...
FLA_Error FLA_Ttmm_l_ops_var1( fla_dim_t mn_A,
                               float*    A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opd_var1( fla_dim_t mn_A,
                               double*   A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opc_var1( fla_dim_t mn_A,
                               scomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opz_var1( fla_dim_t mn_A,
                               dcomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );

FLA_Error FLA_Ttmm_l_opt_var2( FLA_Obj A );
FLA_Error FLA_Ttmm_l_ops_var2( fla_dim_t mn_A,
                               float*    A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opd_var2( fla_dim_t mn_A,
                               double*   A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opc_var2( fla_dim_t mn_A,
                               scomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opz_var2( fla_dim_t mn_A,
                               dcomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );

FLA_Error FLA_Ttmm_l_opt_var3( FLA_Obj A );
FLA_Error FLA_Ttmm_l_ops_var3( fla_dim_t mn_A,
                               float*    A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opd_var3( fla_dim_t mn_A,
                               double*   A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opc_var3( fla_dim_t mn_A,
                               scomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
FLA_Error FLA_Ttmm_l_opz_var3( fla_dim_t mn_A,
                               dcomplex* A, fla_dim_t rs_A, fla_dim_t cs_A );
