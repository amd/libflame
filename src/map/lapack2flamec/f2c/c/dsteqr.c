...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dsteqr(compz, n, d__, e, z__, ldz, work, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t ldz_64 = *ldz;
    aocl_int64_t info_64 = *info;

    aocl_lapack_dsteqr(compz, &n_64, d__, e, z__, &ldz_64, work, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dsteqr(char *compz, aocl_int64_t *n, doublereal *d__, doublereal *e,
                        doublereal *z__, aocl_int64_t *ldz, doublereal *work, aocl_int64_t *info)
{
    ...
    extern /* Subroutine */
        void
        dsteqr_helper_(char *jobz, char *uplo, aocl_int64_t *n, doublereal *a, aocl_int64_t *lda,
    ...
    *info = 0;
    ...
    if(lsame_(compz, "I", 1, 1) && *n > 37)
    {
        ...
        liwork = -1;
        aocl_int64_t N = *n, i;
        aocl_int64_t LDZ = *ldz;

        /* Setting the lower triangular part of z__ to 0 */
        aocl_lapack_dlaset("L", n, n, &c_b9, &c_b9, &z__[z_offset], ldz);
    ...
    L140:
        ...
        {
            i__1 = lendsv - lsv + 1;
            aocl_lapack_dlascl("G", &c__0, &c__0, &ssfmax, &anorm, &i__1, &c__1, &d__[lsv], n,
                               info);
            i__1 = lendsv - lsv;
        ...
        {
            i__1 = lendsv - lsv + 1;
            aocl_lapack_dlascl("G", &c__0, &c__0, &ssfmin, &anorm, &i__1, &c__1, &d__[lsv], n,
                               info);
            i__1 = lendsv - lsv;
