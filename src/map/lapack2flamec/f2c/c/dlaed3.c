...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed3.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed3.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed3.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void dlaed3_(aocl_int_t *k, aocl_int_t *n, aocl_int_t *n1, doublereal *d__, doublereal *q,
                        ...
                        doublereal *s, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    /* Compute updated W. */
    aocl_blas_dcopy(k, &w[1], &c__1, &s[1], &c__1);
    ...
    for(j = 1; j <= i__1; ++j)
    {
        ...
        temp = aocl_blas_dnrm2(k, &s[1], &c__1);
        i__2 = *k;
        for(i__ = 1; i__ <= i__2; ++i__)
        {
            ii = indx[i__];
...
L110:
    ...
    n12 = ctot[1] + ctot[2];
    n23 = ctot[2] + ctot[3];
    aocl_lapack_dlacpy("A", &n23, k, &q[ctot[1] + 1 + q_dim1], ldq, &s[1], &n23);
    iq2 = *n1 * n12 + 1;
    if(n23 != 0)
    {
