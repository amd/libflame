...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zlaqr4(wantt, wantz, n, ilo, ihi, h__, ldh, w, iloz, ihiz, z__, ldz, work, lwork,
                       info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zlaqr4(wantt, wantz, &n_64, &ilo_64, &ihi_64, h__, &ldh_64, w, &iloz_64, &ihiz_64,
...
void aocl_lapack_zlaqr4(logical *wantt, logical *wantz, aocl_int64_t *n, aocl_int64_t *ilo,
    ...
    *info = 0;
    ...
    else
    {
        ...
        *info = 0;
        ...
        /* . NWR.GE.4.) ==== */
        nwr = aocl_lapack_ilaenv(&c__13, "ZLAQR4", jbcmpz, n, ilo, ihi, lwork);
        nwr = fla_max(2, nwr);
        /* Computing MIN */
        i__1 = *ihi - *ilo + 1;
        i__2 = (*n - 1) / 3;
        ...
        nsr = aocl_lapack_ilaenv(&c__15, "ZLAQR4", jbcmpz, n, ilo, ihi, lwork);
        /* Computing MIN */
        i__1 = nsr, i__2 = (*n - 3) / 6;
        ...
        i__1 = nwr + 1;
        aocl_lapack_zlaqr2(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, ihiz,
        ...
        nmin = aocl_lapack_ilaenv(&c__12, "ZLAQR4", jbcmpz, n, ilo, ihi, lwork);
        nmin = fla_max(15, nmin);
        /* ==== Nibble crossover point ==== */
        nibble = aocl_lapack_ilaenv(&c__14, "ZLAQR4", jbcmpz, n, ilo, ihi, lwork);
        nibble = fla_max(0, nibble);
        /* ==== Accumulate reflections during ttswp? Use block */
        /* . 2-by-2 structure during matrix-matrix multiply? ==== */
        kacc22 = aocl_lapack_ilaenv(&c__16, "ZLAQR4", jbcmpz, n, ilo, ihi, lwork);
        ...
        L20:
            ...
            nve = *n - nw - kwv + 1;
            /* ==== Aggressive early deflation ==== */
            aocl_lapack_zlaqr2(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, iloz, ihiz,
                ...
                else
                {
                    ...
                    if(kbot - ks + 1 <= ns / 2)
                    {
                        ...
                        aocl_lapack_zlacpy("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh,
                                           &h__[kt + h_dim1], ldh);
                        aocl_lapack_zlahqr(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt + h_dim1],
