...
void csycon_(char *uplo, aocl_int_t *n, scomplex *a, aocl_int_t *lda, aocl_int_t *ipiv, real *anorm,
             real *rcond, scomplex *work, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_csycon(uplo, n, a, lda, ipiv, anorm, rcond, work, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t lda_64 = *lda;
    aocl_int64_t info_64 = *info;

    aocl_lapack_csycon(uplo, &n_64, a, &lda_64, ipiv, anorm, rcond, work, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_csycon(char *uplo, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CSYCON", &i__1, (ftnlen)6);
...
L30:
    ...
    if(kase != 0)
    {
        ...
        aocl_lapack_csytrs(uplo, n, &c__1, &a[a_offset], lda, &ipiv[1], &work[1], n, info);
        goto L30;
    }
