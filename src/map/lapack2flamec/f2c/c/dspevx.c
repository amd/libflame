...
void dspevx_(char *jobz, char *range, char *uplo, aocl_int_t *n, doublereal *ap, doublereal *vl,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dspevx(jobz, range, uplo, n, ap, vl, vu, il, iu, abstol, m, w, z__, ldz, work,
                       iwork, ifail, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dspevx(jobz, range, uplo, &n_64, ap, vl, vu, &il_64, &iu_64, abstol, &m_64, w, z__,
...
void aocl_lapack_dspevx(char *jobz, char *range, char *uplo, aocl_int64_t *n, doublereal *ap,
                        ...
                        aocl_int64_t *info)
{
    ...
    AOCL_DTL_SNPRINTF("dspevx inputs: jobz %c, range %c, uplo %c, n %" FLA_IS ", il %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DSPEVX", &i__1, (ftnlen)6);
