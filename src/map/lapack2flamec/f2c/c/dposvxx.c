...
/* ../netlib/dposvxx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dposvxx
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dposvxx
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dposvxx
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void dposvxx_(char *fact, char *uplo, integer *n, integer *nrhs, doublereal *a, integer *lda,
              doublereal *af, integer *ldaf, char *equed, doublereal *s, doublereal *b,
              integer *ldb, doublereal *x, integer *ldx, doublereal *rcond, doublereal *rpvgrw,
              ...
              integer *iwork, integer *info)
{
    ...
    extern doublereal dla_porpvgrw_(char *, integer *, doublereal *, integer *, doublereal *,
                                    integer *, doublereal *);
    ...
    extern /* Subroutine */
        ...
        dpoequb_(integer *, doublereal *, integer *, doublereal *, doublereal *, doublereal *,
                 integer *),
        dporfsx_(char *, char *, integer *, integer *, doublereal *, integer *, doublereal *,
    ...
    *rpvgrw = dla_porpvgrw_(uplo, n, &a[a_offset], lda, &af[af_offset], ldaf, &work[1]);
    ...
    dporfsx_(uplo, equed, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &s[1], &b[b_offset],
             ldb, &x[x_offset], ldx, rcond, &berr[1], n_err_bnds__,
