...
/* ===================================================================== */
/* Subroutine */
void dsysv_aa_(char *uplo, integer *n, integer *nrhs, doublereal *a, integer *lda, integer *ipiv,
               doublereal *b, integer *ldb, doublereal *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */
        void
        dsytrf_aa_(char *, integer *, doublereal *, integer *, integer *, doublereal *, integer *,
                   integer *),
        dsytrs_aa_(char *, integer *, integer *, doublereal *, integer *, integer *, doublereal *,
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        dsytrs_aa_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], ldb, &work[1], &c_n1,
                   info);
    ...
    if(*info == 0)
    {
        ...
        dsytrs_aa_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], ldb, &work[1], lwork,
                   info);
    }
    work[1] = (doublereal)lwkopt;
    AOCL_DTL_TRACE_LOG_EXIT
