...
void claqr2_(logical *wantt, logical *wantz, aocl_int_t *n, aocl_int_t *ktop, aocl_int_t *kbot,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_claqr2(wantt, wantz, n, ktop, kbot, nw, h__, ldh, iloz, ihiz, z__, ldz, ns, nd, sh,
    ...
    aocl_lapack_claqr2(wantt, wantz, &n_64, &ktop_64, &kbot_64, &nw_64, h__, &ldh_64, &iloz_64,
...
void aocl_lapack_claqr2(logical *wantt, logical *wantz, aocl_int64_t *n, aocl_int64_t *ktop,
