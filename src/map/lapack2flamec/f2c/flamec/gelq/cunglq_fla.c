...
/* ===================================================================== */
/* Subroutine */
void cunglq_fla(integer *m, integer *n, integer *k, complex *a, integer *lda, complex *tau, complex *work, integer *lwork, integer * info)
{
    ...
    *info = 0;
    ...
    if(kk < *m)
    {
        ...
        i__2 = *n - kk;
        i__3 = *k - kk;
        cungl2_fla(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &tau[kk + 1], &work[1],
                   &iinfo);
    }
    if(kk > 0)
    {
