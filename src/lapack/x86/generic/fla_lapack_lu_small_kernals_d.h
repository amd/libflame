...
#define FLA_LU_PIV_SMALL_D_2x2( i, n, buff_A, ldim_A, buff_p,info)                \
   doublereal max_val_2, t_val_2 = 0.0;                                           \
   doublereal* acur_2, * apiv_2, * asrc_2;                                        \
   integer p_idx_2 = i, lda2 = *ldim_A;                                           \
    /* #####################     First iteration     ###################### */    \
    acur_2 = &buff_A[i + lda2 * i];                                               \
                                                                                  \
    /* Find the pivot element */                                                  \
    if (f2c_dabs(acur_2[0]) > f2c_dabs(acur_2[1]))                                \
    {                                                                             \
        max_val_2 = f2c_dabs(acur_2[0]);                                          \
        p_idx_2 = i;                                                              \
    }                                                                             \
    else                                                                          \
    {                                                                             \
        max_val_2 = f2c_dabs(acur_2[1]);                                          \
        p_idx_2 = i + 1;                                                          \
    }                                                                             \
