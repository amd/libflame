/* dbdsqr.f -- translated by f2c (version 20160102). You must link the resulting object file with
                  ...
                  aocl_int64_t *ldc, doublereal *work, aocl_int64_t *info)
{
    ...
    extern void dlas2_(doublereal *, doublereal *, doublereal *, doublereal *, doublereal *);
    ...
    logical lower;
    void dlasv2_(doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *,
