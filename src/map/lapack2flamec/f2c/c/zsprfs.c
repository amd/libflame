/* ../netlib/zsprfs.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zsprfs.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zsprfs.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zsprfs.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void zsprfs_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, dcomplex *ap, dcomplex *afp,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zsprfs(uplo, n, nrhs, ap, afp, ipiv, b, ldb, x, ldx, ferr, berr, work, rwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zsprfs(uplo, &n_64, &nrhs_64, ap, afp, ipiv, b, &ldb_64, x, &ldx_64, ferr, berr,
                       work, rwork, &info_64);
...
void aocl_lapack_zsprfs(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, dcomplex *ap,
                        ...
                        dcomplex *work, doublereal *rwork, aocl_int64_t *info)
{
    ...
    AOCL_DTL_SNPRINTF("zsprfs inputs: uplo %c, n %" FLA_IS ", nrhs %" FLA_IS ", ldb %" FLA_IS
                      ", ldx %" FLA_IS "",
                      *uplo, *n, *nrhs, *ldb, *ldx);
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZSPRFS", &i__1, (ftnlen)6);
