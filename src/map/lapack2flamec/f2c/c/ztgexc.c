...
/* > \verbatim */
/* > */
/* > ZTGEXC reorders the generalized Schur decomposition of a scomplex */
...
void ztgexc_(logical *wantq, logical *wantz, aocl_int_t *n, dcomplex *a, aocl_int_t *lda,
                        ...
                        aocl_int64_t *ifst, aocl_int64_t *ilst, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    L10: /* Swap with next one below */
        aocl_lapack_ztgex2(wantq, wantz, n, &a[a_offset], lda, &b[b_offset], ldb, &q[q_offset], ldq,
