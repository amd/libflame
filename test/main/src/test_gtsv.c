                              ...
                              integer q_cur, integer pci, integer n_repeats, integer einfo)
{
    ...
    FLA_BRT_PROCESS_FOUR_INPUT(datatype, n - 1, 1, dl, n - 1, datatype, n, 1, d, n, datatype, n - 1,
                               1, du, n - 1, datatype, n, NRHS, B, ldb, "ddd", n, NRHS, ldb)
    ...
    IF_FLA_BRT_VALIDATION(
        n, n,
        store_outputs_base(filename, params, 1, 3, datatype, n, NRHS, B_save, ldb, datatype, n - 1,
                           dl_save, datatype, n, d_save, datatype, n - 1, du_save),
