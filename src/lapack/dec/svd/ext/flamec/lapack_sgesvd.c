...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                  ...
                  aocl_int64_t *ldvt, real *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    aocl_int64_t iscl;
    real anrm;
    aocl_int64_t ierr, itau, ncvt, nrvt, lwork_sgebrd__, lwork_sgelqf__, lwork_sgeqrf__, i__;
    extern logical lsame_(char *, char *, aocl_int64_t, aocl_int64_t);
    aocl_int64_t chunk;
    aocl_int64_t minmn, wrkbl, itaup, itauq, mnthr, iwork;
    logical wntua, wntva, wntun, wntuo, wntvn, wntvo, wntus, wntvs;
    aocl_int64_t ie, ir, bdspac, iu;
    extern /* Subroutine */
        int
        lapack_sgebrd(aocl_int64_t *, aocl_int64_t *, real *, aocl_int64_t *, real *, real *,
                      real *, real *, real *, aocl_int64_t *, aocl_int64_t *);
    real bignum;
    extern /* Subroutine */
        int
        lapack_sbdsqr(char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *,
                      real *, real *, real *, aocl_int64_t *, real *, aocl_int64_t *, real *,
                      aocl_int64_t *, real *, aocl_int64_t *),
        lapack_sorgbr(char *, aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, real *,
                      aocl_int64_t *, real *, real *, aocl_int64_t *, aocl_int64_t *),
    ...
    extern int lapack_sgelqf(aocl_int64_t *m, aocl_int64_t *n, real *a, aocl_int64_t *lda, real *tau,
                  real *work, aocl_int64_t *lwork, aocl_int64_t *info);
    extern real slamch_(char *);
    aocl_int64_t ldwrkr, minwrk, ldwrku, maxwrk;
    extern /* Subroutine */
        int
        lapack_sorglq(aocl_int64_t *, aocl_int64_t *, aocl_int64_t *, real *, aocl_int64_t *,
    ...
    aocl_int64_t blk, lwork_sorgbr_p__, lwork_sorgbr_q__, lwork_sorglq_m__, lwork_sorglq_n__, ncu,
        lwork_sorgqr_n__, lwork_sorgqr_m__;
    real eps, dum[1];
    aocl_int64_t nru;
    ...
    *info = 0;
    ...
    if(*m >= *n)
    {
        ...
        if(*m >= mnthr)
        {
            if(wntun)
            {
                ...
                lapack_sbdsqr("U", n, &ncvt, &c__0, &c__0, &s[1], &work[ie], &a[a_offset], lda, dum,
            ...
            else if(wntuo && wntvn)
            {
                ...
                if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                {
                    ...
                    i__2 = *n - 1;
                    i__3 = *n - 1;
                    aocl_lapack_slaset("L", &i__2, &i__3, &c_b57, &c_b57, &work[ir + 1], &ldwrkr);
                    /* Generate Q in A */
                    /* (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */
                    i__2 = *lwork - iwork + 1;
                    lapack_sorgqr(m, n, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__2,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *n;
                    itaup = itauq + *n;
                    ...
                    i__2 = *lwork - iwork + 1;
                    lapack_sgebrd(n, n, &work[ir], &ldwrkr, &s[1], &work[ie], &work[itauq],
                                  &work[itaup], &work[iwork], &i__2, &ierr);
                    /* Generate left vectors bidiagonalizing R */
                    /* (Workspace: need N*N+4*N, prefer N*N+3*N+N*NB) */
                    i__2 = *lwork - iwork + 1;
                    lapack_sorgbr("Q", n, n, n, &work[ir], &ldwrkr, &work[itauq], &work[iwork],
                                  &i__2, &ierr);
                    iwork = ie + *n;
                    /* Perform bidiagonal QR iteration, computing left */
                    /* singular vectors of R in WORK(IR) */
                    /* (Workspace: need N*N+BDSPAC) */
                    lapack_sbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &c__1, &work[ir],
                    ...
                    for(i__ = 1; i__3 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__3)
                    {
                        ...
                        aocl_blas_sgemm("N", "N", &chunk, n, n, &c_b79, &a[i__ + a_dim1], lda,
                                        &work[ir], &ldwrkr, &c_b57, &work[iu], &ldwrku);
                        aocl_lapack_slacpy("F", &chunk, n, &work[iu], &ldwrku, &a[i__ + a_dim1],
                                           lda);
                        /* L10: */
                    }
                }
                else
                {
                    ...
                    i__3 = *lwork - iwork + 1;
                    lapack_sgebrd(m, n, &a[a_offset], lda, &s[1], &work[ie], &work[itauq],
                    ...
                    /* (Workspace: need BDSPAC) */
                    lapack_sbdsqr("U", n, &c__0, m, &c__0, &s[1], &work[ie], dum, &c__1,
            ...
            else if(wntuo && wntvas)
            {
                ...
                if(*lwork >= *n * *n + fla_max(i__3, bdspac))
                {
                    ...
                    /* (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */
                    i__3 = *lwork - iwork + 1;
                    aocl_lapack_sgeqrf(m, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__3,
                                       &ierr);
                    ...
                    if(*n > 1)
                    {
                        i__3 = *n - 1;
                        i__2 = *n - 1;
                        aocl_lapack_slaset("L", &i__3, &i__2, &c_b57, &c_b57, &vt[vt_dim1 + 2],
                                           ldvt);
                    }
                    /* Generate Q in A */
                    /* (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */
                    i__3 = *lwork - iwork + 1;
                    lapack_sorgqr(m, n, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__3,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *n;
                    itaup = itauq + *n;
                    ...
                    lapack_sgebrd(n, n, &vt[vt_offset], ldvt, &s[1], &work[ie], &work[itauq],
                                  &work[itaup], &work[iwork], &i__3, &ierr);
                    aocl_lapack_slacpy("L", n, n, &vt[vt_offset], ldvt, &work[ir], &ldwrkr);
                    ...
                    /* (Workspace: need N*N+BDSPAC) */
                    lapack_sbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                ...
                else
                {
                    ...
                    i__2 = *lwork - iwork + 1;
                    lapack_sormbr("Q", "R", "N", m, n, n, &vt[vt_offset], ldvt, &work[itauq],
                    ...
                    /* (Workspace: need BDSPAC) */
                    lapack_sbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                                  &a[a_offset], lda, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntus)
            {
                if(wntvn)
                {
                    ...
                    if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        i__2 = *n - 1;
                        i__3 = *n - 1;
                        aocl_lapack_slaset("L", &i__2, &i__3, &c_b57, &c_b57, &work[ir + 1],
                                           &ldwrkr);
                        /* Generate Q in A */
                        /* (Workspace: need N*N+2*N, prefer N*N+N+N*NB) */
                        i__2 = *lwork - iwork + 1;
                        ...
                        /* singular vectors of R in WORK(IR) */
                        /* (Workspace: need N*N+BDSPAC) */
                        lapack_sbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &c__1,
                                      &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
                        /* Multiply Q in A by left singular vectors of R in */
                        /* WORK(IR), storing result in U */
                        /* (Workspace: need N*N) */
                        aocl_blas_sgemm("N", "N", m, n, n, &c_b79, &a[a_offset], lda, &work[ir],
                    ...
                    else
                    {
                        ...
                        /* (Workspace: need 2*N, prefer N+N*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_sorgqr(m, n, n, &u[u_offset], ldu, &work[itau], &work[iwork], &i__2,
                                      &ierr);
                        ie = itau;
                        itauq = ie + *n;
                        itaup = itauq + *n;
                        ...
                        if(*n > 1)
                        {
                            i__2 = *n - 1;
                            i__3 = *n - 1;
                            aocl_lapack_slaset("L", &i__2, &i__3, &c_b57, &c_b57, &a[a_dim1 + 2],
                                               lda);
                        }
                        /* Bidiagonalize R in A */
                        /* (Workspace: need 4*N, prefer 3*N+2*N*NB) */
                        ...
                        /* (Workspace: need 3*N+M, prefer 3*N+M*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_sormbr("Q", "R", "N", m, n, n, &a[a_offset], lda, &work[itauq],
                ...
                else if(wntvo)
                {
                    ...
                    if(*lwork >= (*n << 1) * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        lapack_sgebrd(n, n, &work[iu], &ldwrku, &s[1], &work[ie], &work[itauq],
                                      &work[itaup], &work[iwork], &i__2, &ierr);
                        aocl_lapack_slacpy("U", n, n, &work[iu], &ldwrku, &work[ir], &ldwrkr);
                        ...
                        i__2 = *lwork - iwork + 1;
                        lapack_sorgbr("P", n, n, n, &work[ir], &ldwrkr, &work[itaup], &work[iwork],
                                      &i__2, &ierr);
                        iwork = ie + *n;
                        /* Perform bidiagonal QR iteration, computing left */
                        ...
                        lapack_sbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                        ...
                        /* (Workspace: need N*N) */
                        aocl_lapack_slacpy("F", n, n, &work[ir], &ldwrkr, &a[a_offset], lda);
                    }
                    else
                    {
                        /* Insufficient workspace for a fast algorithm */
                        ...
                        /* singular vectors of A in A */
                        /* (Workspace: need BDSPAC) */
                        lapack_sbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                      &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                    }
                }
                else if(wntvas)
            ...
            else if(wntua)
            {
                if(wntvn)
                {
                    ...
                    if(*lwork >= *n * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        i__2 = *lwork - iwork + 1;
                        lapack_sorgqr(m, m, n, &u[u_offset], ldu, &work[itau], &work[iwork], &i__2,
                                      &ierr);
                        ie = itau;
                        itauq = ie + *n;
                        itaup = itauq + *n;
                        ...
                        /* (Workspace: need N*N) */
                        aocl_blas_sgemm("N", "N", m, n, n, &c_b79, &u[u_offset], ldu, &work[ir],
                ...
                else if(wntvo)
                {
                    ...
                    if(*lwork >= (*n << 1) * *n + fla_max(i__2, bdspac))
                    {
                        ...
                        /* (Workspace: need N*N) */
                        aocl_blas_sgemm("N", "N", m, n, n, &c_b79, &u[u_offset], ldu, &work[iu],
        ...
        else
        {
            ...
            if(!wntuo && !wntvo)
            {
                ...
                /* vectors in VT */
                /* (Workspace: need BDSPAC) */
                lapack_sbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                              &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
            }
            else if(!wntuo && wntvo)
            {
                ...
                /* vectors in A */
                /* (Workspace: need BDSPAC) */
                lapack_sbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                              &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
            }
            else
            {
    ...
    else
    {
        ...
        if(*n >= mnthr)
        {
            if(wntvn)
            {
                ...
                /* (Workspace: need BDSPAC) */
                lapack_sbdsqr("U", m, &c__0, &nru, &c__0, &s[1], &work[ie], dum, &c__1,
                              &a[a_offset], lda, dum, &c__1, &work[iwork], info);
            ...
            else if(wntvo && wntun)
            {
                ...
                if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                {
                    ...
                    aocl_lapack_slacpy("L", m, m, &a[a_offset], lda, &work[ir], &ldwrkr);
                    i__2 = *m - 1;
                    i__3 = *m - 1;
                    aocl_lapack_slaset("U", &i__2, &i__3, &c_b57, &c_b57, &work[ir + ldwrkr],
                                       &ldwrkr);
                    /* Generate Q in A */
                    /* (Workspace: need M*M+2*M, prefer M*M+M+M*NB) */
                    i__2 = *lwork - iwork + 1;
                    lapack_sorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[iwork], &i__2,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *m;
                    itaup = itauq + *m;
                    ...
                    i__2 = *lwork - iwork + 1;
                    lapack_sgebrd(m, m, &work[ir], &ldwrkr, &s[1], &work[ie], &work[itauq],
                                  &work[itaup], &work[iwork], &i__2, &ierr);
                    /* Generate right vectors bidiagonalizing L */
                    /* (Workspace: need M*M+4*M-1, prefer M*M+3*M+(M-1)*NB) */
                    i__2 = *lwork - iwork + 1;
                    lapack_sorgbr("P", m, m, m, &work[ir], &ldwrkr, &work[itaup], &work[iwork],
                                  &i__2, &ierr);
                    iwork = ie + *m;
                    /* Perform bidiagonal QR iteration, computing right */
                    /* singular vectors of L in WORK(IR) */
                    /* (Workspace: need M*M+BDSPAC) */
                    lapack_sbdsqr("U", m, m, &c__0, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                    ...
                    for(i__ = 1; i__3 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__3)
                    {
                        ...
                        aocl_blas_sgemm("N", "N", m, &blk, m, &c_b79, &work[ir], &ldwrkr,
                                        &a[i__ * a_dim1 + 1], lda, &c_b57, &work[iu], &ldwrku);
                        aocl_lapack_slacpy("F", m, &blk, &work[iu], &ldwrku, &a[i__ * a_dim1 + 1],
                                           lda);
                        /* L30: */
                    }
                }
                else
                {
                    ...
                    /* singular vectors of A in A */
                    /* (Workspace: need BDSPAC) */
                    lapack_sbdsqr("L", m, n, &c__0, &c__0, &s[1], &work[ie], &a[a_offset], lda, dum,
                                  &c__1, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntvo && wntuas)
            {
                ...
                if(*lwork >= *m * *m + fla_max(i__3, bdspac))
                {
                    ...
                    i__3 = *m - 1;
                    i__2 = *m - 1;
                    aocl_lapack_slaset("U", &i__3, &i__2, &c_b57, &c_b57, &u[(u_dim1 << 1) + 1],
                                       ldu);
                    /* Generate Q in A */
                    /* (Workspace: need M*M+2*M, prefer M*M+M+M*NB) */
                    i__3 = *lwork - iwork + 1;
                    lapack_sorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[iwork], &i__3,
                                  &ierr);
                    ie = itau;
                    itauq = ie + *m;
                    itaup = itauq + *m;
                    ...
                    lapack_sgebrd(m, m, &u[u_offset], ldu, &s[1], &work[ie], &work[itauq],
                                  &work[itaup], &work[iwork], &i__3, &ierr);
                    aocl_lapack_slacpy("U", m, m, &u[u_offset], ldu, &work[ir], &ldwrkr);
                    ...
                    /* singular vectors of L in WORK(IR) */
                    /* (Workspace: need M*M+BDSPAC) */
                    lapack_sbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                    iu = ie + *m;
                    /* Multiply right singular vectors of L in WORK(IR) by Q */
                    /* in A, storing result in WORK(IU) and copying to A */
                ...
                else
                {
                    ...
                    i__2 = *lwork - iwork + 1;
                    lapack_sormbr("P", "L", "T", m, n, m, &u[u_offset], ldu, &work[itaup],
                                  &a[a_offset], lda, &work[iwork], &i__2, &ierr);
                    /* Generate left vectors bidiagonalizing L in U */
                    /* (Workspace: need 4*M, prefer 3*M+M*NB) */
                    i__2 = *lwork - iwork + 1;
                    ...
                    /* singular vectors of A in A */
                    /* (Workspace: need BDSPAC) */
                    lapack_sbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                                  &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
                }
            }
            else if(wntvs)
            {
                if(wntun)
                {
                    ...
                    if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                    {
                        ...
                        /* (Workspace: need M*M) */
                        aocl_blas_sgemm("N", "N", m, n, m, &c_b79, &work[ir], &ldwrkr, &a[a_offset],
                    ...
                    else
                    {
                        ...
                        /* (Workspace: need 2*M, prefer M+M*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_sorglq(m, n, m, &vt[vt_offset], ldvt, &work[itau], &work[iwork],
                                      &i__2, &ierr);
                        ie = itau;
                        itauq = ie + *m;
                        itaup = itauq + *m;
                        ...
                        /* (Workspace: need 3*M+N, prefer 3*M+N*NB) */
                        i__2 = *lwork - iwork + 1;
                        lapack_sormbr("P", "L", "T", m, n, m, &a[a_offset], lda, &work[itaup],
                                      &vt[vt_offset], ldvt, &work[iwork], &i__2, &ierr);
                        iwork = ie + *m;
                        /* Perform bidiagonal QR iteration, computing right */
                        /* singular vectors of A in VT */
                        /* (Workspace: need BDSPAC) */
                        lapack_sbdsqr("U", m, n, &c__0, &c__0, &s[1], &work[ie], &vt[vt_offset],
                ...
                else if(wntuo)
                {
                    ...
                    if(*lwork >= (*m << 1) * *m + fla_max(i__2, bdspac))
                    {
                        ...
                        lapack_sgebrd(m, m, &work[iu], &ldwrku, &s[1], &work[ie], &work[itauq],
                                      &work[itaup], &work[iwork], &i__2, &ierr);
                        aocl_lapack_slacpy("L", m, m, &work[iu], &ldwrku, &work[ir], &ldwrkr);
                        ...
                        i__2 = *lwork - iwork + 1;
                        lapack_sorgbr("Q", m, m, m, &work[ir], &ldwrkr, &work[itauq], &work[iwork],
                                      &i__2, &ierr);
                        iwork = ie + *m;
                        /* Perform bidiagonal QR iteration, computing left */
                        ...
                        lapack_sbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[iu], &ldwrku,
                                      &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
                        ...
                        /* (Workspace: need M*M) */
                        aocl_lapack_slacpy("F", m, m, &work[ir], &ldwrkr, &a[a_offset], lda);
                    }
                    else
                    {
                        /* Insufficient workspace for a fast algorithm */
                        ...
                        /* singular vectors of A in VT */
                        /* (Workspace: need BDSPAC) */
                        lapack_sbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                                      &a[a_offset], lda, dum, &c__1, &work[iwork], info);
                    }
                }
                else if(wntuas)
            ...
            else if(wntva)
            {
                if(wntun)
                {
                    ...
                    if(*lwork >= *m * *m + fla_max(i__2, bdspac))
                    {
                        ...
                        i__2 = *lwork - iwork + 1;
                        lapack_sorglq(n, n, m, &vt[vt_offset], ldvt, &work[itau], &work[iwork],
                                      &i__2, &ierr);
                        ie = itau;
                        itauq = ie + *m;
                        itaup = itauq + *m;
                        ...
                        /* (Workspace: need M*M) */
                        aocl_blas_sgemm("N", "N", m, n, m, &c_b79, &work[ir], &ldwrkr,
        ...
        else
        {
            ...
            if(!wntuo && !wntvo)
            {
                ...
                /* vectors in VT */
                /* (Workspace: need BDSPAC) */
                lapack_sbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[vt_offset], ldvt,
                              &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
            }
            else if(!wntuo && wntvo)
            {
                ...
                /* vectors in A */
                /* (Workspace: need BDSPAC) */
                lapack_sbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[a_offset], lda,
                              &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
            }
            else
            {
    ...
    if(iscl == 1)
    {
        ...
        {
            i__2 = minmn - 1;
            aocl_lapack_slascl("G", &c__0, &c__0, &bignum, &anrm, &i__2, &c__1, &work[2], &minmn,
                               &ierr);
        }
        if(anrm < smlnum)
        {
        ...
        {
            i__2 = minmn - 1;
            aocl_lapack_slascl("G", &c__0, &c__0, &smlnum, &anrm, &i__2, &c__1, &work[2], &minmn,
                               &ierr);
        }
    }
