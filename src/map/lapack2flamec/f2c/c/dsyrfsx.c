...
/* ../netlib/dsyrfsx.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsyrfsx
 * .f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsyrfsx
 * .f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsyrfsx
 * .f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* ===================================================================== */
/* Subroutine */
void dsyrfsx_(char *uplo, char *equed, integer *n, integer *nrhs, doublereal *a, integer *lda,
              doublereal *af, integer *ldaf, integer *ipiv, doublereal *s, doublereal *b,
              integer *ldb, doublereal *x, integer *ldx, doublereal *rcond, doublereal *berr,
              ...
              integer *nparams, doublereal *params, doublereal *work, integer *iwork, integer *info)
{
    ...
    AOCL_DTL_SNPRINTF("dsyrfsx inputs: uplo %c, equed %c, n %" FLA_IS ", nrhs %" FLA_IS
    ...
    integer prec_type__;
    extern doublereal dla_syrcond_(char *, integer *, doublereal *, integer *, doublereal *,
                                   integer *, integer *, integer *, doublereal *, integer *,
                                   doublereal *, integer *);
    doublereal cwise_wrong__;
    extern /* Subroutine */
        void
        dla_syrfsx_extended_(integer *, char *, integer *, integer *, doublereal *, integer *,
    ...
    *(unsigned char *)norm = 'I';
    ...
    if(ref_type__ != 0)
    {
        ...
        dla_syrfsx_extended_(&prec_type__, uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf,
    ...
    if(*n_err_bnds__ >= 1 && n_norms__ >= 1)
    {
        ...
        if(rcequ)
        {
            rcond_tmp__ = dla_syrcond_(uplo, n, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1],
    ...
    if(*n_err_bnds__ >= 1 && n_norms__ >= 2)
    {
        ...
        for(j = 1; j <= i__1; ++j)
        {
            ...
            {
                rcond_tmp__
                    = dla_syrcond_(uplo, n, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1],
