...
/* ===================================================================== */
/* Subroutine */
void cheevx_2stage_(char *jobz, char *range, char *uplo, integer *n, complex *a, integer *lda,
                    ...
                    integer *iwork, integer *ifail, integer *info)
{
    ...
    *m = 0;
    ...
    chetrd_2stage_(jobz, uplo, n, &a[a_offset], lda, &rwork[indd], &rwork[inde], &work[indtau],
