...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesdd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesdd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesdd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        if(*m >= *n && minmn > 0)
        {
            ...
            sormbr_fla("P", "R", "T", n, n, n, dum, n, dum, dum, n, dum, &c_n1, &ierr);
            lwork_sormbr_prt_nn__ = (aocl_int64_t)dum[0];
            sormbr_fla("Q", "L", "N", n, n, n, dum, n, dum, dum, n, dum, &c_n1, &ierr);
            lwork_sormbr_qln_nn__ = (aocl_int64_t)dum[0];
            sormbr_fla("Q", "L", "N", m, n, n, dum, m, dum, dum, m, dum, &c_n1, &ierr);
            lwork_sormbr_qln_mn__ = (aocl_int64_t)dum[0];
            sormbr_fla("Q", "L", "N", m, m, n, dum, m, dum, dum, m, dum, &c_n1, &ierr);
        ...
        else if(minmn > 0)
        {
            ...
            sormbr_fla("P", "R", "T", m, m, m, dum, m, dum, dum, m, dum, &c_n1, &ierr);
            lwork_sormbr_prt_mm__ = (aocl_int64_t)dum[0];
            sormbr_fla("P", "R", "T", m, n, m, dum, m, dum, dum, m, dum, &c_n1, &ierr);
            lwork_sormbr_prt_mn__ = (aocl_int64_t)dum[0];
            sormbr_fla("P", "R", "T", n, n, m, dum, n, dum, dum, n, dum, &c_n1, &ierr);
            lwork_sormbr_prt_nn__ = (aocl_int64_t)dum[0];
            sormbr_fla("Q", "L", "N", m, m, m, dum, m, dum, dum, m, dum, &c_n1, &ierr);
            lwork_sormbr_qln_mm__ = (aocl_int64_t)dum[0];
            if(*n >= mnthr)
            {
                if(wntqn)
    ...
    if(*m >= *n)
    {
        ...
        if(*m >= mnthr)
        {
            ...
            else if(wntqo)
            {
                ...
                i__1 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[itauq], &work[iu],
                              n, &work[nwork], &i__1, &ierr);
                i__1 = *lwork - nwork + 1;
                sormbr_fla("P", "R", "T", n, n, n, &work[ir], &ldwrkr, &work[itaup],
            ...
            else if(wntqs)
            {
                ...
                i__2 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[itauq],
            ...
            else if(wntqa)
            {
                ...
                i__2 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", n, n, n, &a[a_offset], lda, &work[itauq], &work[iu],
                              &ldwrku, &work[nwork], &i__2, &ierr);
                i__2 = *lwork - nwork + 1;
                sormbr_fla("P", "R", "T", n, n, n, &a[a_offset], lda, &work[itaup],
                              &vt[vt_offset], ldvt, &work[nwork], &i__2, &ierr);
        ...
        else
        {
            ...
            else if(wntqo)
            {
                ...
                if(*lwork >= *m * *n + *n * 3 + bdspac)
                {
                    ...
                    i__2 = *lwork - nwork + 1;
                    sormbr_fla("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[itauq],
            ...
            else if(wntqs)
            {
                ...
                i__1 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[itauq], &u[u_offset],
            ...
            else if(wntqa)
            {
                ...
                i__1 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[itauq], &u[u_offset],
                              ldu, &work[nwork], &i__1, &ierr);
                i__1 = *lwork - nwork + 1;
                sormbr_fla("P", "R", "T", n, n, m, &a[a_offset], lda, &work[itaup],
                              &vt[vt_offset], ldvt, &work[nwork], &i__1, &ierr);
            }
        }
    }
    else
    {
        ...
        if(*n >= mnthr)
        {
            ...
            else if(wntqo)
            {
                ...
                i__1 = *lwork - nwork + 1;
                lapack_sgebrd(m, m, &work[il], &ldwrkl, &s[1], &work[ie], &work[itauq],
                              &work[itaup], &work[nwork], &i__1, &ierr);
                /* Perform bidiagonal SVD, computing left singular vectors */
                /* of bidiagonal matrix in U, and computing right singular */
                ...
                i__1 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[itauq],
                              &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
                i__1 = *lwork - nwork + 1;
                sormbr_fla("P", "R", "T", m, m, m, &work[il], &ldwrkl, &work[itaup], &work[ivt],
            ...
            else if(wntqs)
            {
                ...
                sormbr_fla("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[itauq],
                              &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
                i__2 = *lwork - nwork + 1;
                sormbr_fla("P", "R", "T", m, m, m, &work[il], &ldwrkl, &work[itaup],
                              &vt[vt_offset], ldvt, &work[nwork], &i__2, &ierr);
            ...
            else if(wntqa)
            {
                ...
                i__2 = *lwork - nwork + 1;
                sormbr_fla("Q", "L", "N", m, m, m, &a[a_offset], lda, &work[itauq], &u[u_offset],
                              ldu, &work[nwork], &i__2, &ierr);
                i__2 = *lwork - nwork + 1;
                sormbr_fla("P", "R", "T", m, m, m, &a[a_offset], lda, &work[itaup], &work[ivt],
        ...
        else
        {
            ...
            else if(wntqo)
            {
                ...
                if(*lwork >= *m * *n + *m * 3 + bdspac)
                {
                    ...
                    i__2 = *lwork - nwork + 1;
                    sormbr_fla("P", "R", "T", m, n, m, &a[a_offset], lda, &work[itaup],
