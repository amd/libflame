...
void cla_syamv_(aocl_int_t *uplo, aocl_int_t *n, real *alpha, scomplex *a, aocl_int_t *lda,
                scomplex *x, aocl_int_t *incx, real *beta, real *y, aocl_int_t *incy)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cla_syamv(uplo, n, alpha, a, lda, x, incx, beta, y, incy);
#else
    ...
    aocl_lapack_cla_syamv(&uplo_64, &n_64, alpha, a, &lda_64, x, &incx_64, beta, y, &incy_64);
#endif
}

void aocl_lapack_cla_syamv(aocl_int64_t *uplo, aocl_int64_t *n, real *alpha, scomplex *a,
                           ...
                           aocl_int64_t *incy)
{
    ...
    if(info != 0)
    {
        aocl_blas_xerbla("CLA_SYAMV", &info, (ftnlen)9);
