/* ../netlib/dtbcon.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtbcon.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtbcon.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtbcon.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dtbcon(norm, uplo, diag, n, kd, ab, ldab, rcond, work, iwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_dtbcon(norm, uplo, diag, &n_64, &kd_64, ab, &ldab_64, rcond, work, iwork, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dtbcon(char *norm, char *uplo, char *diag, aocl_int64_t *n, aocl_int64_t *kd,
                        doublereal *ab, aocl_int64_t *ldab, doublereal *rcond, doublereal *work,
                        aocl_int_t *iwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DTBCON", &i__1, (ftnlen)6);
