...
/* > */
/* > \verbatim */
/* > CHETRI_3 computes the inverse of a scomplex Hermitian indefinite */
...
void chetri_3_(char *uplo, aocl_int_t *n, scomplex *a, aocl_int_t *lda, scomplex *e, aocl_int_t *ipiv,
               scomplex *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_chetri_3(uplo, n, a, lda, e, ipiv, work, lwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_chetri_3(uplo, &n_64, a, &lda_64, e, ipiv, work, &lwork_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_chetri_3(char *uplo, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda, scomplex *e,
                          aocl_int_t *ipiv, scomplex *work, aocl_int64_t *lwork, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHETRI_3", &i__1, (ftnlen)8);
    ...
    aocl_lapack_chetri_3x(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &nb, info);
    r__1 = aocl_lapack_sroundup_lwork(&lwkopt);
    work[1].r = r__1;
    work[1].i = 0.f; // , expr subst
    AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
