/* ../netlib/zhpsvx.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zhpsvx.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zhpsvx.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zhpsvx.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void zhpsvx_(char *fact, char *uplo, aocl_int_t *n, aocl_int_t *nrhs, dcomplex *ap,
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhpsvx(fact, uplo, n, nrhs, ap, afp, ipiv, b, ldb, x, ldx, rcond, ferr, berr, work,
                       rwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zhpsvx(fact, uplo, &n_64, &nrhs_64, ap, afp, ipiv, b, &ldb_64, x, &ldx_64, rcond,
...
void aocl_lapack_zhpsvx(char *fact, char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHPSVX", &i__1, (ftnlen)6);
    ...
    if(nofact)
    {
        ...
        aocl_lapack_zhptrf(uplo, n, &afp[1], &ipiv[1], info);
    ...
    anorm = aocl_lapack_zlanhp("I", uplo, n, &ap[1], &rwork[1]);
    /* Compute the reciprocal of the condition number of A. */
    aocl_lapack_zhpcon(uplo, n, &afp[1], &ipiv[1], &anorm, rcond, &work[1], info);
