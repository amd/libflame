/* ../netlib/zgegv.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* ===================================================================== */
/* Subroutine */
void zgegv_(char *jobvl, char *jobvr, integer *n, doublecomplex *a, integer *lda, doublecomplex *b, integer *ldb, doublecomplex *alpha, doublecomplex *beta, doublecomplex *vl, integer *ldvl, doublecomplex *vr, integer *ldvr, doublecomplex *work, integer *lwork, doublereal *rwork, integer *info)
{
    ...
    *info = 0;
    ...
    for(jc = 1; jc <= i__1; ++jc)
    {
        ...
        if(ilimit)
        {
            ...
            i__2 = jc;
            z__2.real = scale * beta[i__2].real;
            z__2.imag = scale * beta[i__2].imag; // , expr subst
            z__1.real = bnrm * z__2.real;
            z__1.imag = bnrm * z__2.imag; // , expr subst
            sbeta = z__1.real;
        }
        i__2 = jc;
        z__1.real = salfar;
        z__1.imag = salfai; // , expr subst
        alpha[i__2].real = z__1.real;
        alpha[i__2].imag = z__1.imag; // , expr subst
        i__2 = jc;
        beta[i__2].real = sbeta;
        beta[i__2].imag = 0.; // , expr subst
        /* L70: */
    }
L80:
