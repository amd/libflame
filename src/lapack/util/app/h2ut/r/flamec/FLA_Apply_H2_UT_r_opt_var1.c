...
FLA_Error FLA_Apply_H2_UT_r_ops_var1( fla_dim_t m_a1,
                                      fla_dim_t n_u2_A2,
                                      float* tau,
...
FLA_Error FLA_Apply_H2_UT_r_opd_var1( fla_dim_t m_a1,
                                      fla_dim_t n_u2_A2,
                                      double* tau,
...
FLA_Error FLA_Apply_H2_UT_r_opc_var1( fla_dim_t m_a1,
                                      fla_dim_t n_u2_A2,
                                      scomplex* tau,
...
FLA_Error FLA_Apply_H2_UT_r_opz_var1( fla_dim_t m_a1,
                                      fla_dim_t n_u2_A2,
                                      dcomplex* tau,
