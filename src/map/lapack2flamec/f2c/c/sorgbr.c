    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        ...
        if(wantq)
        {
            if(*m >= *k)
            {
                sorgqr_fla(m, n, k, &a[a_offset], lda, &tau[1], &work[1], &c_n1, &iinfo);
            }
            else
            {
                if(*m > 1)
                {
                    ...
                    i__2 = *m - 1;
                    i__3 = *m - 1;
                    sorgqr_fla(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], &c_n1,
                                  &iinfo);
                }
            }
        }
        else
        {
            if(*k < *n)
            {
                sorglq_fla(m, n, k, &a[a_offset], lda, &tau[1], &work[1], &c_n1, &iinfo);
            }
            else
            {
                if(*n > 1)
                {
                    ...
                    i__2 = *n - 1;
                    i__3 = *n - 1;
                    sorglq_fla(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], &c_n1,
                                  &iinfo);
                }
            }
        }
    ...
    if(wantq)
    {
        ...
        {
            /* If m >= k, assume m >= n >= k */
            sorgqr_fla(m, n, k, &a[a_offset], lda, &tau[1], &work[1], lwork, &iinfo);
        }
        else
        {
            /* If m < k, assume m = n */
            ...
            if(*m > 1)
            {
                ...
                i__2 = *m - 1;
                i__3 = *m - 1;
                sorgqr_fla(&i__1, &i__2, &i__3, &a[(a_dim1 << 1) + 2], lda, &tau[1], &work[1],
                              lwork, &iinfo);
            }
        }
    }
    else
    {
        ...
        {
            /* If k < n, assume k <= m <= n */
            sorglq_fla(m, n, k, &a[a_offset], lda, &tau[1], &work[1], lwork, &iinfo);
        }
        else
        {
            /* If k >= n, assume m = n */
            ...
            if(*n > 1)
            {
                ...
                i__2 = *n - 1;
                i__3 = *n - 1;
                sorglq_fla(&i__1, &i__2, &i__3, &a[(a_dim1 << 1) + 2], lda, &tau[1], &work[1],
                              lwork, &iinfo);
            }
        }
    }
