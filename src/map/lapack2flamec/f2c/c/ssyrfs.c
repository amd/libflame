...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_ssyrfs(uplo, n, nrhs, a, lda, af, ldaf, ipiv, b, ldb, x, ldx, ferr, berr, work,
                       iwork, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_ssyrfs(uplo, &n_64, &nrhs_64, a, &lda_64, af, &ldaf_64, ipiv, b, &ldb_64, x,
...
void aocl_lapack_ssyrfs(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, real *a, aocl_int64_t *lda,
                        real *af, aocl_int64_t *ldaf, aocl_int_t *ipiv, real *b, aocl_int64_t *ldb,
                        real *x, aocl_int64_t *ldx, real *ferr, real *berr, real *work,
                        aocl_int_t *iwork, aocl_int64_t *info)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("ssyrfs inputs: uplo %c, n %" FLA_IS ", nrhs %" FLA_IS ", lda %" FLA_IS
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SSYRFS", &i__1, (ftnlen)6);
