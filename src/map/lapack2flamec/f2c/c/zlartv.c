/* ../netlib/zlartv.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zlartv.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zlartv.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zlartv.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                        ...
                        aocl_int64_t *incy, doublereal *c__, dcomplex *s, aocl_int64_t *incc)
{
    ...
    for(i__ = 1; i__ <= i__1; ++i__)
    {
        ...
        i__2 = ix;
        i__3 = ic;
        z__2.real = c__[i__3] * xi.real;
        z__2.imag = c__[i__3] * xi.imag; // , expr subst
        i__4 = ic;
        z__3.real = s[i__4].real * yi.real - s[i__4].imag * yi.imag;
        z__3.imag = s[i__4].real * yi.imag + s[i__4].imag * yi.real; // , expr subst
        ...
        i__2 = iy;
        i__3 = ic;
        z__2.real = c__[i__3] * yi.real;
        z__2.imag = c__[i__3] * yi.imag; // , expr subst
        d_cnjg(&z__4, &s[ic]);
        z__3.real = z__4.real * xi.real - z__4.imag * xi.imag;
        z__3.imag = z__4.real * xi.imag + z__4.imag * xi.real; // , expr subst
        z__1.real = z__2.real - z__3.real;
        z__1.imag = z__2.imag - z__3.imag; // , expr subst
