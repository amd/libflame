...
void dorgql_(aocl_int_t *m, aocl_int_t *n, aocl_int_t *k, doublereal *a, aocl_int_t *lda,
             doublereal *tau, doublereal *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dorgql(m, n, k, a, lda, tau, work, lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t k_64 = *k;
    ...
    aocl_lapack_dorgql(&m_64, &n_64, &k_64, a, &lda_64, tau, work, &lwork_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dorgql(aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *k, doublereal *a,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DORGQL", &i__1, (ftnlen)6);
    ...
    if(nb > 1 && nb < *k)
    {
        ...
        /* Computing MAX */
        i__1 = 0;
        i__2 = aocl_lapack_ilaenv(&c__3, "DORGQL", " ", m, n, k, &c_n1); // , expr subst
        ...
        if(nx < *k)
        {
            ...
            if(*lwork < iws)
            {
                ...
                /* Computing MAX */
                i__1 = 2;
                i__2 = aocl_lapack_ilaenv(&c__2, "DORGQL", " ", m, n, k, &c_n1); // , expr subst
