...
/* ===================================================================== */
/* Subroutine */
void chetrs_aa_2stage_(char *uplo, integer *n, integer *nrhs, complex *a, integer *lda, complex *tb,
    ...
    *info = 0;
    ...
    if(upper)
    {
        ...
        if(*n > nb)
        {
            ...
            i__1 = *n - nb;
            ctrsm_("L", "U", "C", "U", &i__1, nrhs, &c_b1, &a[(nb + 1) * a_dim1 + 1], lda,
                   &b[nb + 1 + b_dim1], ldb);
        }
    ...
    else
    {
        ...
        if(*n > nb)
        {
            ...
            i__1 = *n - nb;
            ctrsm_("L", "L", "C", "U", &i__1, nrhs, &c_b1, &a[nb + 1 + a_dim1], lda,
                   &b[nb + 1 + b_dim1], ldb);
