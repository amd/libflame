...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr3.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr3.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr3.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dlaqr3(wantt, wantz, n, ktop, kbot, nw, h__, ldh, iloz, ihiz, z__, ldz, ns, nd, sr,
    ...
    aocl_lapack_dlaqr3(wantt, wantz, &n_64, &ktop_64, &kbot_64, &nw_64, h__, &ldh_64, &iloz_64,
...
void aocl_lapack_dlaqr3(logical *wantt, logical *wantz, aocl_int64_t *n, aocl_int64_t *ktop,
...
L60:
    ...
    if(*ns < jw || s == 0.)
    {
        ...
        for(krow = ltop; i__2 < 0 ? krow >= i__1 : krow <= i__1; krow += i__2)
        {
            ...
            aocl_blas_dgemm("N", "N", &kln, &jw, &jw, &c_b18, &h__[krow + kwtop * h_dim1], ldh,
        ...
        if(*wantt)
        {
            ...
            for(kcol = *kbot + 1; i__1 < 0 ? kcol >= i__2 : kcol <= i__2; kcol += i__1)
            {
                ...
                kln = fla_min(i__3, i__4);
                aocl_blas_dgemm("C", "N", &jw, &kln, &jw, &c_b18, &v[v_offset], ldv,
        ...
        if(*wantz)
        {
            ...
            for(krow = *iloz; i__2 < 0 ? krow >= i__1 : krow <= i__1; krow += i__2)
            {
                ...
                kln = fla_min(i__3, i__4);
                aocl_blas_dgemm("N", "N", &kln, &jw, &jw, &c_b18, &z__[krow + kwtop * z_dim1], ldz,
                                &v[v_offset], ldv, &c_b17, &wv[wv_offset], ldwv);
