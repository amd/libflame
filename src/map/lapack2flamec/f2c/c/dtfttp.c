...
void dtfttp_(char *transr, char *uplo, aocl_int_t *n, doublereal *arf, doublereal *ap,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dtfttp(transr, uplo, n, arf, ap, info);
#else
    aocl_int64_t n_64 = *n;
    aocl_int64_t info_64 = *info;

    aocl_lapack_dtfttp(transr, uplo, &n_64, arf, ap, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_dtfttp(char *transr, char *uplo, aocl_int64_t *n, doublereal *arf, doublereal *ap,
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DTFTTP", &i__1, (ftnlen)6);
