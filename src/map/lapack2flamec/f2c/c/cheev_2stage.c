...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cheev_2
 * stage.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cheev_2
 * stage.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cheev_2
 * stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
                   ...
                   complex *work, integer *lwork, real *rwork, integer *info)
{
    ...
    char buffer[256];
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256, "cheev_2stage inputs: jobz %c, uplo %c, n %lld, lda %lld, lwork %lld",
             *jobz, *uplo, *n, *lda, *lwork);
#else
    snprintf(buffer, 256, "cheev_2stage inputs: jobz %c, uplo %c, n %d, lda %d, lwork %d", *jobz,
             *uplo, *n, *lda, *lwork);
#endif
