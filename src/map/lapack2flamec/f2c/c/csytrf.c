...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/csytrf.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/csytrf.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/csytrf.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
/* > \verbatim */
/* > */
/* > CSYTRF computes the factorization of a scomplex symmetric matrix A */
    ...
    *info = 0;
    ...
    if(nb > 1 && nb < *n)
    {
        ...
        if(*lwork < iws)
        {
            ...
            i__1 = 2;
            i__2
                = aocl_lapack_ilaenv(&c__2, "CSYTRF", uplo, n, &c_n1, &c_n1, &c_n1); // , expr subst
    ...
    L10: /* If K < 1, exit from loop */
        ...
        if(k > nb)
        {
            ...
            aocl_lapack_clasyf(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &work[1], n,
                               &iinfo);
        }
        else
        {
            /* Use unblocked code to factorize columns 1:k of A */
            aocl_lapack_csytf2(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
            kb = k;
        }
    ...
    L20: /* If K > N, exit from loop */
        ...
        if(k <= *n - nb)
        {
            ...
            i__1 = *n - k + 1;
            aocl_lapack_clasyf(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &ipiv[k], &work[1],
                               n, &iinfo);
        }
        else
        {
            ...
            i__1 = *n - k + 1;
            aocl_lapack_csytf2(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &iinfo);
            kb = *n - k + 1;
        }
        /* Set INFO on the first occurrence of a zero pivot */
        if(*info == 0 && iinfo > 0)
