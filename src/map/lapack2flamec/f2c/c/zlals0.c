/* ../netlib/zlals0.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zlals0.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zlals0.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zlals0.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
            ...
            for(j = 1; j <= i__1; ++j)
            {
                ...
                for(i__ = 1; i__ <= i__2; ++i__)
                {
                    ...
                    else
                    {
                        ...
                        rwork[i__] = z__[j] / (dlamc3_(&dsigj, &d__1) - difr[i__ + difr_dim1])
                ...
                for(i__ = j + 1; i__ <= i__2; ++i__)
                {
                    ...
                    else
                    {
                        ...
                        rwork[i__] = z__[j] / (dlamc3_(&dsigj, &d__1) - difl[i__])
                                     / (dsigj + poles[i__ + poles_dim1])
                                     / difr[i__ + (difr_dim1 << 1)];
                    }
                    /* L120: */
                ...
                for(jcol = 1; jcol <= i__2; ++jcol)
                {
                    ...
                    z__1.real = rwork[i__4];
                    z__1.imag = rwork[i__5]; // , expr subst
                    bx[i__3].real = z__1.real;
                    bx[i__3].imag = z__1.imag; // , expr subst
                    /* L170: */
                }
                /* L180: */
            }
