...
/* > \verbatim */
/* > */
/* > CHETRI2X computes the inverse of a scomplex Hermitian indefinite matrix */
...
void chetri2x_(char *uplo, aocl_int_t *n, scomplex *a, aocl_int_t *lda, aocl_int_t *ipiv,
               scomplex *work, aocl_int_t *nb, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_chetri2x(uplo, n, a, lda, ipiv, work, nb, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_chetri2x(uplo, &n_64, a, &lda_64, ipiv, work, &nb_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_chetri2x(char *uplo, aocl_int64_t *n, scomplex *a, aocl_int64_t *lda,
                          aocl_int_t *ipiv, scomplex *work, aocl_int64_t *nb, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CHETRI2X", &i__1, (ftnlen)8);
    ...
    *info = 0;
    ...
    if(upper)
    {
        ...
        while(cut > 0)
        {
            ...
            /* U11**H*invD1*U11->U11 */
            i__1 = *n + *nb + 1;
            aocl_blas_ctrmm("L", "U", "C", "U", &nnb, &nnb, &c_b1, &a[cut + 1 + (cut + 1) * a_dim1],
            ...
            i__1 = *n + *nb + 1;
            i__2 = *n + *nb + 1;
            aocl_blas_cgemm("C", "N", &nnb, &nnb, &cut, &c_b1, &a[(cut + 1) * a_dim1 + 1], lda,
            ...
            /* U01 = U00**H*invD0*U01 */
            i__1 = *n + *nb + 1;
            aocl_blas_ctrmm("L", uplo, "C", "U", &cut, &nnb, &c_b1, &a[a_offset], lda,
        ...
        while(i__ <= *n)
        {
            if(ipiv[i__] > 0)
            {
                ...
                if(i__ < ip)
                {
                    aocl_lapack_cheswapr(uplo, n, &a[a_offset], lda, &i__, &ip);
                }
                if(i__ > ip)
                {
                    aocl_lapack_cheswapr(uplo, n, &a[a_offset], lda, &ip, &i__);
                }
            }
            else
            {
                ...
                {
                    i__1 = i__ - 1;
                    aocl_lapack_cheswapr(uplo, n, &a[a_offset], lda, &i__1, &ip);
                }
                if(i__ - 1 > ip)
                {
                    i__1 = i__ - 1;
                    aocl_lapack_cheswapr(uplo, n, &a[a_offset], lda, &ip, &i__1);
                }
            }
            ++i__;
        }
    ...
    else
    {
        ...
        while(cut < *n)
        {
            ...
            /* L11**H*invD1*L11->L11 */
            i__1 = *n + *nb + 1;
            aocl_blas_ctrmm("L", uplo, "C", "U", &nnb, &nnb, &c_b1,
            ...
            if(cut + nnb < *n)
            {
                ...
                i__2 = *n + *nb + 1;
                i__3 = *n + *nb + 1;
                aocl_blas_cgemm("C", "N", &nnb, &nnb, &i__1, &c_b1,
                ...
                i__1 = *n - nnb - cut;
                i__2 = *n + *nb + 1;
                aocl_blas_ctrmm("L", uplo, "C", "U", &i__1, &nnb, &c_b1,
