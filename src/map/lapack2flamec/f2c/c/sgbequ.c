...
void sgbequ_(aocl_int_t *m, aocl_int_t *n, aocl_int_t *kl, aocl_int_t *ku, real *ab,
             aocl_int_t *ldab, real *r__, real *c__, real *rowcnd, real *colcnd, real *amax,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_sgbequ(m, n, kl, ku, ab, ldab, r__, c__, rowcnd, colcnd, amax, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_sgbequ(&m_64, &n_64, &kl_64, &ku_64, ab, &ldab_64, r__, c__, rowcnd, colcnd, amax,
                       &info_64);
...
void aocl_lapack_sgbequ(aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *kl, aocl_int64_t *ku,
                        ...
                        real *colcnd, real *amax, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("SGBEQU", &i__1, (ftnlen)6);
