/* ../netlib/zheswapr.f -- translated by f2c (version 20160102). You must link the resulting object
...
/* > \brief \b ZHESWAPR applies an elementary permutation on the rows and columns of a Hermitian
 * matrix. */
/* =========== DOCUMENTATION =========== */
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zheswap
 * r.f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zheswap
 * r.f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zheswap
 * r.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
void zheswapr_(char *uplo, aocl_int_t *n, dcomplex *a, aocl_int_t *lda, aocl_int_t *i1,
               aocl_int_t *i2)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zheswapr(uplo, n, a, lda, i1, i2);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zheswapr(uplo, &n_64, a, &lda_64, &i1_64, &i2_64);
#endif
}

void aocl_lapack_zheswapr(char *uplo, aocl_int64_t *n, dcomplex *a, aocl_int64_t *lda,
                          aocl_int64_t *i1, aocl_int64_t *i2)
{
    AOCL_DTL_TRACE_LOG_INIT
    AOCL_DTL_SNPRINTF("zheswapr inputs: uplo %c, n %" FLA_IS ", lda %" FLA_IS ", i1 %" FLA_IS
                      ", i2 %" FLA_IS "",
                      *uplo, *n, *lda, *i1, *i2);
