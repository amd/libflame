...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cuncsd.
 * f"> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cuncsd.
 * f"> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cuncsd.
 * f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
...
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,
             "cuncsd inputs: jobu1 %c, jobu2 %c, jobv1t %c, jobv2t %c, trans %c, signs %c, m %lld, "
             "p %lld, q %lld, ldx11 %lld, ldx12 %lld, ldx21 %lld, ldx22 %lld, ldu1 %lld, ldu2 "
             "%lld, ldv1t %lld, ldv2t %lld, lwork %lld, lrwork %lld",
             *jobu1, *jobu2, *jobv1t, *jobv2t, *trans, *signs, *m, *p, *q, *ldx11, *ldx12, *ldx21,
             *ldx22, *ldu1, *ldu2, *ldv1t, *ldv2t, *lwork, *lrwork);
#else
    snprintf(buffer, 256,
             "cuncsd inputs: jobu1 %c, jobu2 %c, jobv1t %c, jobv2t %c, trans %c, signs %c, m %d, p "
             "%d, q %d, ldx11 %d, ldx12 %d, ldx21 %d, ldx22 %d, ldu1 %d, ldu2 %d, ldv1t %d, ldv2t "
             "%d, lwork %d, lrwork %d",
             *jobu1, *jobu2, *jobv1t, *jobv2t, *trans, *signs, *m, *p, *q, *ldx11, *ldx12, *ldx21,
             *ldx22, *ldu1, *ldu2, *ldv1t, *ldv2t, *lwork, *lrwork);
#endif
