 ...
 */
 ...
 /* ===================================================================== */
 /* Subroutine */
 void sgeqrfp_fla(integer *m, integer *n, real *a, integer *lda, real *tau, real *work, integer *lwork, integer *info) {
 ...
 logical lquery;
 extern /* Subroutine */
 void sgeqr2p_fla(integer *, integer *, real *, integer *, real *, real *, integer *);
 integer iws;
