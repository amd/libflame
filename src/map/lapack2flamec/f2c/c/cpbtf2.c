...
/* > \verbatim */
/* > */
/* > CPBTF2 computes the Cholesky factorization of a scomplex Hermitian */
...
void cpbtf2_(char *uplo, aocl_int_t *n, aocl_int_t *kd, scomplex *ab, aocl_int_t *ldab,
             aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_cpbtf2(uplo, n, kd, ab, ldab, info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_cpbtf2(uplo, &n_64, &kd_64, ab, &ldab_64, &info_64);

    *info = (aocl_int_t)info_64;
#endif
}

void aocl_lapack_cpbtf2(char *uplo, aocl_int64_t *n, aocl_int64_t *kd, scomplex *ab,
                        aocl_int64_t *ldab, aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("CPBTF2", &i__1, (ftnlen)6);
