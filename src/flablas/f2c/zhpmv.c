...
#include "FLA_f2c.h"
/* Subroutine */
int zhpmv_(char *uplo, integer *n, dcomplex *alpha, dcomplex *ap, dcomplex *x, integer *incx, dcomplex * beta, dcomplex *y, integer *incy)
{
        ...
        if (*incx == 1 && *incy == 1)
        {
                    ...
                    ++j)
            {
                        ...
                        ++i__)
                {
                    ...
                    i__4 = i__;
                    i__5 = k;
                    z__2.real = temp1.real * ap[i__5].real - temp1.imag * ap[i__5].imag, z__2.imag = temp1.real * ap[i__5].imag + temp1.imag * ap[i__5] .real;
