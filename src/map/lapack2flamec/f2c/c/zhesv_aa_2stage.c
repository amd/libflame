/* ../netlib/v3.9.0/zhesv_aa_2stage.f -- translated by f2c (version 20160102). You must link the
...
/* > \brief <b> ZHESV_AA_2STAGE computes the solution to system of linear equations A * X = B for HE
 * matrices </b> */
/* =========== DOCUMENTATION =========== */
...
/* > \verbatim */
/* > */
/* > ZHESV_AA_2STAGE computes the solution to a scomplex system of */
/* > linear equations */
/* > A * X = B, */
...
void zhesv_aa_2stage_(char *uplo, aocl_int_t *n, aocl_int_t *nrhs, dcomplex *a,
                      aocl_int_t *lda, dcomplex *tb, aocl_int_t *ltb, aocl_int_t *ipiv,
                      aocl_int_t *ipiv2, dcomplex *b, aocl_int_t *ldb, dcomplex *work,
                      aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_zhesv_aa_2stage(uplo, n, nrhs, a, lda, tb, ltb, ipiv, ipiv2, b, ldb, work, lwork,
                                info);
#else
    aocl_int64_t n_64 = *n;
    ...
    aocl_lapack_zhesv_aa_2stage(uplo, &n_64, &nrhs_64, a, &lda_64, tb, &ltb_64, ipiv, ipiv2, b,
...
void aocl_lapack_zhesv_aa_2stage(char *uplo, aocl_int64_t *n, aocl_int64_t *nrhs, dcomplex *a,
                                 ...
                                 aocl_int64_t *info)
{
    ...
    AOCL_DTL_SNPRINTF("zhesv_aa_2stage inputs: uplo %c, n %" FLA_IS ", nrhs %" FLA_IS
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        aocl_lapack_zhetrf_aa_2stage(uplo, n, &a[a_offset], lda, &tb[1], &c_n1, &ipiv[1], &ipiv2[1],
                                     &work[1], &c_n1, info);
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("ZHESV_AA_2STAGE", &i__1, (ftnlen)15);
    ...
    aocl_lapack_zhetrf_aa_2stage(uplo, n, &a[a_offset], lda, &tb[1], ltb, &ipiv[1], &ipiv2[1],
                                 &work[1], lwork, info);
    if(*info == 0)
    {
        /* Solve the system A*X = B, overwriting B with X. */
        aocl_lapack_zhetrs_aa_2stage(uplo, n, nrhs, &a[a_offset], lda, &tb[1], ltb, &ipiv[1],
