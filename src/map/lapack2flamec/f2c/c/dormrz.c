...
void dormrz_(char *side, char *trans, aocl_int_t *m, aocl_int_t *n, aocl_int_t *k, aocl_int_t *l,
             doublereal *a, aocl_int_t *lda, doublereal *tau, doublereal *c__, aocl_int_t *ldc,
             doublereal *work, aocl_int_t *lwork, aocl_int_t *info)
{
#if FLA_ENABLE_ILP64
    aocl_lapack_dormrz(side, trans, m, n, k, l, a, lda, tau, c__, ldc, work, lwork, info);
#else
    aocl_int64_t m_64 = *m;
    aocl_int64_t n_64 = *n;
    aocl_int64_t k_64 = *k;
    ...
    aocl_lapack_dormrz(side, trans, &m_64, &n_64, &k_64, &l_64, a, &lda_64, tau, c__, &ldc_64, work,
                       &lwork_64, &info_64);
...
void aocl_lapack_dormrz(char *side, char *trans, aocl_int64_t *m, aocl_int64_t *n, aocl_int64_t *k,
                        ...
                        aocl_int64_t *info)
{
    ...
    *info = 0;
    ...
    {
        i__1 = -(*info);
        aocl_blas_xerbla("DORMRZ", &i__1, (ftnlen)6);
    ...
    {
        /* Use unblocked code */
        aocl_lapack_dormr3(side, trans, m, n, k, l, &a[a_offset], lda, &tau[1], &c__[c_offset], ldc,
                           &work[1], &iinfo);
    }
    else
    {
        ...
        for(i__ = i1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2)
        {
            ...
            aocl_lapack_dlarzt("Backward", "Rowwise", l, &ib, &a[i__ + ja * a_dim1], lda, &tau[i__],
                               &work[iwt], &c__65);
            if(left)
            {
            ...
            /* Apply H or H**T */
            aocl_lapack_dlarzb(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, l,
