...
/* ===================================================================== */
/* Subroutine */
void sggsvd3_(char *jobu, char *jobv, char *jobq, integer *m, integer *n, integer *p, integer *k,
              ...
              integer *lwork, integer *iwork, integer *info)
{
    ...
    *info = 0;
    ...
    if(*info == 0)
    {
        sggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, &tola, &tolb, k,
    ...
    /* Preprocessing */
    i__1 = *lwork - *n;
    sggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, &tola, &tolb, k, l,
